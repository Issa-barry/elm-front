...
var _c0 = () => [10, 25, 50];
var _c1 = () => ["reference", "vehicule.nom_vehicule", "vehicule.immatriculation", "statut_facture"];
var _c2 = () => [1, 2, 3];
var _c3 = () => ({ "min-width": "160px" });
var _c4 = () => [1, 2, 3, 4, 5];
var _c5 = () => [1, 2, 3, 4, 5, 6, 7];
...
function FactureVenteListe_ng_template_20_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(11, "Montant brut ");
    \u0275\u0275element(12, "p-sortIcon", 52);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(13, "th", 53)(14, "span", 47);
    \u0275\u0275text(15, "Encaiss\xE9");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(16, "th", 53)(17, "span", 47);
    \u0275\u0275text(18, "Restant");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(19, "th", 54)(20, "span", 47);
    \u0275\u0275text(21, "Statut ");
    \u0275\u0275element(22, "p-sortIcon", 55);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(23, "th", 56);
    \u0275\u0275text(24, "Actions");
    \u0275\u0275elementEnd()();
  }
}
function FactureVenteListe_ng_template_22_Conditional_5_Conditional_9_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0);
  }
  if (rf & 2) {
    \u0275\u0275nextContext(2);
    const lv_r11 = \u0275\u0275readContextLet(8);
    \u0275\u0275textInterpolate1(" \xB7 ", lv_r11.phone, " ");
  }
}
function FactureVenteListe_ng_template_22_Conditional_5_Conditional_9_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 68);
    \u0275\u0275element(1, "i", 69);
    \u0275\u0275text(2);
    \u0275\u0275conditionalCreate(3, FactureVenteListe_ng_template_22_Conditional_5_Conditional_9_Conditional_3_Template, 1, 1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    \u0275\u0275nextContext();
    const lv_r11 = \u0275\u0275readContextLet(8);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate2("", lv_r11.prenom, " ", lv_r11.nom, " ");
    \u0275\u0275advance();
    \u0275\u0275conditional(lv_r11.phone ? 3 : -1);
  }
}
function FactureVenteListe_ng_template_22_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 47)(1, "div", 64);
    \u0275\u0275element(2, "i", 65);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div")(4, "div", 66);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275declareLet(8);
    \u0275\u0275conditionalCreate(9, FactureVenteListe_ng_template_22_Conditional_5_Conditional_9_Template, 4, 3, "div", 68);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const f_r12 = \u0275\u0275nextContext().$implicit;
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(f_r12.vehicule.nom_vehicule);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(f_r12.vehicule.immatriculation);
    \u0275\u0275advance();
    const lv_r13 = \u0275\u0275storeLet(f_r12.vehicule.livreurPrincipal ?? f_r12.vehicule.livreur_principal);
    \u0275\u0275advance();
    \u0275\u0275conditional(lv_r13 ? 9 : -1);
  }
}
...
function FactureVenteListe_ng_template_22_Conditional_20_Template(rf, ctx) {
  if (rf & 1) {
    const _r14 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "p-button", 39);
    \u0275\u0275listener("onClick", function FactureVenteListe_ng_template_22_Conditional_20_Template_p_button_onClick_0_listener() {
      \u0275\u0275restoreView(_r14);
      const f_r12 = \u0275\u0275nextContext().$implicit;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.openEncaissementDialog(f_r12));
    });
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function FactureVenteListe_ng_template_22_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "tr")(1, "td")(2, "div", 57);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "td");
    \u0275\u0275conditionalCreate(5, FactureVenteListe_ng_template_22_Conditional_5_Template, 10, 4, "div", 47)(6, FactureVenteListe_ng_template_22_Conditional_6_Template, 2, 0, "span", 58);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "td", 59);
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "td")(10, "span", 60);
    \u0275\u0275text(11);
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275element(16, "p-tag", 62);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(17, "td")(18, "div", 63)(19, "p-button", 37);
    \u0275\u0275listener("onClick", function FactureVenteListe_ng_template_22_Template_p_button_onClick_19_listener() {
      const f_r12 = \u0275\u0275restoreView(_r10).$implicit;
      const ctx_r3 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r3.goDetail(f_r12.id));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(20, FactureVenteListe_ng_template_22_Conditional_20_Template, 1, 2, "p-button", 38);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    const ctx_r3 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(f_r12.reference);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(f_r12.vehicule ? 5 : 6);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r3.formatMontant(f_r12.montant_brut));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r3.formatMontant(f_r12.montant_encaisse));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r3.formatMontant(f_r12.montant_restant));
    \u0275\u0275advance(2);
    \u0275\u0275property("value", ctx_r3.getStatutLabel(f_r12.statut_facture))("severity", ctx_r3.getStatutSeverity(f_r12.statut_facture));
    \u0275\u0275advance(3);
    \u0275\u0275property("text", true)("rounded", true);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r3.canAddEncaissement(f_r12) ? 20 : -1);
  }
}
...
function FactureVenteListe_Conditional_28_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 18)(1, "div", 73);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "div", 74)(3, "div", 75)(4, "h2", 76);
    \u0275\u0275text(5, "Enregistrer un encaissement");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "p-button", 77);
    ...
    \u0275\u0275conditionalCreate(8, FactureVenteListe_Conditional_28_Conditional_8_Template, 5, 1, "div", 79);
    \u0275\u0275elementStart(9, "form", 80);
    ...
    \u0275\u0275elementStart(10, "div", 81)(11, "div", 82)(12, "label", 83);
    \u0275\u0275text(13, "Montant (GNF) ");
    \u0275\u0275elementStart(14, "span", 84);
    \u0275\u0275text(15, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(16, "p-inputnumber", 85);
    \u0275\u0275conditionalCreate(17, FactureVenteListe_Conditional_28_Conditional_17_Template, 2, 0, "small", 84);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "div", 82)(19, "label", 83);
    \u0275\u0275text(20, "Mode de paiement ");
    \u0275\u0275elementStart(21, "span", 84);
    \u0275\u0275text(22, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(23, "p-select", 86);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(24, "div", 82)(25, "label", 83);
    \u0275\u0275text(26, "Date d'encaissement ");
    \u0275\u0275elementStart(27, "span", 84);
    \u0275\u0275text(28, "*");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(29, "p-datepicker", 87);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(30, "div", 82)(31, "label", 83);
    \u0275\u0275text(32, "Note ");
    \u0275\u0275elementStart(33, "span", 88);
    \u0275\u0275text(34, "(optionnel)");
    \u0275\u0275elementEnd()();
    \u0275\u0275element(35, "input", 89);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(36, "div", 90)(37, "p-button", 91);
...
var FactureVenteListe = class _FactureVenteListe {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _FactureVenteListe, selectors: [["app-facture-vente-liste"]], features: [\u0275\u0275ProvidersFeature([MessageService])], decls: 29, vars: 14, consts: [["dt", ""], ["caption", ""], ["header", ""], ["body", ""], ["emptymessage", ""], ["loadingbody", ""], [1, "fv-liste-page-wrap"], [1, "fv-liste-mobile-header"], ["icon", "pi pi-arrow-left", "styleClass", "fv-liste-mobile-back", "aria-label", "Retour", 3, "onClick", "text", "rounded"], [1, "fv-liste-mobile-title"], [2, "width", "2.5rem", "flex-shrink", "0"], [1, "fv-mobile-filters"], ["type", "button", 1, "fv-filter-chip", 3, "is-active"], [1, "fv-mobile-scroll"], [1, "fv-factures-mobile"], [1, "flex", "flex-col", "items-center", "gap-3", "text-surface-500", "py-12"], [1, "card", "fv-tableau-desktop"], ["responsiveLayout", "scroll", "currentPageReportTemplate", "{first} / {last} de {totalRecords} factures", 3, "value", "loading", "paginator", "rows", "rowsPerPageOptions", "globalFilterFields", "rowHover", "showCurrentPageReport"], [1, "fixed", "inset-0", "z-50"], ["type", "button", 1, "fv-filter-chip", 3, "click"], [1, "fv-facture-card"], ["height", "5.5rem"], [1, "pi", "pi-file-invoice", "text-4xl"], [1, "text-sm"], [1, "fv-facture-card__top"], [2, "min-width", "0"], [1, "fv-facture-card__ref"], [1, "fv-facture-card__vehicule"], [1, "fv-facture-card__amounts"], [1, "fv-amount-item"], [1, "fv-amount-label"], [1, "fv-amount-value"], [1, "fv-amount-value", "fv-amount-value--success"], [1, "fv-amount-value", "fv-amount-value--danger"], [1, "fv-facture-card__footer"], [1, "text-xs", "text-surface-400"], [1, "fv-facture-card__actions"], ["icon", "pi pi-eye", "severity", "info", "pTooltip", "Voir d\xE9tail", "tooltipPosition", "top", 3, "onClick", "text", "rounded"], ["icon", "pi pi-wallet", "severity", "success", "pTooltip", "Encaisser", "tooltipPosition", "top", 3, "text", "rounded"], ["icon", "pi pi-wallet", "severity", "success", "pTooltip", "Encaisser", "tooltipPosition", "top", 3, "onClick", "text", "rounded"], [1, "flex", "flex-wrap", "gap-2", "items-center", "justify-between"], [1, "w-full", "sm:w-80"], [1, "pi", "pi-search"], ["pInputText", "", "type", "text", "placeholder", "Rechercher une facture...", 1, "w-full", 3, "input"], [1, "flex", "gap-2", "w-full", "sm:w-auto"], ["optionLabel", "label", "optionValue", "value", "placeholder", "Tous les statuts", 3, "ngModelChange", "onChange", "options", "ngModel", "showClear"], ["pSortableColumn", "reference", 1, "white-space-nowrap", 2, "width", "20%"], [1, "flex", "items-center", "gap-2"], ["field", "reference"], ["pSortableColumn", "vehicule.nom_vehicule", 1, "white-space-nowrap", 2, "width", "20%"], ["field", "vehicule.nom_vehicule"], ["pSortableColumn", "montant_brut", 1, "white-space-nowrap", 2, "width", "13%"], ["field", "montant_brut"], [2, "width", "11%"], ["pSortableColumn", "statut_facture", 1, "white-space-nowrap", 2, "width", "10%"], ["field", "statut_facture"], [2, "width", "8%"], [1, "font-semibold", "font-mono", "text-sm"], [1, "text-surface-300", "text-sm"], [1, "font-semibold"], [1, "text-sm", "text-green-600", "dark:text-green-400", "font-medium"], [1, "text-sm", "text-red-500", "dark:text-red-400", "font-medium"], [3, "value", "severity"], [1, "flex", "gap-1"], [1, "flex", "items-center", "justify-center", "w-8", "h-8", "rounded-full", "bg-surface-100", "text-surface-600", "flex-shrink-0"], [1, "pi", "pi-truck", "text-xs"], [1, "text-sm", "font-medium"], [1, "text-xs", "text-surface-400", "font-mono"], [1, "text-xs", "text-surface-500", "mt-0.5"], [1, "pi", "pi-user", "text-[10px]", "mr-1"], ["colspan", "7", 1, "text-center", "py-10"], [1, "flex", "flex-col", "items-center", "gap-3", "text-surface-500"], [1, "text-sm", "text-surface-400"], [1, "absolute", "inset-0", "bg-black/50", "animate-fadein", 3, "click"], [1, "fv-enc-slideover", "bg-surface-0", "dark:bg-surface-900", "absolute", "top-0", "right-0", "shadow-xl", "w-full", "md:w-108", "h-full", "animate-fadeinright"], [1, "fv-enc-slideover-header"], [1, "fv-enc-slideover-title"], ["icon", "pi pi-times", "severity", "secondary", 3, "onClick", "text", "rounded"], [1, "fv-enc-slideover-body"], [1, "fv-enc-preview"], [3, "ngSubmit", "formGroup"], [1, "flex", "flex-col", "gap-4"], [1, "flex", "flex-col", "gap-2"], [1, "font-medium", "text-sm"], [1, "text-red-500"], ["formControlName", "montant", "suffix", " GNF", "styleClass", "w-full", "inputStyleClass", "w-full", 3, "min", "useGrouping", "ngClass"], ["formControlName", "mode_paiement", "optionLabel", "label", "optionValue", "value", "styleClass", "w-full", 3, "options"], ["formControlName", "date_encaissement", "dateFormat", "dd/mm/yy", "styleClass", "w-full", "inputStyleClass", "w-full", 3, "showIcon"], [1, "text-color-secondary", "text-xs"], ["pInputText", "", "formControlName", "note", "placeholder", "Remarques\u2026", 1, "w-full"], [1, "fv-enc-slideover-footer"], ["label", "Enregistrer", "icon", "pi pi-check", "fluid", "", 3, "onClick", "loading"], [1, "font-bold", "text-red-500"]], template: function FactureVenteListe_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275template(18, FactureVenteListe_ng_template_18_Template, 6, 6, "ng-template", null, 1, \u0275\u0275templateRefExtractor)(20, FactureVenteListe_ng_template_20_Template, 25, 0, "ng-template", null, 2, \u0275\u0275templateRefExtractor)(22, FactureVenteListe_ng_template_22_Template, 21, 10, "ng-template", null, 3, \u0275\u0275templateRefExtractor)(24, FactureVenteListe_ng_template_24_Template, 8, 0, "ng-template", null, 4, \u0275\u0275templateRefExtractor)(26, FactureVenteListe_ng_template_26_Template, 2, 1, "ng-template", null, 5, \u0275\u0275templateRefExtractor);
      \u0275\u0275elementEnd()()()();
      ...
      >
        ...
        <ng-template #header>
          <tr>
            ...
            <th pSortableColumn="montant_brut" class="white-space-nowrap" style="width:13%">
            ...
            <th style="width:11%"><span class="flex items-center gap-2">Restant</span></th>
            <th pSortableColumn="statut_facture" class="white-space-nowrap" style="width:10%">
                  ...
                  <div>
                    ...
                    @if (lv) {
                      <div class="text-xs text-surface-500 mt-0.5">
                        <i class="pi pi-user text-[10px] mr-1"></i>{{ lv.prenom }} {{ lv.nom }}
                        @if (lv.phone) { \xB7 {{ lv.phone }} }
                      </div>
                    }
                  </div>
                </div>
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(FactureVenteListe, { className: "FactureVenteListe", filePath: "src/app/pages/ventes/facture-vente-liste/facture-vente-liste.ts", lineNumber: 58 });
})();
export {
  FactureVenteListe
};
//# sourceMappingURL=chunk-4TOS2SAS.js.map
