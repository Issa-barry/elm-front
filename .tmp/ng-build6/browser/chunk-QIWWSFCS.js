...
var ventes_routes_default = [
  ...
  {
    path: "commandes/:id",
    loadComponent: () => import("./chunk-JDKWE6AR.js").then((c) => c.CommandeVenteDetail),
    data: { breadcrumb: "commandes" }
  },
  {
    path: "factures-vente-liste2",
    loadComponent: () => import("./chunk-QXHYHBRO.js").then((c) => c.FactureVenteListe2),
    data: { breadcrumb: "factures-vente-liste2" }
  },
  {
    path: "factures-vente-detail2/:id",
    loadComponent: () => import("./chunk-KN3H5YE3.js").then((c) => c.FactureVenteDetail2),
  ...
  {
    path: "factures-vente",
    loadComponent: () => import("./chunk-4TOS2SAS.js").then((c) => c.FactureVenteListe),
  ...
  {
    path: "factures/:id",
    loadComponent: () => import("./chunk-S6QMVDIR.js").then((c) => c.FactureVenteDetail),
    data: { breadcrumb: "factures" }
  },
  {
    path: "encaissements",
    loadComponent: () => import("./chunk-UURAH4YM.js").then((c) => c.EncaissementVenteListe),
    data: { breadcrumb: "encaissements" }
  },
  {
    path: "commissions",
    loadComponent: () => import("./chunk-RHFHX4N4.js").then((c) => c.CommissionVenteListe),
    data: { breadcrumb: "commissions" }
  },
  {
    path: "commissions2",
    loadComponent: () => import("./chunk-N4O7XB52.js").then((c) => c.ComissionVenteListe2),
...
//# sourceMappingURL=chunk-QIWWSFCS.js.map
