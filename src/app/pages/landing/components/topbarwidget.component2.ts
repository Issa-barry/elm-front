    ...
    template: `
            ...
            <div class="bg-surface-900 py-4 px-12 shadow flex items-center justify-between relative">
                <div class="flex items-center gap-4 py-2">
                    ...
                    <span class="text-xl font-medium text-surface-0">Eau la maman</span>
                </div>
                <a
                    pStyleClass="@next"
                    ...
                    [hideOnResize]="true"
                    resizeSelector=".resize-container-landing2"
                    class="cursor-pointer block lg:hidden text-primary-contrast dark:text-surface-100 mt-1"
                >
                ...
                <div class="items-center grow justify-between hidden lg:flex absolute lg:static w-full left-0 top-full px-12 lg:px-0 z-50 shadow lg:shadow-none bg-surface-900">
                    ...
                    <div class="flex border-t lg:border-t-0 border-surface-700 lg:border-surface-800 py-4 lg:py-0 mt-4 lg:mt-0 gap-4">
                        <button pButton [text]="true" (click)="goToLogin()">
                            <span pButtonLabel> Connexion </span>
                        </button>
                        <p-button (onClick)="goToRegister()">
                            <span pButtonLabel> Inscription </span>
                        </p-button>
                    </div>
                </div>
            </div>
