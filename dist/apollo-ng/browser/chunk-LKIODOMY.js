...
var ecommerce_routes_default = [
  ...
  },
  {
    ...
    loadComponent: () => import("./chunk-I7II6GVA.js").then((c) => c.NewProduct)
  },
  {
    path: "shopping-cart",
    data: { breadcrumb: "shopping-cart" },
    loadComponent: () => import("./chunk-JOQSQHT3.js").then((c) => c.ShoppingCart)
  },
  {
    path: "checkout-form",
    data: { breadcrumb: "checkout-form" },
    loadComponent: () => import("./chunk-WCTHG6VS.js").then((c) => c.CheckoutForm)
  },
  {
    path: "order-history",
...
//# sourceMappingURL=chunk-LKIODOMY.js.map
