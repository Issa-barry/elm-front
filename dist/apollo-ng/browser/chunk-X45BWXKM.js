...
function AppConfigurator_For_14_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("title", surface_r6.name)("ngClass", \u0275\u0275pureFunction1(6, _c1, ctx_r1.selectedSurface() ? ctx_r1.selectedSurface() === surface_r6.name : surface_r6.name === "slate"));
  }
}
...
var AppConfigurator = class _AppConfigurator {
  ...
  executeDarkModeToggle() {
    ...
    this.layoutService.layoutConfig.update((state) => __spreadValues(__spreadProps(__spreadValues({}, state), {
      darkTheme: willBeDark
    }), willBeDark ? { surface: "slate" } : {}));
    if (willBeDark) {
      const slateSurface = this.surfaces.find((s33) => s33.name === "slate");
      if (slateSurface?.palette) {
        s11(slateSurface.palette);
      }
    }
  }
  toggleConfigSidebar() {
...
//# sourceMappingURL=chunk-X45BWXKM.js.map
