...
var ecommerce_routes_default = [
  ...
  },
  {
    ...
    loadComponent: () => import("./chunk-OZ5QO62N.js").then((c) => c.NewProduct)
  },
  {
    path: "shopping-cart",
    data: { breadcrumb: "shopping-cart" },
    loadComponent: () => import("./chunk-YP4RODH6.js").then((c) => c.ShoppingCart)
  },
  {
    path: "checkout-form",
    data: { breadcrumb: "checkout-form" },
    loadComponent: () => import("./chunk-ZYFN4MMA.js").then((c) => c.CheckoutForm)
  },
  {
    path: "order-history",
...
//# sourceMappingURL=chunk-UR6DQWGB.js.map
