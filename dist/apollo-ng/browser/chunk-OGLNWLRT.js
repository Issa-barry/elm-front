...
var ventes_routes_default = [
  ...
  {
    path: "commandes/:id",
    loadComponent: () => import("./chunk-O2FMUWCB.js").then((c) => c.CommandeVenteDetail),
    data: { breadcrumb: "commandes" }
  },
  {
    path: "factures-vente-liste2",
    loadComponent: () => import("./chunk-JH6BKVLP.js").then((c) => c.FactureVenteListe2),
    data: { breadcrumb: "factures-vente-liste2" }
  },
  {
    path: "factures-vente-detail2/:id",
    loadComponent: () => import("./chunk-4M4THVO7.js").then((c) => c.FactureVenteDetail2),
    data: { breadcrumb: "factures-vente-detail2" }
  },
  {
    path: "factures-vente-detail3/:id",
    loadComponent: () => import("./chunk-RPWUAZAT.js").then((c) => c.FactureVenteDetail3),
    data: { breadcrumb: "factures-vente-detail2" }
  },
  {
    path: "factures-vente",
    loadComponent: () => import("./chunk-H2BW43CA.js").then((c) => c.FactureVenteListe),
  ...
  {
    path: "factures/:id",
    loadComponent: () => import("./chunk-R3KH7UYZ.js").then((c) => c.FactureVenteDetail),
    data: { breadcrumb: "factures" }
  },
  {
    path: "encaissements",
    loadComponent: () => import("./chunk-6UZWI36Q.js").then((c) => c.EncaissementVenteListe),
    data: { breadcrumb: "encaissements" }
  },
  {
    path: "commissions",
    loadComponent: () => import("./chunk-4JPA2MRD.js").then((c) => c.CommissionVenteListe),
    data: { breadcrumb: "commissions" }
  },
  {
    path: "commissions2",
    loadComponent: () => import("./chunk-KN4WULJP.js").then((c) => c.ComissionVenteListe2),
...
//# sourceMappingURL=chunk-OGLNWLRT.js.map
