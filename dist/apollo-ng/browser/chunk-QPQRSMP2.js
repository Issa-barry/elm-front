...
import {
  EyeIcon
} from "./chunk-TXC7FPAK.js";
import {
  FocusTrap
} from "./chunk-ZDDMG6HG.js";
import {
  Tag,
  TagModule
...
import {
  ChevronLeftIcon
} from "./chunk-V6PRFSIJ.js";
import {
  ChevronRightIcon
} from "./chunk-WVMZKPPT.js";
import {
  ChevronUpIcon
} from "./chunk-YCFI2AFC.js";
import {
  TimesIcon
...
var _c07 = ["indicator"];
var _c110 = ["rotaterighticon"];
var _c25 = ["rotatelefticon"];
...
function Image_button_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("ngStyle", \u0275\u0275pureFunction2(7, _c123, ctx_r1.height + "px", ctx_r1.width + "px"))("pBind", ctx_r1.ptm("previewMask"));
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
    ...
    contentQueries: function Image_ContentQueries(rf, ctx, dirIndex) {
      ...
      if (rf & 2) {
        let _t2;
        \u0275\u0275queryRefresh(_t2 = \u0275\u0275loadQuery()) && (ctx.indicatorTemplate = _t2.first);
        \u0275\u0275queryRefresh(_t2 = \u0275\u0275loadQuery()) && (ctx.rotateRightIconTemplate = _t2.first);
        \u0275\u0275queryRefresh(_t2 = \u0275\u0275loadQuery()) && (ctx.rotateLeftIconTemplate = _t2.first);
        \u0275\u0275queryRefresh(_t2 = \u0275\u0275loadQuery()) && (ctx.zoomOutIconTemplate = _t2.first);
        \u0275\u0275queryRefresh(_t2 = \u0275\u0275loadQuery()) && (ctx.zoomInIconTemplate = _t2.first);
        \u0275\u0275queryRefresh(_t2 = \u0275\u0275loadQuery()) && (ctx.closeIconTemplate = _t2.first);
        \u0275\u0275queryRefresh(_t2 = \u0275\u0275loadQuery()) && (ctx.previewTemplate = _t2.first);
        \u0275\u0275queryRefresh(_t2 = \u0275\u0275loadQuery()) && (ctx.imageTemplate = _t2.first);
        \u0275\u0275queryRefresh(_t2 = \u0275\u0275loadQuery()) && (ctx.templates = _t2);
      }
    },
    viewQuery: function Image_Query(rf, ctx) {
      ...
      if (rf & 2) {
        let _t2;
        \u0275\u0275queryRefresh(_t2 = \u0275\u0275loadQuery()) && (ctx.mask = _t2.first);
        \u0275\u0275queryRefresh(_t2 = \u0275\u0275loadQuery()) && (ctx.previewButton = _t2.first);
        \u0275\u0275queryRefresh(_t2 = \u0275\u0275loadQuery()) && (ctx.closeButton = _t2.first);
      }
    },
    hostVars: 2,
    ...
    template: function Image_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ...
        \u0275\u0275advance();
        \u0275\u0275property("ngTemplateOutlet", ctx.imageTemplate || ctx._imageTemplate)("ngTemplateOutletContext", \u0275\u0275pureFunction1(5, _c113, ctx.imageError.bind(ctx)));
        \u0275\u0275advance();
...
var ImageCompare = class _ImageCompare extends BaseComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
    ...
    contentQueries: function ImageCompare_ContentQueries(rf, ctx, dirIndex) {
      ...
      if (rf & 2) {
        let _t2;
        \u0275\u0275queryRefresh(_t2 = \u0275\u0275loadQuery()) && (ctx.leftTemplate = _t2.first);
        \u0275\u0275queryRefresh(_t2 = \u0275\u0275loadQuery()) && (ctx.rightTemplate = _t2.first);
        \u0275\u0275queryRefresh(_t2 = \u0275\u0275loadQuery()) && (ctx.templates = _t2);
      }
    },
    hostVars: 5,
...
var _c09 = () => ({ "max-width": "640px" });
var _c114 = () => ({ "left.px": 5, "top.px": 5 });
function MediaDemo_ng_template_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(3);
    \u0275\u0275property("src", \u0275\u0275interpolate1("/demo/images/product/", product_r1.image), \u0275\u0275sanitizeUrl)("alt", product_r1.name);
    \u0275\u0275advance();
    \u0275\u0275property("ngStyle", \u0275\u0275pureFunction0(9, _c114));
    \u0275\u0275advance();
...
var MediaDemo = class _MediaDemo {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MediaDemo, selectors: [["app-media-demo"]], features: [\u0275\u0275ProvidersFeature([ProductService, PhotoService])], decls: 26, vars: 10, consts: [["item", ""], ["left", ""], ["right", ""], ["thumbnail", ""], [1, "card"], [1, "font-semibold", "text-xl", "mb-6"], [3, "value", "numVisible", "numScroll", "circular", "responsiveOptions"], ["src", "https://primefaces.org/cdn/primeng/images/galleria/galleria10.jpg", "alt", "Image", "width", "250", "preview", ""], [1, "card", "flex", "flex-col"], [1, "sm:w-96!", "shadow-lg", "rounded-2xl"], [3, "value", "responsiveOptions", "containerStyle", "numVisible"], [1, "border", "border-surface", "rounded-border", "m-2", "p-6"], [1, "mb-6"], [1, "relative", "mx-auto"], [1, "w-full", "rounded-border", 3, "src", "alt"], [1, "absolute", "bg-black/70", "rounded-border", 3, "ngStyle"], [3, "value", "severity"], [1, "mb-6", "font-medium"], [1, "flex", "justify-between", "items-center"], [1, "mt-0", "font-semibold", "text-xl"], ["icon", "pi pi-heart", "severity", "secondary", 3, "outlined"], ["icon", "pi pi-shopping-cart", "styleClass", "ml-2"], ["src", "https://primefaces.org/cdn/primevue/images/compare/island1.jpg"], ["src", "https://primefaces.org/cdn/primevue/images/compare/island2.jpg"], [2, "width", "100%", 3, "src"], [3, "src"]], template: function MediaDemo_Template(rf, ctx) {
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance(18);
      \u0275\u0275property("value", ctx.images)("responsiveOptions", ctx.galleriaResponsiveOptions)("containerStyle", \u0275\u0275pureFunction0(9, _c09))("numVisible", 5);
    }
...
//# sourceMappingURL=chunk-QPQRSMP2.js.map
