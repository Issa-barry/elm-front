...
var UserCard = class _UserCard {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _UserCard, selectors: [["app-user-card"]], hostAttrs: [1, "shrink-0"], inputs: { user: "user" }, decls: 12, vars: 10, consts: [["tabindex", "0", 1, "flex", "flex-nowrap", "justify-between", "items-center", "border", "border-surface-200", "dark:border-surface-700", "rounded", "p-4", "cursor-pointer", "select-none", "hover:bg-surface-100", "dark:hover:bg-surface-800", "transition-colors", "duration-150", 3, "keydown.enter", "click"], [1, "flex", "items-center", "shrink-0"], [1, "relative", "md:mr-4", "shrink-0"], ["alt", "user", 1, "w-12", "h-12", "rounded-full", "shadow-lg", 3, "src"], [1, "w-4", "h-4", "rounded-full", "border-2", "border-surface-200", "dark:border-surface-700", "absolute", 2, "bottom", "2px", "right", "2px", 3, "ngClass"], [1, "flex-col", "hidden", "md:flex"], [1, "text-surface-900", "dark:text-surface-0", "font-semibold", "block"], [1, "block", "text-surface-600", "dark:text-surface-200", "text-ellipsis", "overflow-hidden", "whitespace-nowrap", "w-40", "text-sm"], [1, "text-surface-700", "dark:text-surface-100", "font-semibold", "ml-auto", "hidden", "md:inline"]], template: function UserCard_Template(rf, ctx) {
    if (rf & 1) {
    ...
    if (rf & 2) {
      \u0275\u0275advance(3);
      \u0275\u0275property("src", \u0275\u0275interpolate1("/demo/images/avatar/", ctx.user.image), \u0275\u0275sanitizeUrl);
      \u0275\u0275advance();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(UserCard, [{
    type: Component,
    args: [{
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ChatSidebar, [{
    type: Component,
    args: [{
...
function ChatBox_div_15_div_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("src", \u0275\u0275interpolate1("/demo/images/avatar/", ctx_r2.user.image), \u0275\u0275sanitizeUrl);
    \u0275\u0275advance(3);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ChatBox, [{
    type: Component,
    args: [{
      ...
      template: `<div class="flex flex-col h-full">
            ...
            <div class="p-4 md:p-6 lg:p-12 flex flex-col sm:flex-row items-center mt-auto border-t border-surface-200 dark:border-surface-700 gap-4">
                ...
                <div class="flex w-full sm:w-auto gap-4">
                    <button pRipple class="w-full sm:w-auto justify-center text-xl" severity="secondary" (click)="op.toggle($event)">\u{1F600}</button>
...
var Chat = class _Chat {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _Chat, selectors: [["app-chat"]], features: [\u0275\u0275ProvidersFeature([ChatService])], decls: 5, vars: 1, consts: [[1, "flex", "flex-col", "md:flex-row", "gap-8", 2, "min-height", "81vh"], [1, "md:w-100", "card", "p-0!"], [1, "flex-1", "card", "p-0!"], [3, "user"]], template: function Chat_Template(rf, ctx) {
    if (rf & 1) {
...
//# sourceMappingURL=chunk-H5BXA4IM.js.map
