...
var ProprietaireForm = class _ProprietaireForm {
  ...
  validatePhone() {
    ...
    try {
      if (!isValidPhoneNumber(phone, this.phoneCountry)) {
        this.phoneError = `Numero invalide pour ${this.getCountryName(this.phoneCountry)}.`;
        return false;
      }
      const parsed = parsePhoneNumberWithError(phone, this.phoneCountry);
      if (parsed) {
...
function VehiculeListe2_For_41_Conditional_76_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0);
  }
  if (rf & 2) {
    const v_r7 = \u0275\u0275nextContext().$implicit;
    const ctx_r4 = \u0275\u0275nextContext();
    \u0275\u0275textInterpolate1(" ", ctx_r4.getLivreur(v_r7).is_active ? "Actif" : "Inactif", " ");
  }
}
function VehiculeListe2_For_41_Conditional_77_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275text(0, " \u2014 ");
  }
}
function VehiculeListe2_For_41_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 32)(1, "div", 46);
    \u0275\u0275listener("click", function VehiculeListe2_For_41_Template_div_click_1_listener() {
      const v_r7 = \u0275\u0275restoreView(_r6).$implicit;
      const ctx_r4 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r4.toggleChevron(v_r7.id));
    });
    ...
    \u0275\u0275text(13);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(14, "div", 53)(15, "div", 56);
    \u0275\u0275element(16, "i");
    ...
    \u0275\u0275listener("click", function VehiculeListe2_For_41_Template_button_click_23_listener($event) {
      const v_r7 = \u0275\u0275restoreView(_r6).$implicit;
      const ctx_r4 = \u0275\u0275nextContext();
      ctx_r4.goEdit(v_r7);
      return \u0275\u0275resetView($event.stopPropagation());
    ...
    \u0275\u0275listener("click", function VehiculeListe2_For_41_Template_button_click_25_listener($event) {
      const v_r7 = \u0275\u0275restoreView(_r6).$implicit;
      const ctx_r4 = \u0275\u0275nextContext();
      ctx_r4.toggleChevron(v_r7.id);
      return \u0275\u0275resetView($event.stopPropagation());
    });
    \u0275\u0275element(26, "i", 63);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(27, "div")(28, "div", 64)(29, "div", 65)(30, "div", 66)(31, "div", 67)(32, "h3", 68);
    \u0275\u0275text(33, "Propri\xE9taire");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(34, "div", 69)(35, "div", 70)(36, "span", 71);
    \u0275\u0275text(37, "Nom");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(38, "span", 72);
    \u0275\u0275text(39);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(40, "div", 70)(41, "span", 71);
    \u0275\u0275text(42, "Phone");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(43, "span", 72);
    \u0275\u0275text(44);
    \u0275\u0275pipe(45, "phoneFormat");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(46, "div", 70)(47, "span", 71);
    \u0275\u0275text(48, "Ville");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(49, "span", 72);
    \u0275\u0275text(50);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(51, "div", 70)(52, "span", 71);
    \u0275\u0275text(53, "Date de cr\xE9ation");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(54, "span", 72);
    \u0275\u0275text(55);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(56, "div", 66)(57, "div", 67)(58, "h3", 68);
    \u0275\u0275text(59, "Livreur principal");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(60, "div", 69)(61, "div", 70)(62, "span", 71);
    \u0275\u0275text(63, "Nom");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(64, "span", 72);
    \u0275\u0275text(65);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(66, "div", 70)(67, "span", 71);
    \u0275\u0275text(68, "Phone");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(69, "span", 72);
    \u0275\u0275text(70);
    \u0275\u0275pipe(71, "phoneFormat");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(72, "div", 70)(73, "span", 71);
    \u0275\u0275text(74, "Statut");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(75, "span", 72);
    \u0275\u0275conditionalCreate(76, VehiculeListe2_For_41_Conditional_76_Template, 1, 1)(77, VehiculeListe2_For_41_Conditional_77_Template, 1, 0);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(78, "div", 70)(79, "span", 71);
    \u0275\u0275text(80, "Date de cr\xE9ation");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(81, "span", 72);
    \u0275\u0275text(82);
    \u0275\u0275elementEnd()()()()()()()();
  }
  if (rf & 2) {
    ...
    const ctx_r4 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("pStyleClass", \u0275\u0275interpolate1(".order-content-", v_r7.id));
    \u0275\u0275advance(2);
    \u0275\u0275property("src", v_r7.photo_url || "", \u0275\u0275sanitizeUrl)("alt", v_r7.nom_vehicule);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(v_r7.nom_vehicule);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(v_r7.immatriculation);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r4.getTypeLabel(v_r7));
    \u0275\u0275advance(2);
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction3(35, _c07, ctx_r4.getStatusColor(v_r7) === "surface", ctx_r4.getStatusColor(v_r7) === "orange", ctx_r4.getStatusColor(v_r7) === "green"));
    \u0275\u0275advance();
    \u0275\u0275classMap("text-xs pi " + ctx_r4.getStatusIcon(v_r7) + " " + (ctx_r4.getStatusColor(v_r7) === "surface" ? "text-surface-600 dark:text-surface-300" : ctx_r4.getStatusColor(v_r7) === "orange" ? "text-orange-700 dark:text-orange-300" : "text-green-700 dark:text-green-300"));
    \u0275\u0275advance();
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction3(39, _c15, ctx_r4.getStatusColor(v_r7) === "surface", ctx_r4.getStatusColor(v_r7) === "orange", ctx_r4.getStatusColor(v_r7) === "green"));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r4.getStatusLabel(v_r7));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(v_r7.capacite_packs);
    \u0275\u0275advance(2);
    \u0275\u0275property("text", true)("rounded", true);
    \u0275\u0275advance(2);
    \u0275\u0275property("pStyleClass", \u0275\u0275interpolate1(".order-content-", v_r7.id))("text", true)("rounded", true);
    \u0275\u0275advance();
    \u0275\u0275classMap("pi pi-chevron-down chevron-icon-" + v_r7.id + " transition-transform duration-300");
    \u0275\u0275advance();
    \u0275\u0275classMap("order-content-" + v_r7.id + " hidden overflow-hidden");
    \u0275\u0275advance(12);
    \u0275\u0275textInterpolate(ctx_r4.getProprietaireNom(v_r7));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(45, 31, v_r7.proprietaire == null ? null : v_r7.proprietaire.phone));
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate((v_r7.proprietaire == null ? null : v_r7.proprietaire.ville) || "\u2014");
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r4.formatDate(v_r7.created_at));
    \u0275\u0275advance(10);
    \u0275\u0275textInterpolate(ctx_r4.getLivreurNom(v_r7));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(71, 33, (tmp_35_0 = ctx_r4.getLivreur(v_r7)) == null ? null : tmp_35_0.phone));
    \u0275\u0275advance(6);
    \u0275\u0275conditional(ctx_r4.getLivreur(v_r7) ? 76 : 77);
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(ctx_r4.formatDate(v_r7.created_at));
  }
}
...
var VehiculeListe2 = class _VehiculeListe2 {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _VehiculeListe2, selectors: [["app-vehicule-liste2"]], features: [\u0275\u0275ProvidersFeature([MessageService])], decls: 43, vars: 14, consts: [["filterMenu", ""], [1, "vehicules-mobile-app"], [1, "mobile-header"], ["pButton", "", "pRipple", "", "icon", "pi pi-arrow-left", "aria-label", "Retour", 1, "p-button-rounded", "p-button-text", "mobile-back", 3, "click"], [1, "mobile-title-wrap"], [1, "mobile-title"], [1, "mobile-subtitle"], ["appendTo", "body", "styleClass", "mobile-filter-menu", 3, "model", "popup"], ["pButton", "", "pRipple", "", "icon", "pi pi-filter", "aria-label", "Filtrer", 1, "p-button-rounded", "p-button-text", "mobile-add", 3, "click"], [1, "mobile-scroll"], [1, "mobile-search"], ["iconPosition", "left"], [1, "pi", "pi-search"], ["pInputText", "", "type", "text", "placeholder", "Nom, immatriculation\u2026", 1, "w-full", 3, "ngModelChange", "ngModel"], [1, "mobile-list"], [1, "mobile-state"], ["type", "button", "aria-label", "Nouveau v\xE9hicule", 1, "mobile-fab", 3, "click"], [1, "pi", "pi-plus"], [1, "vehicules-desktop", "bg-surface-0", "dark:bg-surface-900", "p-12", "md:p-20"], [1, "flex", "flex-col", "lg:flex-row", "md:justify-between", "items-start", "lg:items-end", "gap-4", "mb-8"], [1, "flex", "flex-col", "gap-2", "flex-1"], [1, "text-surface-900", "dark:text-surface-0", "text-2xl", "font-semibold", "leading-tight"], [1, "text-surface-500", "dark:text-surface-400", "text-xl", "leading-tight"], [1, "flex", "flex-col", "md:flex-row", "items-start", "md:items-end", "gap-4"], [1, "w-full", "md:w-54"], [1, "pi", "pi-search", "text-surface-400"], ["pInputText", "", "placeholder", "Search", 1, "w-full", "px-3", "py-2", "bg-surface-0", "dark:bg-surface-900", "border", "border-surface-300", "dark:border-surface-600", "rounded-md", "text-surface-900", "dark:text-surface-0", 3, "ngModelChange", "ngModel"], [1, "w-full", "md:w-auto"], ["optionLabel", "label", "optionValue", "value", "placeholder", "Filter", "styleClass", "w-full md:w-40 bg-surface-0 dark:bg-surface-900 border border-surface-300 dark:border-surface-600", 3, "ngModelChange", "ngModel", "options", "appendTo"], ["pTemplate", "dropdownicon"], ["pButton", "", "type", "button", "icon", "pi pi-plus", "label", "Nouveau vehicule", 1, "w-full", "md:w-auto", 3, "click"], [1, "flex", "flex-col", "gap-6"], [1, "bg-surface-0", "dark:bg-surface-900", "border", "border-surface-200", "dark:border-surface-700", "rounded-lg", "overflow-hidden", "transition-all", "duration-300"], [1, "text-center", "py-12"], [1, "mobile-vehicule-card"], [1, "mobile-vehicule-card", 3, "click"], [1, "mobile-card-avatar-img", 3, "src", "alt"], ["aria-hidden", "true", 1, "mobile-card-avatar"], [1, "mobile-card-body"], [1, "mobile-card-name"], [1, "mobile-card-meta"], [1, "mobile-card-footer"], ["styleClass", "mobile-status-tag", 3, "value", "severity"], [1, "mobile-card-actions"], ["pButton", "", "pRipple", "", "icon", "pi pi-pencil", "pTooltip", "Modifier", "tooltipPosition", "top", 1, "p-button-rounded", "p-button-text", "p-button-sm", 3, "click"], [1, "pi", "pi-chevron-down", "text-surface-400"], ["enterFromClass", "hidden", "enterActiveClass", "animate-slidedown", "leaveToClass", "hidden", "leaveActiveClass", "animate-slideup", 1, "p-6", "flex", "flex-col", "lg:flex-row", "justify-start", "lg:items-center", "gap-6", "cursor-pointer", "hover:bg-surface-50", "dark:hover:bg-surface-800", "transition-colors", 3, "click", "pStyleClass"], [1, "flex", "items-center", "gap-4", "flex-1"], [1, "w-12", "h-12", "rounded", "object-cover", 3, "src", "alt"], [1, "flex", "flex-col", "gap-2"], [1, "text-surface-900", "dark:text-surface-0", "text-lg", "font-medium", "leading-tight"], [1, "text-surface-500", "dark:text-surface-400", "text-base", "leading-tight"], [1, "flex", "flex-col", "sm:flex-row", "items-start", "sm:items-center", "gap-3", "sm:gap-4", "flex-1"], [1, "flex", "flex-col", "items-start", "sm:items-center", "flex-1", "min-w-0"], [1, "px-2", "py-1", "bg-surface-100", "dark:bg-surface-800", "rounded-md"], [1, "text-surface-600", "dark:text-surface-300", "text-sm", "font-bold"], [3, "ngClass"], [1, "flex", "flex-col", "items-start", "sm:items-center", "flex-1"], [1, "text-surface-700", "dark:text-surface-300", "text-base", "font-semibold", "leading-tight"], [1, "flex", "items-center", "justify-center", "gap-1", "flex-1"], ["pButton", "", "severity", "secondary", "pTooltip", "Modifier", "tooltipPosition", "top", 1, "w-10", "h-10", 3, "click", "text", "rounded"], ["pButtonIcon", "", 1, "pi", "pi-pencil"], ["pButton", "", "severity", "secondary", "enterFromClass", "hidden", "enterActiveClass", "animate-slidedown", "leaveToClass", "hidden", "leaveActiveClass", "animate-slideup", 1, "w-10", "h-10", 3, "click", "text", "rounded", "pStyleClass"], ["pButtonIcon", ""], [1, "flex", "flex-col", "gap-6", "p-6", "border-t", "border-surface-200", "dark:border-surface-700"], [1, "grid", "grid-cols-1", "lg:grid-cols-2", "gap-6"], [1, "border", "border-surface-200", "dark:border-surface-700", "rounded-lg", "overflow-hidden"], [1, "p-4", "bg-surface-50", "dark:bg-surface-800", "border-b", "border-surface-200", "dark:border-surface-700"], [1, "text-surface-900", "dark:text-surface-0", "text-base", "font-semibold", "leading-tight"], [1, "p-6", "flex", "flex-col", "gap-5"], [1, "flex", "gap-2"], [1, "w-40", "text-surface-700", "dark:text-surface-300", "text-base", "leading-tight"], [1, "flex-1", "text-surface-900", "dark:text-surface-0", "text-base", "font-medium", "leading-tight"], [1, "text-surface-500", "dark:text-surface-400", "text-lg", "mb-2"], [1, "text-surface-400", "dark:text-surface-500", "text-base"]], template: function VehiculeListe2_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275repeaterCreate(40, VehiculeListe2_For_41_Template, 83, 43, "div", 32, _forTrack02);
    ...
    @if (!loading && filteredOrders().length) {\r
      <section class="mobile-list">\r
        @for (v of filteredOrders(); track v.id) {\r
          <article class="mobile-vehicule-card" (click)="goEdit(v)">\r
\r
            <!-- Avatar : photo si disponible, sinon initiales -->\r
            @if (v.photo_url) {\r
              <img class="mobile-card-avatar-img" [src]="v.photo_url" [alt]="v.nom_vehicule" />\r
            } @else {\r
              <div class="mobile-card-avatar" aria-hidden="true">\r
                {{ getInitials(v.nom_vehicule) }}\r
              </div>\r
            }\r
\r
            <div class="mobile-card-body">\r
        ...
        @for (v of filteredOrders(); track v.id; let index = $index) {\r
            <div class="bg-surface-0 dark:bg-surface-900 border border-surface-200 dark:border-surface-700 rounded-lg overflow-hidden transition-all duration-300">\r
                <div\r
                    ...
                    (click)="toggleChevron(v.id)"\r
                >\r
                    <div class="flex items-center gap-4 flex-1">\r
                        <img class="w-12 h-12 rounded object-cover" [src]="v.photo_url || ''" [alt]="v.nom_vehicule" />\r
                        <div class="flex flex-col gap-2">\r
                            <div class="text-surface-900 dark:text-surface-0 text-lg font-medium leading-tight">{{ v.nom_vehicule }}</div>\r
                            <div class="text-surface-500 dark:text-surface-400 text-base leading-tight">{{ v.immatriculation }}</div>\r
                        </div>\r
                    </div>\r
\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(VehiculeListe2, { className: "VehiculeListe2", filePath: "src/app/pages/vehicules/vehicules/vehicule-liste2/vehicule-liste2.ts", lineNumber: 51 });
})();
...
//# sourceMappingURL=chunk-UJG5Y7QO.js.map
