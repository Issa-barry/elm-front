          ...
          <article class="cpt-mobile-card" (click)="goToDetail(item)">\r
            ...
            <div class="cpt-card-body">\r
              ...
              <div class="cpt-card-footer">\r
                <p-tag\r
                  [value]="getStatutLabel(item.statut)"\r
                  [severity]="getStatutSeverity(item.statut)"\r
                  styleClass="cpt-status-tag"\r
                />\r
...
\r
    <ng-template #body let-item>\r
      <tr>\r
        ...
        <td>\r
          <p-tag [value]="getStatutLabel(item.statut)" [severity]="getStatutSeverity(item.statut)" />\r
        </td>\r
        <td>\r
...
//# sourceMappingURL=chunk-NATYMLDQ.js.map
