import {
  FileUploadModule
} from "./chunk-UEZEUWI7.js";
import "./chunk-WGK37CVP.js";
import {
  isValidPhoneNumber,
...
function PrestateursFrom_div_48_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("click", function PrestateursFrom_div_48_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
...
var PrestateursFrom = class _PrestateursFrom {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PrestateursFrom, selectors: [["app-prestateurs-from"]], inputs: { mode: "mode", initialData: "initialData", loading: "loading" }, outputs: { submitForm: "submitForm", cancel: "cancel" }, features: [\u0275\u0275NgOnChangesFeature], decls: 49, vars: 31, consts: [[1, "card"], [1, "flex", "justify-between", "items-center", "mb-6"], [1, "text-surface-900", "dark:text-surface-0", "text-xl", "font-bold"], [1, "grid", "grid-cols-12", "gap-4"], [1, "col-span-12", "lg:col-span-2"], [1, "text-surface-900", "dark:text-surface-0", "font-medium", "text-xl", "mb-4"], [1, "m-0", "p-0", "text-surface-600", "dark:text-surface-200", "leading-normal", "mr-4"], [1, "col-span-12", "lg:col-span-10"], [1, "mb-6", "col-span-12", "md:col-span-12"], ["for", "type", 1, "font-medium", "text-surface-900", "dark:text-surface-0", "mb-2", "block"], ["class", "text-red-500", 4, "ngIf"], ["id", "type", "optionLabel", "label", "optionValue", "value", "placeholder", "S\xE9lectionner un type", "fluid", "", 3, "ngModelChange", "ngModel", "options", "disabled", "invalid"], ["class", "mb-6 col-span-12 md:col-span-12", 4, "ngIf"], ["class", "mb-6 col-span-12 md:col-span-6", 4, "ngIf"], [1, "mb-6", "col-span-12"], [1, "grid", "grid-cols-12", "gap-3"], [1, "col-span-12", "md:col-span-4"], ["for", "codePays", 1, "font-medium", "text-surface-900", "dark:text-surface-0", "mb-3", "block"], ["id", "codePays", "optionLabel", "name", "optionValue", "code", "placeholder", "S\xE9lectionner un pays", "fluid", "", 3, "ngModelChange", "onChange", "ngModel", "options", "disabled"], ["pTemplate", "item"], ["pTemplate", "selectedItem"], [1, "col-span-12", "md:col-span-8"], ["for", "phone", 1, "font-medium", "text-surface-900", "dark:text-surface-0", "mb-3", "block"], ["id", "phone", "type", "tel", "pInputText", "", "fluid", "", "placeholder", "Exemple: 622 00 00 00", 3, "ngModelChange", "input", "blur", "ngModel", "invalid", "disabled"], ["class", "text-red-500 block mt-2", 4, "ngIf"], [1, "mb-6", "col-span-12", "md:col-span-6"], ["for", "ville", 1, "font-medium", "text-surface-900", "dark:text-surface-0", "mb-2", "block"], ["id", "ville", "type", "text", "pInputText", "", "fluid", "", 3, "ngModelChange", "ngModel", "invalid", "disabled"], ["for", "quartier", 1, "font-medium", "text-surface-900", "dark:text-surface-0", "mb-2", "block"], ["id", "quartier", "type", "text", "pInputText", "", "fluid", "", 3, "ngModelChange", "ngModel", "invalid", "disabled"], ["class", "col-span-12 prestateurs-form-actions", 4, "ngIf"], [1, "text-red-500"], ["for", "raison_sociale", 1, "font-medium", "text-surface-900", "dark:text-surface-0", "mb-2", "block"], ["id", "raison_sociale", "type", "text", "pInputText", "", "fluid", "", 3, "ngModelChange", "ngModel", "invalid", "disabled"], ["for", "nom", 1, "font-medium", "text-surface-900", "dark:text-surface-0", "mb-2", "block"], ["id", "nom", "type", "text", "pInputText", "", "fluid", "", 3, "ngModelChange", "ngModel", "invalid", "disabled"], ["for", "prenom", 1, "font-medium", "text-surface-900", "dark:text-surface-0", "mb-2", "block"], ["id", "prenom", "type", "text", "pInputText", "", "fluid", "", 3, "ngModelChange", "ngModel", "invalid", "disabled"], [1, "flex", "items-center", "gap-2"], [1, "w-5", "h-auto", "rounded-sm", 3, "src", "alt"], [1, "font-semibold", "text-primary"], ["class", "flex items-center gap-2", 4, "ngIf"], [1, "text-red-500", "block", "mt-2"], [1, "col-span-12", "prestateurs-form-actions"], [1, "flex", "flex-wrap", "items-center", "gap-3"], ["pButton", "", "pRipple", "", "icon", "pi pi-check", 1, "prestateurs-form-submit", 3, "click", "label", "loading", "disabled"], ["pButton", "", "pRipple", "", "label", "Annuler", "icon", "pi pi-times", "severity", "secondary", 1, "prestateurs-form-cancel", 3, "click", "disabled"]], template: function PrestateursFrom_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275template(48, PrestateursFrom_div_48_Template, 4, 4, "div", 30);
      \u0275\u0275elementEnd()()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(3);
    ...
    NgControlStatus,
    NgModel
  ], styles: ["\n\n.prestateurs-form-actions[_ngcontent-%COMP%] {\n  margin-top: 0.5rem;\n  padding-top: 0.5rem;\n}\n.prestateurs-form-actions[_ngcontent-%COMP%]   .flex[_ngcontent-%COMP%] {\n  align-items: center;\n}\n.prestateurs-form-actions[_ngcontent-%COMP%]     .p-button {\n  min-height: 2.5rem;\n  min-width: 7rem;\n}\n@media (max-width: 768px) {\n  .prestateurs-form-actions[_ngcontent-%COMP%]   .flex[_ngcontent-%COMP%] {\n    flex-direction: column;\n    width: 100%;\n  }\n  .prestateurs-form-actions[_ngcontent-%COMP%]     .p-button {\n    width: 100%;\n    justify-content: center;\n    min-width: unset;\n  }\n}\n/*# sourceMappingURL=prestateurs-from.css.map */"] });
};
(() => {
  ...
  <div class="grid grid-cols-12 gap-4">
    <div class="col-span-12 lg:col-span-2">
      ...
      <p class="m-0 p-0 text-surface-600 dark:text-surface-200 leading-normal mr-4">
       Les champs s'affiche en fonctin du type de prestateur.
      </p>
    </div>
    ...
    <div class="col-span-12 lg:col-span-10">
      <div class="grid grid-cols-12 gap-4">
        ...
        <!-- Raison sociale (visible uniquement pour fournisseur) -->
        ...
        <!-- Nom (masqu\xE9 pour fournisseur) -->
        ...
        <!-- Pr\xE9nom (masqu\xE9 pour fournisseur) -->
        <div class="mb-6 col-span-12 md:col-span-6" *ngIf="model.type !== 'fournisseur'">
        ...
        <!-- T\xE9l\xE9phone avec s\xE9lecteur de pays -->
        <div class="mb-6 col-span-12">
          ...
          <!-- Messages d'erreur pour le t\xE9l\xE9phone -->
          ...
          <!-- <small class="text-surface-500 dark:text-surface-400 block mt-2" *ngIf="isEditing && !phoneError && !fieldsDisabled">
            Format: {{ getCountryName(phoneCountry) }} ({{ getSelectedCountryDialCode() }})
          </small> -->
        </div>
        ...
        <!-- Boutons -->
        <div class="col-span-12 prestateurs-form-actions" *ngIf="isEditing">
...
`, styles: ["/* src/app/pages/contacts/prestateurs/prestateurs-from/prestateurs-from.scss */\n.prestateurs-form-actions {\n  margin-top: 0.5rem;\n  padding-top: 0.5rem;\n}\n.prestateurs-form-actions .flex {\n  align-items: center;\n}\n.prestateurs-form-actions ::ng-deep .p-button {\n  min-height: 2.5rem;\n  min-width: 7rem;\n}\n@media (max-width: 768px) {\n  .prestateurs-form-actions .flex {\n    flex-direction: column;\n    width: 100%;\n  }\n  .prestateurs-form-actions ::ng-deep .p-button {\n    width: 100%;\n    justify-content: center;\n    min-width: unset;\n  }\n}\n/*# sourceMappingURL=prestateurs-from.css.map */\n"] }]
  }], null, { mode: [{
    type: Input
  }], initialData: [{
    type: Input
...
//# sourceMappingURL=chunk-G7RIR5IN.js.map
