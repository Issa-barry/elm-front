...
function RolesListe_ng_template_5_p_button_0_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "p-button", 15);
    \u0275\u0275listener("onClick", function RolesListe_ng_template_5_p_button_0_Template_p_button_onClick_0_listener() {
      \u0275\u0275restoreView(_r4);
...
function RolesListe_ng_template_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, RolesListe_ng_template_5_p_button_0_Template, 1, 0, "p-button", 14);
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function RolesListe_ng_template_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 16)(1, "h5", 17);
...
function RolesListe_ng_template_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(3, "Nom ");
    \u0275\u0275element(4, "p-sortIcon", 22);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "th", 23)(6, "span", 24);
    \u0275\u0275text(7, "Permissions");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(8, "th", 25)(9, "span", 21);
...
function RolesListe_ng_template_13_p_button_12_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "p-button", 37);
    \u0275\u0275listener("click", function RolesListe_ng_template_13_p_button_12_Template_p_button_click_0_listener($event) {
      \u0275\u0275restoreView(_r9);
...
function RolesListe_ng_template_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(1, "td")(2, "div", 29)(3, "span", 30);
    \u0275\u0275element(4, "i", 31);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275element(8, "p-tag", 33);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "td", 34);
    \u0275\u0275text(10);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(11, "td", 23);
    \u0275\u0275template(12, RolesListe_ng_template_13_p_button_12_Template, 1, 2, "p-button", 35);
    \u0275\u0275elementStart(13, "p-button", 36);
...
var RolesListe = class _RolesListe {
  ...
  static \u0275fac = function RolesListe_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _RolesListe)(\u0275\u0275directiveInject(RoleService), \u0275\u0275directiveInject(AuthService), \u0275\u0275directiveInject(MessageService), \u0275\u0275directiveInject(ConfirmationService), \u0275\u0275directiveInject(Router));
  };
  ...
  }, features: [\u0275\u0275ProvidersFeature([MessageService, ConfirmationService])], decls: 23, vars: 20, consts: [["start", ""], ["end", ""], ["dt", ""], ["caption", ""], ["header", ""], ["body", ""], ["emptymessage", ""], ["content", ""], ["footer", ""], [1, "card"], ["styleClass", "mb-12"], ["dataKey", "role.id", "currentPageReportTemplate", "Affichage {first} \xE0 {last} sur {totalRecords} r\xF4les", 3, "value", "rows", "paginator", "globalFilterFields", "tableStyle", "rowHover", "showCurrentPageReport", "rowsPerPageOptions", "loading"], ["header", "Nouveau r\xF4le", 3, "visibleChange", "visible", "modal"], ["icon", "pi pi-arrow-left", "severity", "secondary", "pTooltip", "Retour param\xE9tres", 3, "onClick", "text", "rounded"], ["label", "Ajouter un r\xF4le", "icon", "pi pi-plus", "severity", "secondary", 3, "onClick", 4, "ngIf"], ["label", "Ajouter un r\xF4le", "icon", "pi pi-plus", "severity", "secondary", 3, "onClick"], [1, "flex", "items-center", "justify-between"], [1, "m-0"], ["styleClass", "pi pi-search"], ["pInputText", "", "type", "text", "placeholder", "Rechercher...", 3, "input"], ["pSortableColumn", "role.name"], [1, "col-header"], ["field", "role.name"], [1, "text-center"], [1, "col-header", "justify-center"], ["pSortableColumn", "role.created_at"], ["field", "role.created_at"], [1, "text-center", 2, "width", "8rem"], [1, "table-row", 3, "dblclick"], [1, "cell-role"], [1, "cell-role__icon"], [1, "pi", "pi-shield"], [1, "cell-role__name"], ["severity", "info", 3, "value"], [1, "cell-secondary"], ["icon", "pi pi-trash", "severity", "danger", "pTooltip", "Supprimer", "class", "mr-2", 3, "text", "rounded", "click", 4, "ngIf"], ["icon", "pi pi-arrow-right", "severity", "secondary", "pTooltip", "Voir / Modifier", 3, "click", "text", "rounded"], ["icon", "pi pi-trash", "severity", "danger", "pTooltip", "Supprimer", 1, "mr-2", 3, "click", "text", "rounded"], ["colspan", "4"], [1, "empty-state"], [1, "flex", "flex-col", "gap-4"], ["for", "roleName", 1, "block", "font-bold", "mb-2"], ["pInputText", "", "id", "roleName", "placeholder", "Ex: editeur, manager...", 1, "w-full", 3, "ngModelChange", "keydown.enter", "ngModel"], ["label", "Annuler", "icon", "pi pi-times", 3, "click", "text", "disabled"], ["label", "Cr\xE9er", "icon", "pi pi-check", 3, "click", "disabled", "loading"]], template: function RolesListe_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
      \u0275\u0275element(0, "p-toast");
      \u0275\u0275elementStart(1, "div", 9)(2, "p-toolbar", 10);
      \u0275\u0275template(3, RolesListe_ng_template_3_Template, 1, 2, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(5, RolesListe_ng_template_5_Template, 1, 1, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(7, "p-table", 11, 2);
      \u0275\u0275template(9, RolesListe_ng_template_9_Template, 6, 0, "ng-template", null, 3, \u0275\u0275templateRefExtractor)(11, RolesListe_ng_template_11_Template, 13, 0, "ng-template", null, 4, \u0275\u0275templateRefExtractor)(13, RolesListe_ng_template_13_Template, 14, 10, "ng-template", null, 5, \u0275\u0275templateRefExtractor)(15, RolesListe_ng_template_15_Template, 6, 0, "ng-template", null, 6, \u0275\u0275templateRefExtractor);
      \u0275\u0275elementEnd()();
...
<div class="card">
    <p-toolbar styleClass="mb-12">
        ...
        <ng-template #end>
            <p-button *ngIf="isSuperAdmin()" label="Ajouter un r\xF4le" icon="pi pi-plus" severity="secondary" (onClick)="openCreateDialog()" />
        </ng-template>
    </p-toolbar>
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(RolesListe, { className: "RolesListe", filePath: "src/app/pages/roles/roles-liste/roles-liste.ts", lineNumber: 44 });
})();
...
function RolesEdit_div_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("disabled", ctx_r1.originalName === "admin_entreprise" || !ctx_r1.isSuperAdmin());
  }
}
...
function RolesEdit_p_button_7_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "p-button", 11);
    \u0275\u0275listener("click", function RolesEdit_p_button_7_Template_p_button_click_0_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275property("loading", ctx_r1.saving)("disabled", ctx_r1.loading || ctx_r1.saving);
  }
}
function RolesEdit_div_8_div_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275pipe(3, "uppercase");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "p-checkbox", 20);
    \u0275\u0275listener("onChange", function RolesEdit_div_8_div_6_Template_p_checkbox_onChange_4_listener() {
      ...
      return \u0275\u0275resetView(ctx_r1.toggleColumn(action_r5));
    });
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(3, 5, action_r5));
    \u0275\u0275advance(2);
    \u0275\u0275property("binary", true)("ngModel", ctx_r1.isColumnAllChecked(action_r5))("indeterminate", ctx_r1.isColumnIndeterminate(action_r5))("disabled", ctx_r1.isColumnToggleDisabled(action_r5) || !ctx_r1.isSuperAdmin());
  }
}
function RolesEdit_div_8_div_7_div_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 18)(1, "p-checkbox", 23);
    \u0275\u0275listener("onChange", function RolesEdit_div_8_div_7_div_5_Template_p_checkbox_onChange_1_listener() {
      ...
      const module_r7 = \u0275\u0275nextContext().$implicit;
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.togglePermission(module_r7, action_r9));
    });
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275property("binary", true)("ngModel", module_r7.permissions[action_r9])("disabled", !ctx_r1.isActionAllowed(module_r7, action_r9) || !ctx_r1.isSuperAdmin());
  }
}
function RolesEdit_div_8_div_7_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 21)(1, "div", 15)(2, "p-checkbox", 20);
    \u0275\u0275listener("onChange", function RolesEdit_div_8_div_7_Template_p_checkbox_onChange_2_listener() {
      ...
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.toggleRow(module_r7));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "span", 22);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(5, RolesEdit_div_8_div_7_div_5_Template, 2, 3, "div", 16);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275classProp("permission-matrix__row--alt", odd_r10);
    \u0275\u0275advance(2);
    \u0275\u0275property("binary", true)("ngModel", ctx_r1.isRowAllChecked(module_r7))("indeterminate", ctx_r1.isRowIndeterminate(module_r7))("disabled", ctx_r1.isRowToggleDisabled(module_r7) || !ctx_r1.isSuperAdmin());
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(module_r7.module);
    \u0275\u0275advance();
...
function RolesEdit_div_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 0)(1, "h5", 12);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 13)(4, "div", 14);
    \u0275\u0275element(5, "div", 15);
    \u0275\u0275template(6, RolesEdit_div_8_div_6_Template, 5, 7, "div", 16);
    \u0275\u0275elementEnd();
    \u0275\u0275template(7, RolesEdit_div_8_div_7_Template, 6, 8, "div", 17);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function RolesEdit_div_9_div_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(1, "p-skeleton", 27)(2, "p-skeleton", 28)(3, "p-skeleton", 28)(4, "p-skeleton", 28)(5, "p-skeleton", 28);
    \u0275\u0275elementEnd();
  }
}
function RolesEdit_div_9_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(1, "p-skeleton", 24);
    \u0275\u0275template(2, RolesEdit_div_9_div_2_Template, 6, 0, "div", 25);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    \u0275\u0275advance(2);
...
var RolesEdit = class _RolesEdit {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RolesEdit, selectors: [["app-roles-edit"]], features: [\u0275\u0275ProvidersFeature([MessageService])], decls: 10, vars: 7, consts: [[1, "card"], [1, "role-header"], [1, "role-header__left"], ["icon", "pi pi-arrow-left", "severity", "secondary", "pTooltip", "Retour", 3, "click", "text", "rounded"], ["class", "role-header__title", 4, "ngIf"], ["width", "200px", "height", "2.2rem", 4, "ngIf"], ["label", "Sauvegarder", "icon", "pi pi-save", 3, "loading", "disabled", "click", 4, "ngIf"], ["class", "card", 4, "ngIf"], [1, "role-header__title"], ["pInputText", "", 1, "role-name-input", 3, "ngModelChange", "blur", "keydown.enter", "ngModel", "disabled"], ["width", "200px", "height", "2.2rem"], ["label", "Sauvegarder", "icon", "pi pi-save", 3, "click", "loading", "disabled"], [1, "permission-title"], [1, "permission-matrix"], [1, "permission-matrix__header"], [1, "permission-matrix__module-col"], ["class", "permission-matrix__action-col", 4, "ngFor", "ngForOf"], ["class", "permission-matrix__row", 3, "permission-matrix__row--alt", 4, "ngFor", "ngForOf"], [1, "permission-matrix__action-col"], [1, "permission-matrix__action-label"], [3, "onChange", "binary", "ngModel", "indeterminate", "disabled"], [1, "permission-matrix__row"], [1, "permission-matrix__module-name"], [3, "onChange", "binary", "ngModel", "disabled"], ["width", "250px", "height", "1.5rem", "styleClass", "mb-6"], ["class", "flex items-center gap-8 mb-4", 4, "ngFor", "ngForOf"], [1, "flex", "items-center", "gap-8", "mb-4"], ["width", "140px", "height", "1.2rem"], ["width", "24px", "height", "24px"]], template: function RolesEdit_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275element(0, "p-toast");
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275template(7, RolesEdit_p_button_7_Template, 1, 2, "p-button", 6);
      \u0275\u0275elementEnd()();
        ...
        <div class="role-header__left">
            ...
            <div class="role-header__title" *ngIf="!loading">
                <input
                    ...
                    [disabled]="originalName === 'admin_entreprise' || !isSuperAdmin()"
                />
            </div>
        ...
        <div class="permission-matrix__header">
            ...
            <div class="permission-matrix__action-col" *ngFor="let action of actions">
                ...
                <p-checkbox
                    ...
                    [disabled]="isColumnToggleDisabled(action) || !isSuperAdmin()"
                />
            </div>
        </div>
        ...
        >
            <div class="permission-matrix__module-col">
                <p-checkbox
                    ...
                    [disabled]="isRowToggleDisabled(module) || !isSuperAdmin()"
                />
            ...
            <div class="permission-matrix__action-col" *ngFor="let action of actions">
                <p-checkbox
                    ...
                    [disabled]="!isActionAllowed(module, action) || !isSuperAdmin()"
                />
            </div>
        </div>
    </div>
...
//# sourceMappingURL=chunk-VKTBXA65.js.map
