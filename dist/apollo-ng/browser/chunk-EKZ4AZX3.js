...
import {
  StatCardWidget
} from "./chunk-4AS5ZARB.js";
import "./chunk-6DPCLPVB.js";
import {
...
function CommissionVenteListe_Conditional_1_For_12_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("title", card_r3.title)("value", card_r3.value)("subtitle", card_r3.subtitle)("loading", ctx_r1.statsLoading())("variant", card_r3.variant);
  }
}
...
function CommissionVenteListe_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(11, CommissionVenteListe_Conditional_1_For_12_Template, 1, 5, "app-stat-card-widget", 16, _forTrack0);
    \u0275\u0275elementEnd();
...
function CommissionVenteListe_Conditional_2_For_2_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275property("title", card_r9.title)("value", card_r9.value)("subtitle", card_r9.subtitle)("loading", ctx_r1.statsLoading())("variant", card_r9.variant);
  }
}
...
function CommissionVenteListe_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, CommissionVenteListe_Conditional_2_For_2_Template, 1, 5, "app-stat-card-widget", 16, _forTrack0);
    \u0275\u0275elementEnd();
...
var CommissionVenteListe = class _CommissionVenteListe {
  ...
  commissionStats = signal({
    totalCommission: 0,
    partLivreur: 0,
    partProprietaire: 0,
    count: 0
  }, ...ngDevMode ? [{ debugName: "commissionStats" }] : []);
  ...
  loadCommissionStats() {
    ...
    this.commissionService.getAll(this.buildStatsParams(1, perPage)).pipe(switchMap((resp) => {
      ...
      const requests = Array.from({ length: lastPage - 1 }, (_, idx) => this.commissionService.getAll(this.buildStatsParams(idx + 2, perPage)));
      ...
      next: (rows) => {
        const stats = rows.reduce((acc, item) => {
          ...
          acc.count += 1;
          return acc;
        }, { totalCommission: 0, partLivreur: 0, partProprietaire: 0, count: 0 });
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CommissionVenteListe, { className: "CommissionVenteListe", filePath: "src/app/pages/ventes/commission-vente-liste/commission-vente-liste.ts", lineNumber: 70 });
})();
export {
  CommissionVenteListe
};
//# sourceMappingURL=chunk-EKZ4AZX3.js.map
