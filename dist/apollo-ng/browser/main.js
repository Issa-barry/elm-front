import {
  AppConfigurator,
  Qr
} from "./chunk-U7XNCY2K.js";
import {
  Drawer,
  DrawerModule
} from "./chunk-PYDUWKI2.js";
import {
  LayoutService
...
var AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
   ...
   */
  loadImpl() {
    const loadFn = () => this.moduleImpl ?? import("./chunk-UYQC4HVR.js").then((m) => m);
...
var AppTopbar = class _AppTopbar {
  ...
  }, attrs: _c1, decls: 17, vars: 0, consts: [["menubutton", ""], [1, "layout-topbar"], [1, "topbar-start"], ["type", "button", 1, "topbar-menubutton", "p-link", "p-trigger", "hover:cursor-pointer", 3, "click"], [1, "pi", "pi-bars"], ["app-breadcrumb", "", 1, "topbar-breadcrumb"], [1, "topbar-end"], [1, "topbar-menu"], [1, "topbar-search"], [1, "pi", "pi-search"], ["type", "text", "pInputText", "", "placeholder", "Rechercher...", 1, "w-48", "sm:w-full"], [1, "ml-3"], ["icon", "pi pi-palette", "rounded", "", 3, "onClick"], [1, "topbar-profile"], ["type", "button", 1, "p-link", "hover:cursor-pointer", 3, "click"], ["src", "/layout/images/avatar.png", "alt", "Profile"]], template: function AppTopbar_Template(rf, ctx) {
    if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AppLayout, { className: "AppLayout", filePath: "src/app/layout/components/app.layout.ts", lineNumber: 37 });
})();
...
var _c15 = () => ({ top: "50px", right: "-800px", transform: "rotate(60deg)" });
...
var appRoutes = [
  // Routes protégées (nécessitent une authentification)
  {
    ...
    children: [
      {
        path: "",
        loadComponent: () => import("./chunk-YKUWIICD.js").then((c) => c.EcommerceDashboard),
      ...
      {
        path: "produits",
        loadChildren: () => import("./chunk-CLFIRNKZ.js")
      },
      {
        path: "parametres",
        loadChildren: () => import("./chunk-3VCXMMF7.js")
      },
      {
        path: "roles",
        canActivate: [authorizationGuard],
        data: { roles: ["admin"] },
        loadChildren: () => import("./chunk-QYZ3NVOE.js")
      },
      {
        path: "dashboard-banking",
        loadComponent: () => import("./chunk-DZ4DVG2O.js").then((c) => c.BankingDashboard),
        data: { breadcrumb: "Banking Dashboard" }
      },
      {
        path: "uikit",
        data: { breadcrumb: "UI Kit" },
        loadChildren: () => import("./chunk-LY53RCAB.js")
      },
      {
        path: "documentation",
        data: { breadcrumb: "Documentation" },
        loadComponent: () => import("./chunk-3LTHQXDZ.js").then((c) => c.Documentation)
      },
      {
        path: "pages",
        loadChildren: () => import("./chunk-VBRB4ULB.js")
      },
      {
        path: "apps",
        loadChildren: () => import("./chunk-3L74CCXQ.js"),
        data: { breadcrumb: "Apps" }
      },
      {
        path: "blocks",
        data: { breadcrumb: "Free Blocks" },
        loadChildren: () => import("./chunk-QFZNWM2D.js")
      },
      {
        path: "ecommerce",
        loadChildren: () => import("./chunk-YPNYANNG.js"),
        data: { breadcrumb: "E-Commerce" }
      },
      {
        path: "profile",
        loadChildren: () => import("./chunk-6PSXNIDP.js")
      }
    ]
  },
  ...
  // Routes d'authentification (accessibles uniquement si NON connecté)
  {
    ...
    loadChildren: () => import("./chunk-LJ6Y32VI.js")
  },
  // Route 404
  {
    path: "**",
