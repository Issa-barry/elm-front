...
var AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
   ...
   */
  loadImpl() {
    const loadFn = () => this.moduleImpl ?? import("./chunk-FWRAJBEZ.js").then((m) => m);
          ...
          // ── Comptabilité ───────────────────────────────────────────────
          {
            ...
            items: [
              ...
              },
              {
                ...
                visible: this.hasAnyPermission(permissions, [
                  "factures-livraisons.read",
                  "facture-livraisons.read"
                ])
              },
              {
                label: "Encaissements",
                icon: "pi pi-fw pi-wallet",
                routerLink: ["/comptabilite/encaissements-livraison"],
                visible: this.hasAnyPermission(permissions, [
                  "encaissements.read",
                  "encaissement.read"
                ])
...
var appRoutes = [
  // Routes protégées (nécessitent une authentification)
  {
    ...
    children: [
      {
        path: "",
        loadComponent: () => import("./chunk-Y3XT4RAB.js").then((c) => c.EcommerceDashboard),
        data: { breadcrumb: "E-Commerce Dashboard" }
      },
      {
        path: "comptabilite",
        loadChildren: () => import("./chunk-GI3CFTKV.js")
      },
      {
        path: "contacts",
        loadChildren: () => import("./chunk-E2FMUVZK.js")
      },
      {
        path: "packings",
        loadChildren: () => import("./chunk-I44C3WLJ.js")
      },
      {
        path: "produits",
        loadChildren: () => import("./chunk-EPW6IFL4.js")
      },
      {
        path: "vehicules",
        loadChildren: () => import("./chunk-2AKK6WVC.js")
      },
      {
        path: "parametres",
        loadChildren: () => import("./chunk-7WNELEMP.js")
      },
      {
        path: "roles",
        canActivate: [authorizationGuard],
        data: { roles: ["admin"] },
        loadChildren: () => import("./chunk-4QZFPXX4.js")
      },
      {
        path: "dashboard-banking",
        loadComponent: () => import("./chunk-KLK5M2FI.js").then((c) => c.BankingDashboard),
        data: { breadcrumb: "Banking Dashboard" }
      },
      {
        path: "uikit",
        data: { breadcrumb: "UI Kit" },
        loadChildren: () => import("./chunk-LYYLDM7Z.js")
      },
      {
        path: "documentation",
        data: { breadcrumb: "Documentation" },
        loadComponent: () => import("./chunk-6LTE2XJI.js").then((c) => c.Documentation)
      },
      {
        path: "pages",
        loadChildren: () => import("./chunk-QHAKSITG.js")
      },
      {
        path: "apps",
        loadChildren: () => import("./chunk-TWCEKDBG.js"),
        data: { breadcrumb: "Apps" }
      },
      {
        path: "blocks",
        data: { breadcrumb: "Free Blocks" },
        loadChildren: () => import("./chunk-GAA4KXX3.js")
      },
      {
        path: "ecommerce",
        loadChildren: () => import("./chunk-OQYCMSQR.js"),
        data: { breadcrumb: "E-Commerce" }
      },
      {
        path: "profile",
        loadChildren: () => import("./chunk-RDFDP3TP.js")
      }
    ]
  },
  ...
  // Routes d'authentification (accessibles uniquement si NON connecté)
  {
    ...
    loadChildren: () => import("./chunk-ZXMRARTG.js")
  },
  // Route 404
  {
    path: "**",
