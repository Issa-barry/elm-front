...
var AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
   ...
   */
  loadImpl() {
    const loadFn = () => this.moduleImpl ?? import("./chunk-6EMFE2MC.js").then((m) => m);
...
var appRoutes = [
  // Routes protégées (nécessitent une authentification)
  {
    ...
    children: [
      {
        path: "",
        loadComponent: () => import("./chunk-2CCXCRI5.js").then((c) => c.EcommerceDashboard),
      ...
      {
        path: "packings",
        loadChildren: () => import("./chunk-4RKVQHAB.js"),
        data: { breadcrumb: "packings" }
      },
      {
        path: "produits",
        loadChildren: () => import("./chunk-RS7XRO6X.js"),
      ...
      {
        path: "ventes",
        loadChildren: () => import("./chunk-QVUOKWTZ.js"),
      ...
      },
      {
        ...
        loadComponent: () => import("./chunk-BPRYHA7W.js").then((c) => c.Documentation)
      },
      {
        path: "pages",
