import {
  MemberService
} from "./chunk-XSPCL5FN.js";
import {
  AvatarGroup,
  AvatarGroupModule
} from "./chunk-XHSNFFVN.js";
import {
  Avatar,
  AvatarModule
} from "./chunk-ZIMY6V3U.js";
import {
  Editor,
  EditorModule
} from "./chunk-XS7CMRW3.js";
import {
  AutoComplete,
  AutoCompleteModule
...
function TaskListComponent_li_4_p_avatar_12_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("image", \u0275\u0275interpolate1("/demo/images/avatar/", member_r4.image));
  }
}
function TaskListComponent_li_4_p_avatar_14_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("label", \u0275\u0275interpolate1("+ ", task_r2.members.length - 4));
  }
}
...
var TaskListComponent = class _TaskListComponent {
  ...
  }, dependencies: [CommonModule, NgClass, NgForOf, NgIf, CheckboxModule, Checkbox, AvatarGroupModule, AvatarGroup, AvatarModule, Avatar, MenuModule, Menu, ButtonModule, ButtonDirective, RippleModule, Ripple, FormsModule, NgControlStatus, NgModel, SlicePipe], encapsulation: 2, changeDetection: 0 });
};
(() => {
...
function CreateTaskComponent_ng_template_24_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("src", \u0275\u0275interpolate1("/demo/images/avatar/", member_r1.image), \u0275\u0275sanitizeUrl)("alt", member_r1.name);
    \u0275\u0275advance(2);
...
function CreateTaskComponent_ng_template_25_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("src", \u0275\u0275interpolate1("/demo/images/avatar/", member_r2.image), \u0275\u0275sanitizeUrl)("alt", member_r2.name);
    \u0275\u0275advance(2);
...
(() => {
  ...
  }], () => [{ type: MemberService }, { type: MessageService }, { type: TaskService }], null);
})();
(() => {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(TaskList, [{
    type: Component,
    args: [{
      standalone: true,
...
//# sourceMappingURL=chunk-E2TYQDAH.js.map
