import {
  Documentation
} from "./chunk-STPGVXGV.js";
import {
  Rating,
  RatingModule
} from "./chunk-4N566Y2T.js";
import {
  ProductService
} from "./chunk-2E7VINK3.js";
import {
  LayoutService
...
function Crud_ng_template_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(12, "Image");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "th", 25)(14, "span", 21);
    \u0275\u0275text(15, "Price ");
    \u0275\u0275element(16, "p-sortIcon", 26);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(17, "th", 27)(18, "span", 21);
    \u0275\u0275text(19, "Category ");
    \u0275\u0275element(20, "p-sortIcon", 28);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(21, "th", 29)(22, "span", 21);
    \u0275\u0275text(23, "Reviews ");
    \u0275\u0275element(24, "p-sortIcon", 30);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(25, "th", 31)(26, "span", 21);
    \u0275\u0275text(27, "Status ");
    \u0275\u0275element(28, "p-sortIcon", 32);
    \u0275\u0275elementEnd()();
    \u0275\u0275element(29, "th", 33);
    \u0275\u0275elementEnd();
  }
...
function Crud_ng_template_12_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(13);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "td")(15, "p-rating", 37);
    ...
    \u0275\u0275element(17, "p-tag", 38);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "td")(19, "p-button", 39);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("src", "/demo/images/product/" + product_r8.image, \u0275\u0275sanitizeUrl)("alt", product_r8.name);
    \u0275\u0275advance(2);
...
function Crud_ng_template_15_img_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("src", "/demo/images/product/" + ctx_r2.product.image, \u0275\u0275sanitizeUrl)("alt", ctx_r2.product.image);
  }
}
function Crud_ng_template_15_small_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "small", 67);
...
function Crud_ng_template_15_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(1, Crud_ng_template_15_img_1_Template, 1, 2, "img", 42);
    \u0275\u0275elementStart(2, "div")(3, "label", 43);
    \u0275\u0275text(4, "Name");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(6, Crud_ng_template_15_small_6_Template, 2, 0, "small", 45);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(7, "div")(8, "label", 46);
    \u0275\u0275text(9, "Description");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "textarea", 47);
    ...
    \u0275\u0275text(17, "Category");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(18, "div", 51)(19, "div", 52)(20, "p-radiobutton", 53);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(23, "div", 52)(24, "p-radiobutton", 55);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(25, "label", 56);
    \u0275\u0275text(26, "Clothing");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(27, "div", 52)(28, "p-radiobutton", 57);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(29, "label", 58);
    \u0275\u0275text(30, "Electronics");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(31, "div", 52)(32, "p-radiobutton", 59);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(33, "label", 60);
    \u0275\u0275text(34, "Fitness");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(35, "div", 51)(36, "div", 61)(37, "label", 62);
    \u0275\u0275text(38, "Price");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(39, "p-inputnumber", 63);
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(40, "div", 61)(41, "label", 64);
    \u0275\u0275text(42, "Quantity");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(43, "p-inputnumber", 65);
...
var Crud = class _Crud {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _Crud, selectors: [["app-crud"]], viewQuery: function Crud_Query(rf, ctx) {
    ...
    if (rf & 1) {
      ...
      \u0275\u0275template(8, Crud_ng_template_8_Template, 6, 0, "ng-template", null, 3, \u0275\u0275templateRefExtractor)(10, Crud_ng_template_10_Template, 30, 0, "ng-template", null, 4, \u0275\u0275templateRefExtractor)(12, Crud_ng_template_12_Template, 21, 18, "ng-template", null, 5, \u0275\u0275templateRefExtractor);
      \u0275\u0275elementEnd()();
...
var Invoice = class _Invoice {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _Invoice, selectors: [["app-invoice"]], decls: 96, vars: 0, consts: [[1, "card", "py-20", "px-12", "md:px-20", "overflow-auto"], [1, "flex", "flex-col", "items-start", "md:flex-row", "md:items-center", "md:justify-between", "border-b", "border-surface-200", "dark:border-surface-700", "pb-8", "min-w-max"], [1, "flex", "flex-col"], ["width", "48", "height", "50", "viewBox", "0 0 48 50", "fill", "none", "xmlns", "http://www.w3.org/2000/svg"], ["fillRule", "evenodd", "clipRule", "evenodd", "d", "M33.1548 9.65956L23.9913 4.86169L5.54723 14.5106L0.924465 12.0851L23.9913 0L37.801 7.23403L33.1548 9.65956ZM23.9931 19.3085L42.4255 9.65955L47.0717 12.0851L23.9931 24.1595L10.1952 16.9361L14.8297 14.5106L23.9931 19.3085ZM4.6345 25.8937L0 23.4681V37.9149L23.0669 50V45.1489L4.6345 35.4894V25.8937ZM18.4324 28.2658L0 18.6169V13.7658L23.0669 25.8403V40.2977L18.4324 37.8615V28.2658ZM38.7301 23.468V18.6169L24.9205 25.8403V49.9999L29.555 47.5743V28.2659L38.7301 23.468ZM43.3546 35.4892V16.1914L48.0008 13.7659V37.9148L34.1912 45.1488V40.2977L43.3546 35.4892Z", "fill", "var(--p-primary-color)"], [1, "my-4", "text-4xl", "font-bold", "text-surface-900", "dark:text-surface-0"], [1, "mb-2"], [1, "flex", "flex-col", "mt-8", "md:mt-0"], [1, "text-2xl", "font-semibold", "text-left", "md:text-right", "mb-4"], [1, "flex", "justify-between", "items-center", "mb-2"], [1, "font-semibold", "mr-12"], [1, "flex", "justify-between", "items-center"], [1, "mt-8", "mb-20", "flex", "flex-col"], [1, "mb-4", "text-2xl", "font-medium"], [1, "overflow-x-auto"], [1, "w-full", 2, "border-collapse", "collapse", "table-layout", "auto"], [1, "text-left", "font-semibold", "py-4", "border-b", "border-surface-200", "dark:border-surface-700", "whitespace-nowrap"], [1, "text-right", "font-semibold", "py-4", "border-b", "border-surface-200", "dark:border-surface-700", "whitespace-nowrap", "px-4"], [1, "text-right", "font-semibold", "py-4", "border-b", "border-surface-200", "dark:border-surface-700", "whitespace-nowrap"], [1, "text-left", "py-4", "border-b", "border-surface-200", "dark:border-surface-700", "whitespace-nowrap"], [1, "text-right", "py-4", "border-b", "border-surface-200", "dark:border-surface-700", "px-4"], [1, "text-right", "py-4", "border-b", "border-surface-200", "dark:border-surface-700"], [1, "flex", "flex-col", "md:flex-row", "md:items-start", "md:justify-between", "mt-20"], [1, "font-semibold", "mb-4", "md:mb-0"]], template: function Invoice_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(13, " INVOICE ");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(14, "div", 2)(15, "div", 9)(16, "span", 10);
      \u0275\u0275text(17, "DATE");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(18, "span");
      \u0275\u0275text(19, "30/08/2019");
      \u0275\u0275domElementEnd()();
      \u0275\u0275domElementStart(20, "div", 9)(21, "span", 10);
      \u0275\u0275text(22, "INVOICE #");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(23, "span");
      \u0275\u0275text(24, "8523");
      \u0275\u0275domElementEnd()();
      \u0275\u0275domElementStart(25, "div", 11)(26, "span", 10);
      \u0275\u0275text(27, "CUSTOMER ID");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(28, "span");
      \u0275\u0275text(29, "C1613");
      \u0275\u0275domElementEnd()()()()();
      \u0275\u0275domElementStart(30, "div", 12)(31, "div", 13);
      \u0275\u0275text(32, "BILL TO");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(33, "span", 6);
      \u0275\u0275text(34, "Claire Williams, 148 Hope Lane");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(35, "span");
      \u0275\u0275text(36, "Palo Alto, CA 94304.");
      \u0275\u0275domElementEnd()();
      \u0275\u0275domElementStart(37, "div", 14)(38, "table", 15)(39, "thead")(40, "tr")(41, "th", 16);
      \u0275\u0275text(42, " Description ");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(43, "th", 17);
      \u0275\u0275text(44, " Quantity ");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(45, "th", 17);
      \u0275\u0275text(46, " Unit Price ");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(47, "th", 18);
      \u0275\u0275text(48, " Line Total ");
      \u0275\u0275domElementEnd()()();
      \u0275\u0275domElementStart(49, "tbody")(50, "tr")(51, "td", 19);
      \u0275\u0275text(52, " Green T-Shirt ");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(53, "td", 20);
      \u0275\u0275text(54, " 1 ");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(55, "td", 20);
      \u0275\u0275text(56, " $49.00 ");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(57, "td", 21);
      \u0275\u0275text(58, " $49.00 ");
      \u0275\u0275domElementEnd()();
      \u0275\u0275domElementStart(59, "tr")(60, "td", 19);
      \u0275\u0275text(61, " Game Controller ");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(62, "td", 20);
      \u0275\u0275text(63, " 2 ");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(64, "td", 20);
      \u0275\u0275text(65, " $99.00 ");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(66, "td", 21);
      \u0275\u0275text(67, " $198.00 ");
      \u0275\u0275domElementEnd()();
      \u0275\u0275domElementStart(68, "tr")(69, "td", 19);
      \u0275\u0275text(70, " Mini Speakers ");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(71, "td", 20);
      \u0275\u0275text(72, " 1 ");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(73, "td", 20);
      \u0275\u0275text(74, " $85.00 ");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(75, "td", 21);
      \u0275\u0275text(76, " $85.00 ");
      \u0275\u0275domElementEnd()()()()();
      \u0275\u0275domElementStart(77, "div", 22)(78, "div", 23);
      \u0275\u0275text(79, "NOTES");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(80, "div", 2)(81, "div", 9)(82, "span", 10);
      \u0275\u0275text(83, "SUBTOTAL");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(84, "span");
      \u0275\u0275text(85, "$332.00");
      \u0275\u0275domElementEnd()();
      \u0275\u0275domElementStart(86, "div", 9)(87, "span", 10);
      \u0275\u0275text(88, "VAT #");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(89, "span");
      \u0275\u0275text(90, "0");
      \u0275\u0275domElementEnd()();
      \u0275\u0275domElementStart(91, "div", 11)(92, "span", 10);
      \u0275\u0275text(93, "TOTAL");
      \u0275\u0275domElementEnd();
      \u0275\u0275domElementStart(94, "span");
      \u0275\u0275text(95, "$332.00");
      \u0275\u0275domElementEnd()()()()();
    }
  }, encapsulation: 2 });
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(Invoice, [{
    type: Component,
    args: [{
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(Invoice, { className: "Invoice", filePath: "src/app/pages/invoice/invoice.ts", lineNumber: 184 });
})();
...
function AboutUs_div_19_div_3_a_7_Template(rf, ctx) {
  ...
  if (rf & 2) {
    const socialIcon_r4 = ctx.$implicit;
    \u0275\u0275advance();
    \u0275\u0275classMap(socialIcon_r4.additionalClasses);
    \u0275\u0275property("ngClass", socialIcon_r4.iconClass);
  }
}
function AboutUs_div_19_div_3_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("ngForOf", member_r5.socialIcons);
  }
}
function AboutUs_div_19_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275listener("mouseenter", function AboutUs_div_19_Template_div_mouseenter_1_listener() {
      ...
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.setVisibleMember(i_r2));
    })("mouseleave", function AboutUs_div_19_Template_div_mouseleave_1_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.setVisibleMember(-1));
    });
    \u0275\u0275element(2, "img", 15);
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r2.visibleMember === i_r2);
  }
}
...
var _c03 = () => ({ borderRadius: "2rem" });
var Help = class _Help {
  static \u0275fac = function Help_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _Help)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _Help, selectors: [["app-help"]], decls: 125, vars: 3, consts: [[1, "card"], [1, "relative", "overflow-hidden", "h-80", "bg-primary", "text-primary-contrast", "flex", "flex-col", "items-center", "justify-center", "rounded", "mb-20"], ["xmlns", "http://www.w3.org/2000/svg", "viewBox", "0 0 1440 320", 1, "absolute", "w-full", "top-0", "left-0"], ["fill", "var(--p-primary-600)", "fill-opacity", "1", "d", "M0,64L48,90.7C96,117,192,171,288,208C384,245,480,267,576,256C672,245,768,203,864,165.3C960,128,1056,96,1152,74.7C1248,53,1344,43,1392,37.3L1440,32L1440,0L1392,0C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z"], [1, "font-bold", "mb-8", "text-4xl", "z-10"], [1, "w-9/12", "md:w-6/12"], [1, "pi", "pi-search"], ["type", "text", "pInputText", "", "placeholder", "Rechercher", 1, "w-full", 2, "border-radius", "2rem"], [1, "grid", "grid-cols-12", "gap-4", "mb-8"], [1, "col-span-12", "md:col-span-4", "mb-8"], [1, "flex", "flex-col", "items-center"], [1, "inline-flex", "items-center", "justify-center", "rounded-full", "w-20", "h-20", "bg-primary-100", "mb-8"], [1, "pi", "pi-power-off", "text-4xl", "text-primary-700"], [1, "text-2xl", "mb-4", "font-medium"], [1, "list-none", "m-0", "p-0", "text-center"], [1, "leading-normal", "mb-1"], [1, "text-surface-500", "dark:text-surface-400", "hover:text-primary", "cursor-pointer"], [1, "leading-normal", "mb-4"], [1, "text-primary", "hover:underline", "cursor-pointer", "font-medium"], [1, "pi", "pi-arrows-h", "text-4xl", "text-primary-700"], [1, "pi", "pi-user", "text-4xl", "text-primary-700"], [1, "pi", "pi-money-bill", "text-4xl", "text-primary-700"], [1, "pi", "pi-database", "text-4xl", "text-primary-700"], [1, "pi", "pi-lock", "text-4xl", "text-primary-700"]], template: function Help_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(6, " Comment pouvons-nous vous aider ? ");
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275text(20, "Guide d'utilisation");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(21, "li", 15)(22, "a", 16);
      \u0275\u0275text(23, "Questions fr\xE9quentes");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(24, "li", 17)(25, "a", 16);
      \u0275\u0275text(26, "R\xE9soudre un probl\xE8me");
      \u0275\u0275elementEnd()();
      ...
      \u0275\u0275text(39, "Guide d'utilisation");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(40, "li", 15)(41, "a", 16);
      \u0275\u0275text(42, "Questions fr\xE9quentes");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(43, "li", 17)(44, "a", 16);
      \u0275\u0275text(45, "R\xE9soudre un probl\xE8me");
      \u0275\u0275elementEnd()();
      ...
      \u0275\u0275text(58, "Guide d'utilisation");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(59, "li", 15)(60, "a", 16);
      \u0275\u0275text(61, "Questions fr\xE9quentes");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(62, "li", 17)(63, "a", 16);
      \u0275\u0275text(64, "R\xE9soudre un probl\xE8me");
      \u0275\u0275elementEnd()();
      ...
      \u0275\u0275text(73, " Facturation ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(74, "ul", 14)(75, "li", 15)(76, "a", 16);
      \u0275\u0275text(77, "Guide d'utilisation");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(78, "li", 15)(79, "a", 16);
      \u0275\u0275text(80, "Questions fr\xE9quentes");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(81, "li", 17)(82, "a", 16);
      \u0275\u0275text(83, "R\xE9soudre un probl\xE8me");
      \u0275\u0275elementEnd()();
      ...
      \u0275\u0275text(96, "Guide d'utilisation");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(97, "li", 15)(98, "a", 16);
      \u0275\u0275text(99, "Questions fr\xE9quentes");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(100, "li", 17)(101, "a", 16);
      \u0275\u0275text(102, "R\xE9soudre un probl\xE8me");
      \u0275\u0275elementEnd()();
      ...
      \u0275\u0275text(115, "Guide d'utilisation");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(116, "li", 15)(117, "a", 16);
      \u0275\u0275text(118, "Questions fr\xE9quentes");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(119, "li", 17)(120, "a", 16);
      \u0275\u0275text(121, "R\xE9soudre un probl\xE8me");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(122, "li")(123, "a", 18);
      \u0275\u0275text(124, "Voir tout");
      \u0275\u0275elementEnd()()()()()()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(9);
      \u0275\u0275styleMap(\u0275\u0275pureFunction0(2, _c03));
    }
  }, dependencies: [IconFieldModule, IconField, InputIconModule, InputIcon, InputTextModule, InputText], encapsulation: 2 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(Help, [{
    type: Component,
    args: [{
      selector: "app-help",
      standalone: true,
                ...
                <div class="grid grid-cols-12 gap-4 mb-8">
                        ...
                        <div class="flex flex-col items-center">
                            ...
                            <ul class="list-none m-0 p-0 text-center">
                                ...
                                <li class="leading-normal mb-1">
                                    <a
                                        class="text-surface-500 dark:text-surface-400 hover:text-primary cursor-pointer"
                                        >Questions fr\xE9quentes</a
                                    >
                                </li>
                                <li class="leading-normal mb-4">
                                    <a
                                        class="text-surface-500 dark:text-surface-400 hover:text-primary cursor-pointer"
                                        >R\xE9soudre un probl\xE8me</a
                                    >
                                </li>
                                <li>
                                    <a
                    ...
                    <div class="col-span-12 md:col-span-4 mb-8">
                        <div class="flex flex-col items-center">
                            ...
                            <div class="text-2xl mb-4 font-medium">V\xE9hicules</div>
                            <ul class="list-none m-0 p-0 text-center">
                                <li class="leading-normal mb-1">
                                    <a
                                        class="text-surface-500 dark:text-surface-400 hover:text-primary cursor-pointer"
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(Help, { className: "Help", filePath: "src/app/pages/help/help.ts", lineNumber: 290 });
})();

// src/app/pages/faq/faq.ts
var _c04 = (a0, a1) => ({ "bg-primary text-primary-contrast": a0, "hover:bg-surface-100 dark:hover:bg-surface-800": a1 });
function Faq_li_11_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "li", 10);
    \u0275\u0275listener("click", function Faq_li_11_Template_li_click_0_listener() {
      const i_r2 = \u0275\u0275restoreView(_r1).index;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.changeItem(i_r2));
    });
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction2(4, _c04, ctx_r2.activeIndex === i_r2, ctx_r2.activeIndex !== i_r2));
    \u0275\u0275advance();
...
function Faq_For_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p-accordion-panel", 9)(1, "p-accordion-header");
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "p-accordion-content")(4, "p", 13);
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275property("value", ctx_r2.items[\u0275$index_35_r6].value);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(question_r5);
  }
}
var Faq = class _Faq {
  items = [];
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _Faq, selectors: [["app-faq"]], decls: 16, vars: 1, consts: [[1, "card"], [1, "text-surface-900", "dark:text-surface-0", "font-bold", "text-xl", "mb-4"], [1, "text-surface-600", "dark:text-surface-200", "leading-normal"], [1, "flex", "flex-col", "md:flex-row", "gap-8"], [1, "card", "mb-0", "md:w-80"], [1, "text-surface-900", "dark:text-surface-0", "block", "font-bold", "mb-4"], [1, "list-none", "m-0", "p-0"], ["pRipple", "", "class", "mb-2 ", 3, "click", 4, "ngFor", "ngForOf"], [1, "card", "flex-1"], [3, "value"], ["pRipple", "", 1, "mb-2", 3, "click"], [1, "flex", "items-center", "cursor-pointer", "select-none", "p-4", "transition-colors", "duration-150", "rounded-border", 3, "ngClass"], [1, "mr-2", "text-lg"], [1, "leading-normal", "m-0", "p-0"]], template: function Faq_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div")(1, "div", 0)(2, "div", 1);
      \u0275\u0275text(3, "Frequently Asked Questions");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(4, "p", 2);
      \u0275\u0275text(5, "Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit.");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(6, "div", 3)(7, "div", 4)(8, "div", 5);
      \u0275\u0275text(9, "Categories");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(10, "ul", 6);
      \u0275\u0275template(11, Faq_li_11_Template, 5, 7, "li", 7);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(12, "div", 8)(13, "p-accordion");
      \u0275\u0275repeaterCreate(14, Faq_For_15_Template, 6, 2, "p-accordion-panel", 9, \u0275\u0275repeaterTrackByIdentity);
      \u0275\u0275elementEnd()()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(11);
      ...
      \u0275\u0275advance(3);
      \u0275\u0275repeater(ctx.items[ctx.activeIndex].questions);
    }
  }, dependencies: [AccordionModule, Accordion, AccordionPanel, AccordionHeader, AccordionContent, CommonModule, NgClass, NgForOf, RippleModule, Ripple], encapsulation: 2 });
};
(() => {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(Faq, { className: "Faq", filePath: "src/app/pages/faq/faq.ts", lineNumber: 54 });
})();

// src/app/pages/contactus/contactus.ts
var _c05 = () => ({ height: "3.5rem" });
...
//# sourceMappingURL=chunk-MMBN6GJP.js.map
