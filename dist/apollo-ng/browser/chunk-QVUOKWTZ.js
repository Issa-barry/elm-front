...
var ventes_routes_default = [
  ...
  {
    path: "commandes/:id",
    loadComponent: () => import("./chunk-5HPMX3QK.js").then((c) => c.CommandeVenteDetail),
    data: { breadcrumb: "commandes" }
  },
  {
    path: "factures-vente-liste2",
    loadComponent: () => import("./chunk-LIWLCUP2.js").then((c) => c.FactureVenteListe2),
    data: { breadcrumb: "factures-vente-liste2" }
  },
  {
    path: "factures-vente-detail2/:id",
    loadComponent: () => import("./chunk-ZDRSS53Q.js").then((c) => c.FactureVenteDetail2),
  ...
  {
    path: "factures-vente",
    loadComponent: () => import("./chunk-J2Y744LI.js").then((c) => c.FactureVenteListe),
  ...
  {
    path: "factures/:id",
    loadComponent: () => import("./chunk-4NIO3K7X.js").then((c) => c.FactureVenteDetail),
    data: { breadcrumb: "factures" }
  },
  {
    path: "encaissements",
    loadComponent: () => import("./chunk-FETEINSF.js").then((c) => c.EncaissementVenteListe),
    data: { breadcrumb: "encaissements" }
  },
  {
    path: "commissions",
    loadComponent: () => import("./chunk-B4DQDPCA.js").then((c) => c.CommissionVenteListe),
    data: { breadcrumb: "commissions" }
  },
  {
    path: "commissions2",
    loadComponent: () => import("./chunk-DB55KVYV.js").then((c) => c.ComissionVenteListe2),
...
//# sourceMappingURL=chunk-QVUOKWTZ.js.map
