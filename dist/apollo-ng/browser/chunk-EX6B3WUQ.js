...
function MailDetailComponent_div_0_p_avatar_4_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275property("image", "/demo/images/avatar/" + ctx_r1.mail.image);
  }
}
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(MailDetailComponent, [{
    type: Component,
    args: [{
      standalone: true,
  ...
  }], () => [{ type: ActivatedRoute }, { type: MailService }, { type: Location }, { type: Router }, { type: MessageService }], null);
})();
(() => {
...
//# sourceMappingURL=chunk-EX6B3WUQ.js.map
