...
function OrganisationsListe_ng_template_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(15);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(16, "td", 33)(17, "div", 38);
    \u0275\u0275element(18, "button", 39);
    \u0275\u0275template(19, OrganisationsListe_ng_template_10_button_19_Template, 1, 0, "button", 40)(20, OrganisationsListe_ng_template_10_button_20_Template, 1, 0, "button", 41);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
...
var OrganisationsListe = class _OrganisationsListe {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _OrganisationsListe, selectors: [["app-organisations-liste"]], features: [\u0275\u0275ProvidersFeature([ConfirmationService])], decls: 78, vars: 14, consts: [[1, "card", "organisations-page"], [1, "flex", "align-items-center", "justify-content-between", "mb-4", "gap-3", "flex-wrap"], [1, "m-0", "text-2xl", "font-semibold"], [1, "m-0", "text-color-secondary"], ["pButton", "", "type", "button", "icon", "pi pi-plus", "label", "Nouvelle organisation", 3, "click", 4, "ngIf"], ["dataKey", "id", "responsiveLayout", "scroll", 3, "value", "loading"], ["pTemplate", "header"], ["pTemplate", "body"], ["pTemplate", "emptymessage"], ["styleClass", "org-dialog", 3, "visibleChange", "onHide", "visible", "header", "modal", "draggable"], [1, "grid", "org-form-grid", 3, "ngSubmit", "formGroup"], [1, "col-12"], [1, "m-0", "mb-3", "text-sm", "font-semibold", "text-color-secondary", "uppercase", 2, "letter-spacing", ".05em"], [1, "col-12", "md:col-6"], [1, "block", "mb-2", "font-medium"], [1, "text-red-500"], ["pInputText", "", "type", "text", "formControlName", "nom", "placeholder", "Ex: ELM Guin\xE9e", 1, "w-full"], ["pInputText", "", "type", "text", "formControlName", "code", "placeholder", "Ex: ELM-GN", 1, "w-full"], [1, "col-12", "mt-2"], ["pInputText", "", "type", "email", "formControlName", "email", "placeholder", "contact@exemple.com", 1, "w-full"], ["pInputText", "", "type", "text", "formControlName", "phone", "placeholder", "+224 6X XX XX XX", 1, "w-full"], [1, "col-12", "md:col-4"], ["pInputText", "", "type", "text", "formControlName", "pays", 1, "w-full"], ["pInputText", "", "type", "text", "formControlName", "ville", 1, "w-full"], ["pInputText", "", "type", "text", "formControlName", "quartier", 1, "w-full"], ["pInputText", "", "type", "text", "formControlName", "adresse", 1, "w-full"], ["pTextarea", "", "rows", "2", "formControlName", "description", 1, "w-full"], ["formControlName", "statut", "optionLabel", "label", "optionValue", "value", "styleClass", "w-full", 3, "options"], ["formControlName", "forfait_id", "optionLabel", "label", "optionValue", "value", "styleClass", "w-full", "placeholder", "Aucun forfait", 3, "options"], [1, "col-12", "flex", "justify-content-end", "gap-2", "mt-3", "pt-3", "border-top-1", "surface-border"], ["pButton", "", "type", "button", "label", "Annuler", 1, "p-button-text", 3, "click"], ["pButton", "", "type", "submit", "label", "Enregistrer", 3, "loading"], ["pButton", "", "type", "button", "icon", "pi pi-plus", "label", "Nouvelle organisation", 3, "click"], [1, "text-right"], [1, "font-semibold"], [1, "text-sm", "border-round", "px-2", "py-1", "surface-100", "text-color-secondary"], [1, "border-round", "px-2", "text-xs", "font-semibold", "white-space-nowrap", "bg-gray-100", "text-gray-600", 2, "padding-top", "3px", "padding-bottom", "3px", 3, "ngClass"], [1, "border-round", "px-2", "text-xs", "font-semibold", "white-space-nowrap", 2, "padding-top", "3px", "padding-bottom", "3px", 3, "ngClass"], [1, "flex", "justify-content-end", "gap-2"], ["pButton", "", "pRipple", "", "type", "button", "icon", "pi pi-eye", "pTooltip", "Voir le d\xE9tail", 1, "p-button-text", "p-button-sm", 3, "routerLink"], ["pButton", "", "pRipple", "", "type", "button", "class", "p-button-text p-button-sm", "icon", "pi pi-pencil", "pTooltip", "Modifier", 3, "click", 4, "ngIf"], ["pButton", "", "pRipple", "", "type", "button", "class", "p-button-text p-button-danger p-button-sm", "icon", "pi pi-trash", "pTooltip", "Supprimer", 3, "click", 4, "ngIf"], ["pButton", "", "pRipple", "", "type", "button", "icon", "pi pi-pencil", "pTooltip", "Modifier", 1, "p-button-text", "p-button-sm", 3, "click"], ["pButton", "", "pRipple", "", "type", "button", "icon", "pi pi-trash", "pTooltip", "Supprimer", 1, "p-button-text", "p-button-danger", "p-button-sm", 3, "click"], ["colspan", "7", 1, "text-center", "text-color-secondary", "py-5"]], template: function OrganisationsListe_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275template(9, OrganisationsListe_ng_template_9_Template, 15, 0, "ng-template", 6)(10, OrganisationsListe_ng_template_10_Template, 21, 21, "ng-template", 7)(11, OrganisationsListe_ng_template_11_Template, 3, 0, "ng-template", 8);
      \u0275\u0275elementEnd()();
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(29, "div", 18)(30, "p", 12);
      \u0275\u0275text(31, "Contact");
      \u0275\u0275elementEnd()();
      ...
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(40, "div", 18)(41, "p", 12);
      \u0275\u0275text(42, "Localisation");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(43, "div", 21)(44, "label", 14);
      \u0275\u0275text(45, "Pays");
      \u0275\u0275elementEnd();
      \u0275\u0275element(46, "input", 22);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(47, "div", 21)(48, "label", 14);
      \u0275\u0275text(49, "Ville");
      \u0275\u0275elementEnd();
      \u0275\u0275element(50, "input", 23);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(51, "div", 21)(52, "label", 14);
      \u0275\u0275text(53, "Quartier");
      \u0275\u0275elementEnd();
      \u0275\u0275element(54, "input", 24);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(55, "div", 11)(56, "label", 14);
      \u0275\u0275text(57, "Adresse");
      \u0275\u0275elementEnd();
      \u0275\u0275element(58, "input", 25);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(59, "div", 11)(60, "label", 14);
      \u0275\u0275text(61, "Description");
      \u0275\u0275elementEnd();
      \u0275\u0275element(62, "textarea", 26);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(63, "div", 18)(64, "p", 12);
      \u0275\u0275text(65, "Configuration");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(66, "div", 13)(67, "label", 14);
      \u0275\u0275text(68, "Statut");
      \u0275\u0275elementEnd();
      \u0275\u0275element(69, "p-select", 27);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(70, "div", 13)(71, "label", 14);
      \u0275\u0275text(72, "Forfait");
      \u0275\u0275elementEnd();
      \u0275\u0275element(73, "p-select", 28);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(74, "div", 29)(75, "button", 30);
      \u0275\u0275listener("click", function OrganisationsListe_Template_button_click_75_listener() {
        return ctx.closeDialog();
      });
      \u0275\u0275elementEnd();
      \u0275\u0275element(76, "button", 31);
      \u0275\u0275elementEnd()()();
...
(() => {
  ...
  <div class="flex align-items-center justify-content-between mb-4 gap-3 flex-wrap">
    ...
    <button
      *ngIf="canCreate()"
      pButton type="button" icon="pi pi-plus" label="Nouvelle organisation"
...
>
  <form class="grid org-form-grid" [formGroup]="organisationForm" (ngSubmit)="submitForm()">
    ...
    <div class="col-12 flex justify-content-end gap-2 mt-3 pt-3 border-top-1 surface-border">
...
//# sourceMappingURL=chunk-ZPQHODT3.js.map
