...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(BlockViewer, [{
    type: Component,
    args: [{ selector: "block-viewer", standalone: true, imports: [CommonModule, TooltipModule], template: `
...
var blocks_routes_default = [{ path: "", data: { breadcrumb: "blocks" }, component: Blocks }];
export {
  blocks_routes_default as default
};
//# sourceMappingURL=chunk-OVPONC6Q.js.map
