...
function PrestatairesListe_section_17_article_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "article", 26);
    \u0275\u0275listener("click", function PrestatairesListe_section_17_article_1_Template_article_click_0_listener($event) {
    ...
    \u0275\u0275listener("click", function PrestatairesListe_section_17_article_1_Template_button_click_12_listener($event) {
      const prestataire_r4 = \u0275\u0275restoreView(_r3).$implicit;
      const ctx_r4 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r4.goToEdit($event, prestataire_r4.id));
    });
...
function PrestatairesListe_section_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "section", 24);
    \u0275\u0275template(1, PrestatairesListe_section_17_article_1_Template, 13, 10, "article", 25);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function PrestatairesListe_ng_template_18_div_0_Template(rf, ctx) {
  if (rf & 1) {
...
function PrestatairesListe_ng_template_18_div_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 36);
...
function PrestatairesListe_ng_template_18_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, PrestatairesListe_ng_template_18_div_0_Template, 2, 0, "div", 35)(1, PrestatairesListe_ng_template_18_div_1_Template, 2, 0, "div", 35);
  }
  if (rf & 2) {
    const ctx_r4 = \u0275\u0275nextContext();
...
function PrestatairesListe_div_20_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 37)(1, "button", 38);
    \u0275\u0275listener("click", function PrestatairesListe_div_20_Template_button_click_1_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r4 = \u0275\u0275nextContext();
...
function PrestatairesListe_button_21_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 39);
    \u0275\u0275listener("click", function PrestatairesListe_button_21_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r4 = \u0275\u0275nextContext();
...
function PrestatairesListe_ng_template_25_button_6_Template(rf, ctx) {
  if (rf & 1) {
    const _r10 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 47);
    \u0275\u0275listener("click", function PrestatairesListe_ng_template_25_button_6_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r10);
      const ctx_r4 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r4.navigateToCreate());
    });
...
function PrestatairesListe_ng_template_25_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 41)(1, "p-icon-field", 42);
    \u0275\u0275element(2, "p-inputicon", 17);
    \u0275\u0275elementStart(3, "input", 43);
    \u0275\u0275listener("input", function PrestatairesListe_ng_template_25_Template_input_input_3_listener($event) {
      \u0275\u0275restoreView(_r8);
      const ctx_r4 = \u0275\u0275nextContext();
      const dt_r9 = \u0275\u0275reference(24);
      return \u0275\u0275resetView(ctx_r4.onGlobalFilter(dt_r9, $event));
    });
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(4, "div", 44)(5, "p-select", 45);
    \u0275\u0275twoWayListener("ngModelChange", function PrestatairesListe_ng_template_25_Template_p_select_ngModelChange_5_listener($event) {
      \u0275\u0275restoreView(_r8);
      const ctx_r4 = \u0275\u0275nextContext();
      \u0275\u0275twoWayBindingSet(ctx_r4.selectedStatus, $event) || (ctx_r4.selectedStatus = $event);
      return \u0275\u0275resetView($event);
    });
    \u0275\u0275listener("onChange", function PrestatairesListe_ng_template_25_Template_p_select_onChange_5_listener() {
      \u0275\u0275restoreView(_r8);
      const ctx_r4 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r4.filterByStatus());
    });
    \u0275\u0275elementEnd();
    \u0275\u0275template(6, PrestatairesListe_ng_template_25_button_6_Template, 1, 0, "button", 46);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r4 = \u0275\u0275nextContext();
...
function PrestatairesListe_ng_template_27_Template(rf, ctx) {
  if (rf & 1) {
...
function PrestatairesListe_ng_template_29_p_tag_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "p-tag", 70);
  }
  if (rf & 2) {
...
function PrestatairesListe_ng_template_29_span_17_Template(rf, ctx) {
  if (rf & 1) {
...
function PrestatairesListe_ng_template_29_button_31_Template(rf, ctx) {
  if (rf & 1) {
    const _r13 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 75);
    \u0275\u0275listener("click", function PrestatairesListe_ng_template_29_button_31_Template_button_click_0_listener($event) {
      \u0275\u0275restoreView(_r13);
      const prestataire_r12 = \u0275\u0275nextContext().$implicit;
      const ctx_r4 = \u0275\u0275nextContext();
...
function PrestatairesListe_ng_template_29_button_32_Template(rf, ctx) {
  if (rf & 1) {
    const _r14 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 76);
    \u0275\u0275listener("click", function PrestatairesListe_ng_template_29_button_32_Template_button_click_0_listener($event) {
      \u0275\u0275restoreView(_r14);
      const prestataire_r12 = \u0275\u0275nextContext().$implicit;
      const ctx_r4 = \u0275\u0275nextContext();
...
function PrestatairesListe_ng_template_29_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(16, PrestatairesListe_ng_template_29_p_tag_16_Template, 1, 2, "p-tag", 66)(17, PrestatairesListe_ng_template_29_span_17_Template, 2, 0, "span", 67);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function PrestatairesListe_ng_template_29_Template_button_click_30_listener($event) {
      const prestataire_r12 = \u0275\u0275restoreView(_r11).$implicit;
      const ctx_r4 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r4.goToEdit($event, prestataire_r12.id));
    });
    \u0275\u0275elementEnd();
    \u0275\u0275template(31, PrestatairesListe_ng_template_29_button_31_Template, 1, 6, "button", 72)(32, PrestatairesListe_ng_template_29_button_32_Template, 1, 1, "button", 73);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
...
function PrestatairesListe_ng_template_31_Template(rf, ctx) {
  if (rf & 1) {
...
var PrestatairesListe = class _PrestatairesListe {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PrestatairesListe, selectors: [["app-prestataires-liste"]], hostBindings: function PrestatairesListe_HostBindings(rf, ctx) {
    ...
    if (rf & 1) {
      ...
      \u0275\u0275listener("click", function PrestatairesListe_Template_button_click_11_listener($event) {
        \u0275\u0275restoreView(_r1);
      ...
      \u0275\u0275twoWayListener("ngModelChange", function PrestatairesListe_Template_input_ngModelChange_16_listener($event) {
        \u0275\u0275restoreView(_r1);
        \u0275\u0275twoWayBindingSet(ctx.mobileSearchTerm, $event) || (ctx.mobileSearchTerm = $event);
        return \u0275\u0275resetView($event);
      });
      \u0275\u0275listener("ngModelChange", function PrestatairesListe_Template_input_ngModelChange_16_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.onMobileSearchChange());
      });
      \u0275\u0275elementEnd()()();
      \u0275\u0275template(17, PrestatairesListe_section_17_Template, 2, 2, "section", 19)(18, PrestatairesListe_ng_template_18_Template, 2, 2, "ng-template", null, 1, \u0275\u0275templateRefExtractor)(20, PrestatairesListe_div_20_Template, 2, 0, "div", 20);
      \u0275\u0275elementEnd();
      \u0275\u0275template(21, PrestatairesListe_button_21_Template, 2, 0, "button", 21);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(22, "div", 22)(23, "p-table", 23, 2);
      \u0275\u0275twoWayListener("selectionChange", function PrestatairesListe_Template_p_table_selectionChange_23_listener($event) {
        \u0275\u0275restoreView(_r1);
        \u0275\u0275twoWayBindingSet(ctx.selectedPrestataire, $event) || (ctx.selectedPrestataire = $event);
        return \u0275\u0275resetView($event);
      });
      \u0275\u0275listener("onRowSelect", function PrestatairesListe_Template_p_table_onRowSelect_23_listener($event) {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.onRowSelect($event));
      });
      \u0275\u0275template(25, PrestatairesListe_ng_template_25_Template, 7, 7, "ng-template", null, 3, \u0275\u0275templateRefExtractor)(27, PrestatairesListe_ng_template_27_Template, 23, 0, "ng-template", null, 4, \u0275\u0275templateRefExtractor)(29, PrestatairesListe_ng_template_29_Template, 33, 21, "ng-template", null, 5, \u0275\u0275templateRefExtractor)(31, PrestatairesListe_ng_template_31_Template, 6, 0, "ng-template", null, 6, \u0275\u0275templateRefExtractor);
      \u0275\u0275elementEnd()();
    }
    if (rf & 2) {
      const mobileListState_r15 = \u0275\u0275reference(19);
      \u0275\u0275advance(8);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(PrestatairesListe, { className: "PrestatairesListe", filePath: "src/app/pages/contacts/prestataires/prestataires-liste/prestataires-liste.ts", lineNumber: 47 });
})();
...
function PrestatairesFrom_span_14_Template(rf, ctx) {
  if (rf & 1) {
...
function PrestatairesFrom_small_16_Template(rf, ctx) {
  if (rf & 1) {
...
function PrestatairesFrom_div_17_span_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 32);
    \u0275\u0275text(1, "*");
    \u0275\u0275elementEnd();
...
function PrestatairesFrom_div_17_small_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "small", 32);
...
function PrestatairesFrom_div_17_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 8)(1, "label", 33);
    \u0275\u0275text(2, " Raison sociale ");
    \u0275\u0275template(3, PrestatairesFrom_div_17_span_3_Template, 2, 0, "span", 10);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "input", 34);
    \u0275\u0275twoWayListener("ngModelChange", function PrestatairesFrom_div_17_Template_input_ngModelChange_4_listener($event) {
      \u0275\u0275restoreView(_r1);
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(5, PrestatairesFrom_div_17_small_5_Template, 2, 0, "small", 10);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function PrestatairesFrom_div_18_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 26)(1, "label", 35);
    \u0275\u0275text(2, " Nom ");
    \u0275\u0275template(3, PrestatairesFrom_div_18_span_3_Template, 2, 0, "span", 10);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(5, PrestatairesFrom_div_18_small_5_Template, 2, 0, "small", 10);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function PrestatairesFrom_div_19_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(0, "div", 26)(1, "label", 37);
    \u0275\u0275text(2, " Prenom ");
    \u0275\u0275template(3, PrestatairesFrom_div_19_span_3_Template, 2, 0, "span", 10);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275template(5, PrestatairesFrom_div_19_small_5_Template, 2, 0, "small", 10);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
function PrestatairesFrom_span_25_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 32);
    \u0275\u0275text(1, "*");
    \u0275\u0275elementEnd();
...
function PrestatairesFrom_ng_template_27_Template(rf, ctx) {
  if (rf & 1) {
...
function PrestatairesFrom_ng_template_28_div_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 39);
    \u0275\u0275element(1, "img", 40);
    \u0275\u0275elementStart(2, "span", 41);
...
function PrestatairesFrom_ng_template_28_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, PrestatairesFrom_ng_template_28_div_0_Template, 6, 4, "div", 42);
  }
  if (rf & 2) {
...
function PrestatairesFrom_span_32_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 32);
    \u0275\u0275text(1, "*");
    \u0275\u0275elementEnd();
...
function PrestatairesFrom_small_34_Template(rf, ctx) {
  if (rf & 1) {
...
function PrestatairesFrom_span_40_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 32);
    \u0275\u0275text(1, "*");
    \u0275\u0275elementEnd();
...
function PrestatairesFrom_small_42_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "small", 32);
...
function PrestatairesFrom_span_46_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 32);
    \u0275\u0275text(1, "*");
    \u0275\u0275elementEnd();
...
function PrestatairesFrom_small_48_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "small", 32);
...
function PrestatairesFrom_div_49_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 45)(1, "div", 46)(2, "button", 47);
    \u0275\u0275listener("click", function PrestatairesFrom_div_49_Template_button_click_2_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("click", function PrestatairesFrom_div_49_Template_button_click_3_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r1 = \u0275\u0275nextContext();
...
var PrestatairesFrom = class _PrestatairesFrom {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PrestatairesFrom, selectors: [["app-prestataires-from"]], inputs: { mode: "mode", initialData: "initialData", loading: "loading" }, outputs: { submitForm: "submitForm", cancel: "cancel" }, features: [\u0275\u0275NgOnChangesFeature], decls: 50, vars: 32, consts: [[1, "card"], [1, "flex", "justify-between", "items-center", "mb-6"], [1, "text-surface-900", "dark:text-surface-0", "text-xl", "font-bold"], [1, "grid", "grid-cols-12", "gap-4"], [1, "col-span-12", "lg:col-span-2"], [1, "text-surface-900", "dark:text-surface-0", "font-medium", "text-xl", "mb-4"], [1, "m-0", "p-0", "text-surface-600", "dark:text-surface-200", "leading-normal", "mr-4"], [1, "col-span-12", "lg:col-span-10"], [1, "mb-6", "col-span-12", "md:col-span-12"], ["for", "type", 1, "font-medium", "text-surface-900", "dark:text-surface-0", "mb-2", "block"], ["class", "text-red-500", 4, "ngIf"], ["id", "type", "optionLabel", "label", "optionValue", "value", "placeholder", "Selectionner un type", "fluid", "", 3, "ngModelChange", "ngModel", "options", "disabled", "invalid"], ["class", "mb-6 col-span-12 md:col-span-12", 4, "ngIf"], ["class", "mb-6 col-span-12 md:col-span-6", 4, "ngIf"], [1, "mb-6", "col-span-12"], [1, "grid", "grid-cols-12", "gap-3"], [1, "col-span-12", "md:col-span-4"], ["for", "codePays", 1, "font-medium", "text-surface-900", "dark:text-surface-0", "mb-3", "block"], ["id", "codePays", "optionLabel", "name", "optionValue", "code", "placeholder", "Selectionner un pays", "fluid", "", 3, "ngModelChange", "onChange", "ngModel", "options", "disabled"], ["pTemplate", "item"], ["pTemplate", "selectedItem"], [1, "col-span-12", "md:col-span-8"], ["for", "phone", 1, "font-medium", "text-surface-900", "dark:text-surface-0", "mb-3", "block"], ["id", "phone", "type", "tel", "pInputText", "", "fluid", "", "inputmode", "numeric", "pattern", "[0-9]*", "autocomplete", "tel-national", "placeholder", "Numero local sans indicatif", 3, "ngModelChange", "beforeinput", "keydown", "input", "blur", "ngModel", "invalid", "disabled"], ["class", "text-red-500 block mt-2", 4, "ngIf"], ["class", "text-surface-500 dark:text-surface-400 block mt-2", 4, "ngIf"], [1, "mb-6", "col-span-12", "md:col-span-6"], ["for", "ville", 1, "font-medium", "text-surface-900", "dark:text-surface-0", "mb-2", "block"], ["id", "ville", "type", "text", "pInputText", "", "fluid", "", 3, "ngModelChange", "ngModel", "invalid", "disabled"], ["for", "quartier", 1, "font-medium", "text-surface-900", "dark:text-surface-0", "mb-2", "block"], ["id", "quartier", "type", "text", "pInputText", "", "fluid", "", 3, "ngModelChange", "ngModel", "invalid", "disabled"], ["class", "col-span-12 prestataires-form-actions", 4, "ngIf"], [1, "text-red-500"], ["for", "raison_sociale", 1, "font-medium", "text-surface-900", "dark:text-surface-0", "mb-2", "block"], ["id", "raison_sociale", "type", "text", "pInputText", "", "fluid", "", 3, "ngModelChange", "ngModel", "invalid", "disabled"], ["for", "nom", 1, "font-medium", "text-surface-900", "dark:text-surface-0", "mb-2", "block"], ["id", "nom", "type", "text", "pInputText", "", "fluid", "", 3, "ngModelChange", "ngModel", "invalid", "disabled"], ["for", "prenom", 1, "font-medium", "text-surface-900", "dark:text-surface-0", "mb-2", "block"], ["id", "prenom", "type", "text", "pInputText", "", "fluid", "", 3, "ngModelChange", "ngModel", "invalid", "disabled"], [1, "flex", "items-center", "gap-2"], [1, "w-5", "h-auto", "rounded-sm", 3, "src", "alt"], [1, "font-semibold", "text-primary"], ["class", "flex items-center gap-2", 4, "ngIf"], [1, "text-red-500", "block", "mt-2"], [1, "text-surface-500", "dark:text-surface-400", "block", "mt-2"], [1, "col-span-12", "prestataires-form-actions"], [1, "flex", "flex-wrap", "items-center", "gap-3"], ["pButton", "", "pRipple", "", "icon", "pi pi-check", 1, "prestataires-form-submit", 3, "click", "label", "loading", "disabled"], ["pButton", "", "pRipple", "", "label", "Annuler", "icon", "pi pi-times", "severity", "secondary", 1, "prestataires-form-cancel", 3, "click", "disabled"]], template: function PrestatairesFrom_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(8, " Les champs s'affichent en fonction du type de prestataire. ");
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(9, "div", 7)(10, "div", 3)(11, "div", 8)(12, "label", 9);
      \u0275\u0275text(13, " Type de prestataire ");
      \u0275\u0275template(14, PrestatairesFrom_span_14_Template, 2, 0, "span", 10);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(15, "p-select", 11);
      \u0275\u0275twoWayListener("ngModelChange", function PrestatairesFrom_Template_p_select_ngModelChange_15_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.model.type, $event) || (ctx.model.type = $event);
        return $event;
      });
      \u0275\u0275elementEnd();
      \u0275\u0275template(16, PrestatairesFrom_small_16_Template, 2, 0, "small", 10);
      \u0275\u0275elementEnd();
      \u0275\u0275template(17, PrestatairesFrom_div_17_Template, 6, 5, "div", 12)(18, PrestatairesFrom_div_18_Template, 6, 5, "div", 13)(19, PrestatairesFrom_div_19_Template, 6, 5, "div", 13);
      \u0275\u0275elementStart(20, "div", 14)(21, "div", 15)(22, "div", 16)(23, "label", 17);
      \u0275\u0275text(24, " Pays ");
      \u0275\u0275template(25, PrestatairesFrom_span_25_Template, 2, 0, "span", 10);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(26, "p-select", 18);
      \u0275\u0275twoWayListener("ngModelChange", function PrestatairesFrom_Template_p_select_ngModelChange_26_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.phoneCountry, $event) || (ctx.phoneCountry = $event);
        return $event;
      });
      \u0275\u0275listener("onChange", function PrestatairesFrom_Template_p_select_onChange_26_listener() {
        return ctx.onCountryChange();
      });
      \u0275\u0275template(27, PrestatairesFrom_ng_template_27_Template, 6, 4, "ng-template", 19)(28, PrestatairesFrom_ng_template_28_Template, 1, 1, "ng-template", 20);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(29, "div", 21)(30, "label", 22);
      \u0275\u0275text(31, " Telephone ");
      \u0275\u0275template(32, PrestatairesFrom_span_32_Template, 2, 0, "span", 10);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(33, "input", 23);
      \u0275\u0275twoWayListener("ngModelChange", function PrestatairesFrom_Template_input_ngModelChange_33_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.model.phone, $event) || (ctx.model.phone = $event);
        return $event;
      });
      \u0275\u0275listener("beforeinput", function PrestatairesFrom_Template_input_beforeinput_33_listener($event) {
        return ctx.onPhoneBeforeInput($event);
      })("keydown", function PrestatairesFrom_Template_input_keydown_33_listener($event) {
        return ctx.onPhoneKeyDown($event);
      })("input", function PrestatairesFrom_Template_input_input_33_listener($event) {
        return ctx.onPhoneInput($event);
      })("blur", function PrestatairesFrom_Template_input_blur_33_listener() {
        return ctx.onPhoneBlur();
      });
      \u0275\u0275elementEnd()()();
      \u0275\u0275template(34, PrestatairesFrom_small_34_Template, 2, 0, "small", 24)(35, PrestatairesFrom_small_35_Template, 2, 1, "small", 24)(36, PrestatairesFrom_small_36_Template, 2, 1, "small", 25);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(37, "div", 26)(38, "label", 27);
      \u0275\u0275text(39, " Ville ");
      \u0275\u0275template(40, PrestatairesFrom_span_40_Template, 2, 0, "span", 10);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(41, "input", 28);
      \u0275\u0275twoWayListener("ngModelChange", function PrestatairesFrom_Template_input_ngModelChange_41_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.model.ville, $event) || (ctx.model.ville = $event);
        return $event;
      });
      \u0275\u0275elementEnd();
      \u0275\u0275template(42, PrestatairesFrom_small_42_Template, 2, 0, "small", 10);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(43, "div", 26)(44, "label", 29);
      \u0275\u0275text(45, " Quartier ");
      \u0275\u0275template(46, PrestatairesFrom_span_46_Template, 2, 0, "span", 10);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(47, "input", 30);
      \u0275\u0275twoWayListener("ngModelChange", function PrestatairesFrom_Template_input_ngModelChange_47_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.model.quartier, $event) || (ctx.model.quartier = $event);
        return $event;
      });
      \u0275\u0275elementEnd();
      \u0275\u0275template(48, PrestatairesFrom_small_48_Template, 2, 0, "small", 10);
      \u0275\u0275elementEnd();
      \u0275\u0275template(49, PrestatairesFrom_div_49_Template, 4, 4, "div", 31);
      \u0275\u0275elementEnd()()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(3);
...
//# sourceMappingURL=chunk-55PWXG2A.js.map
