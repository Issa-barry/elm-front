...
var ventes_routes_default = [
  ...
  {
    path: "commandes/:id",
    loadComponent: () => import("./chunk-XGP6SILY.js").then((c) => c.CommandeVenteDetail2),
    data: { breadcrumb: "commandes" }
  },
  {
    path: "factures-vente-liste2",
    loadComponent: () => import("./chunk-LA2SGNVB.js").then((c) => c.FactureVenteListe2),
    data: { breadcrumb: "factures-vente-liste2" }
  },
  {
    path: "factures-vente-detail2/:id",
    loadComponent: () => import("./chunk-MI2XW3X3.js").then((c) => c.FactureVenteDetail2),
    data: { breadcrumb: "factures-vente-detail2" }
  },
  {
    path: "factures-vente-detail3/:id",
    loadComponent: () => import("./chunk-4BABH7U7.js").then((c) => c.FactureVenteDetail3),
    data: { breadcrumb: "factures-vente-detail3" }
  },
  {
    path: "factures-vente-detail4/:id",
    loadComponent: () => import("./chunk-BP2NMZSI.js").then((c) => c.FactureVenteDetail4),
    data: { breadcrumb: "factures-vente-detail2" }
  },
  {
    path: "factures-vente",
    loadComponent: () => import("./chunk-ZTE6NCDD.js").then((c) => c.FactureVenteListe),
  ...
  {
    path: "factures/:id",
    loadComponent: () => import("./chunk-5FEGNFRL.js").then((c) => c.FactureVenteDetail),
    data: { breadcrumb: "factures" }
  },
  {
    path: "encaissements",
    loadComponent: () => import("./chunk-VGPKOEF2.js").then((c) => c.EncaissementVenteListe),
    data: { breadcrumb: "encaissements" }
  },
  {
    path: "commissions",
    loadComponent: () => import("./chunk-XY77I7NB.js").then((c) => c.CommissionVenteListe),
...
//# sourceMappingURL=chunk-BHDAGPNE.js.map
