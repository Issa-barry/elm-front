...
import {
  StyleClassModule
} from "./chunk-5TMWBT6K.js";
import {
  ToggleSwitchModule
} from "./chunk-OB5JMKLO.js";
import {
  RatingModule
} from "./chunk-RLWK5D7T.js";
import {
  ProductService
} from "./chunk-M2MUJ52M.js";
import {
  MoneyPipe
} from "./chunk-4KL4KK62.js";
import {
  Skeleton,
  SkeletonModule
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ComptabilitePackingPaiement, [{
    type: Component,
    args: [{ selector: "app-comptabilite-packing-paiement", standalone: true, imports: [CommonModule, FormsModule, ButtonModule, StyleClassModule, InputNumberModule, MoneyPipe, PhoneFormatPipe], template: `<div class="paiement-panel flex flex-col h-full bg-surface-0 dark:bg-surface-900" *ngIf="facture">
    <!-- Header -->
    ...
    <div class="paiement-body flex-1 min-h-0 w-full p-6 flex flex-col justify-start items-start gap-6 overflow-y-auto">
        ...
        <div class="w-full p-5 bg-surface-50 dark:bg-surface-800 rounded-xl flex flex-col justify-start items-start gap-4">
            <div class="w-full flex justify-start items-start gap-6">
                ...
                <div class="text-surface-900 dark:text-surface-0 text-base font-medium leading-tight">{{  facture.montant_total | money :'GNF'}}</div>
            </div>
            <div class="w-full flex justify-start items-start gap-6">
                <div class="flex-1 text-surface-500 dark:text-surface-400 text-base font-normal leading-tight">D\xE9j\xE0 vers\xE9</div>
                <div class="text-base font-semibold leading-tight" style="color: #059669">{{  facture.montant_verse | money :'GNF'}}</div>
            </div>

            <div class="w-full h-px bg-surface-200 dark:bg-surface-700"></div>

            <div class="w-full flex justify-start items-start gap-6">
                <div class="flex-1 text-surface-900 dark:text-surface-0 text-base font-semibold leading-tight">Reste \xE0 payer</div>
                <div class="text-lg font-bold leading-tight" style="color: #d97706">{{  facture.montant_restant | money :'GNF' }}</div>
            </div>
        </div> 

        <!-- Montant \xE0 verser -->
        <div class="w-full flex flex-col gap-3">
            <div class="text-surface-500 dark:text-surface-400 text-xs font-semibold uppercase tracking-wider">Montant \xE0 verser</div>
            <p-inputnumber
                [(ngModel)]="montant"
                [min]="1"
    ...
    <div class="paiement-footer w-full border-t border-surface-200 dark:border-surface-700 p-6 flex flex-col gap-5 flex-shrink-0">
        <div class="w-full flex justify-start items-start gap-4">
            <div class="flex justify-start items-end gap-2">
                <div class="text-surface-900 dark:text-surface-0 text-base font-medium leading-tight">Montant \xE0 payer</div>
            </div>
...
var FACTURE_LIV_STATUT_LABELS = {
  impayee: "Impay\xE9e",
  partielle: "Partielle",
  payee: "Pay\xE9e",
  annulee: "Annul\xE9e"
};
var FACTURE_LIV_STATUT_SEVERITY = {
  impayee: "danger",
  partielle: "warn",
  payee: "success",
  annulee: "secondary"
...
var FactureLivraisonService = class _FactureLivraisonService {
  http;
  facturesUrl = `${environment.apiUrl}/livraisons/factures`;
  encaissementsUrl = `${environment.apiUrl}/encaissements-livraisons`;
  constructor(http) {
    this.http = http;
  }
  ...
  createFacture(data) {
    return this.http.post(this.facturesUrl, data);
  }
  // ── Commissions ───────────────────────────────────────────────────────
  getCommissionCalcul(factureId) {
    return this.http.get(`${this.facturesUrl}/${factureId}/commissions/calcul`);
  }
  payerCommission(factureId, data) {
    return this.http.post(`${this.facturesUrl}/${factureId}/commissions/paiement`, data);
  }
  // ── Déductions ────────────────────────────────────────────────────────
  addDeduction(factureId, data) {
    return this.http.post(`${this.facturesUrl}/${factureId}/deductions`, data);
  }
  // ── Encaissements (workflow classique) ────────────────────────────────
  getEncaissements(search) {
    let params = new HttpParams();
    if (search)
      params = params.set("search", search);
    return this.http.get(this.encaissementsUrl, { params });
  }
...
var _c03 = () => [10, 25, 50];
var _c13 = () => ["vehicule.marque", "vehicule.immatriculation", "statut"];
var _c23 = () => ({ width: "32rem" });
var _c33 = (a0) => ({ "ng-invalid ng-dirty": a0 });
var _c43 = () => [1, 2, 3];
var _c53 = () => [1, 2, 3, 4, 5, 6, 7];
function FactureLivraisonListe_ng_template_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "h2", 23);
    \u0275\u0275element(1, "i", 24);
    \u0275\u0275text(2, " Factures livraison ");
    \u0275\u0275elementEnd();
  }
}
function FactureLivraisonListe_ng_template_5_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    const _r2 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "p-button", 26);
    \u0275\u0275listener("onClick", function FactureLivraisonListe_ng_template_5_Conditional_0_Template_p_button_onClick_0_listener() {
      \u0275\u0275restoreView(_r2);
...
function FactureLivraisonListe_ng_template_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, FactureLivraisonListe_ng_template_5_Conditional_0_Template, 1, 0, "p-button", 25);
  }
  if (rf & 2) {
...
function FactureLivraisonListe_ng_template_9_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 27)(1, "p-iconfield");
    \u0275\u0275element(2, "p-inputicon", 28);
    \u0275\u0275elementStart(3, "input", 29);
    \u0275\u0275listener("input", function FactureLivraisonListe_ng_template_9_Template_input_input_3_listener($event) {
      \u0275\u0275restoreView(_r4);
      const ctx_r2 = \u0275\u0275nextContext();
      const dt_r5 = \u0275\u0275reference(8);
      return \u0275\u0275resetView(ctx_r2.onGlobalFilter(dt_r5, $event));
    });
    \u0275\u0275elementEnd()()();
  }
}
function FactureLivraisonListe_ng_template_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(13, "Encaiss\xE9");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "th", 38);
    \u0275\u0275text(15, "Statut ");
    \u0275\u0275element(16, "p-sortIcon", 39);
    \u0275\u0275elementEnd();
...
function FactureLivraisonListe_ng_template_13_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 48);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
    \u0275\u0275element(2, "br");
    \u0275\u0275elementStart(3, "code", 49);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate2("", f_r7.vehicule.marque, " ", f_r7.vehicule.modele);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(f_r7.vehicule.immatriculation);
  }
}
function FactureLivraisonListe_ng_template_13_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
...
function FactureLivraisonListe_ng_template_13_Conditional_11_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(ctx_r2.formatMontant(f_r7.montant_encaisse));
  }
}
function FactureLivraisonListe_ng_template_13_Conditional_12_Template(rf, ctx) {
  if (rf & 1) {
...
function FactureLivraisonListe_ng_template_13_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "td");
    \u0275\u0275conditionalCreate(4, FactureLivraisonListe_ng_template_13_Conditional_4_Template, 5, 3)(5, FactureLivraisonListe_ng_template_13_Conditional_5_Template, 2, 0, "span", 21);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275conditionalCreate(11, FactureLivraisonListe_ng_template_13_Conditional_11_Template, 2, 1, "span", 44)(12, FactureLivraisonListe_ng_template_13_Conditional_12_Template, 2, 0, "span", 45);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(13, "td");
    \u0275\u0275element(14, "p-tag", 46);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "td")(16, "p-button", 47);
    \u0275\u0275listener("onClick", function FactureLivraisonListe_ng_template_13_Template_p_button_onClick_16_listener() {
      const f_r7 = \u0275\u0275restoreView(_r6).$implicit;
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.goDetail(f_r7.id));
    });
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("#", f_r7.id);
    \u0275\u0275advance(2);
    \u0275\u0275conditional(f_r7.vehicule ? 4 : 5);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r2.formatDateDisplay(f_r7.date_facture));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r2.formatMontant(f_r7.montant));
    \u0275\u0275advance(2);
    \u0275\u0275conditional(f_r7.montant_encaisse != null ? 11 : 12);
    \u0275\u0275advance(3);
    \u0275\u0275property("value", ctx_r2.getStatutLabel(f_r7.statut))("severity", ctx_r2.getStatutSeverity(f_r7.statut));
    \u0275\u0275advance(2);
    \u0275\u0275property("text", true)("rounded", true);
  }
}
function FactureLivraisonListe_ng_template_15_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r8 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "p-button", 54);
    \u0275\u0275listener("onClick", function FactureLivraisonListe_ng_template_15_Conditional_5_Template_p_button_onClick_0_listener() {
      \u0275\u0275restoreView(_r8);
      const ctx_r2 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r2.openCreateDialog());
    });
...
function FactureLivraisonListe_ng_template_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "td", 50);
    \u0275\u0275element(2, "i", 51);
    \u0275\u0275elementStart(3, "p", 52);
    \u0275\u0275text(4, "Aucune facture livraison.");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(5, FactureLivraisonListe_ng_template_15_Conditional_5_Template, 1, 1, "p-button", 53);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
...
function FactureLivraisonListe_ng_template_17_For_1_For_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td");
...
function FactureLivraisonListe_ng_template_17_For_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr");
    \u0275\u0275repeaterCreate(1, FactureLivraisonListe_ng_template_17_For_1_For_2_Template, 2, 0, "td", null, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    \u0275\u0275advance();
...
function FactureLivraisonListe_ng_template_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275repeaterCreate(0, FactureLivraisonListe_ng_template_17_For_1_Template, 3, 1, "tr", null, \u0275\u0275repeaterTrackByIndex);
  }
  if (rf & 2) {
    \u0275\u0275repeater(\u0275\u0275pureFunction0(0, _c43));
  }
}
function FactureLivraisonListe_Conditional_28_Template(rf, ctx) {
  if (rf & 1) {
...
function FactureLivraisonListe_Conditional_35_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "small", 17);
...
function FactureLivraisonListe_Conditional_42_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "small", 17);
...
function FactureLivraisonListe_ng_template_49_Template(rf, ctx) {
  if (rf & 1) {
    const _r9 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "p-button", 55);
    \u0275\u0275listener("onClick", function FactureLivraisonListe_ng_template_49_Template_p_button_onClick_0_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r2 = \u0275\u0275nextContext();
    ...
    \u0275\u0275listener("onClick", function FactureLivraisonListe_ng_template_49_Template_p_button_onClick_1_listener() {
      \u0275\u0275restoreView(_r9);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.onSaveFacture());
    });
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275property("outlined", true)("disabled", ctx_r2.saving);
    \u0275\u0275advance();
...
var FactureLivraisonListe = class _FactureLivraisonListe {
  ...
  vehiculeOptions = [];
  canCreate = false;
  constructor(fb, factureService, vehiculeService, authService, messageService, router) {
    this.fb = fb;
    this.factureService = factureService;
  ...
  initForm() {
    this.createForm = this.fb.group({
      ...
      date_facture: [/* @__PURE__ */ new Date(), Validators.required],
      description: [""]
    });
  }
  loadFactures() {
  ...
  onSaveFacture() {
    ...
    this.factureService.createFacture(dto).subscribe({
      ...
      error: (err) => {
        this.saving = false;
        this.showApiError(err, "Impossible de cr\xE9er la facture");
      }
    });
  }
  goDetail(id) {
  ...
  showApiError(err, fallback) {
    if (err.status === 422 && err.error?.errors) {
      ...
      msgs.forEach((m) => this.messageService.add({ severity: "error", summary: fallback, detail: m, life: 5e3 }));
    } else {
      this.messageService.add({
        severity: "error",
        summary: "Erreur",
  ...
  static \u0275fac = function FactureLivraisonListe_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _FactureLivraisonListe)(\u0275\u0275directiveInject(FormBuilder), \u0275\u0275directiveInject(FactureLivraisonService), \u0275\u0275directiveInject(VehiculeService), \u0275\u0275directiveInject(AuthService), \u0275\u0275directiveInject(MessageService), \u0275\u0275directiveInject(Router));
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _FactureLivraisonListe, selectors: [["app-facture-livraison-liste"]], features: [\u0275\u0275ProvidersFeature([MessageService])], decls: 51, vars: 33, consts: [["start", ""], ["end", ""], ["dt", ""], ["caption", ""], ["header", ""], ["body", ""], ["emptymessage", ""], ["loadingbody", ""], ["footer", ""], [1, "card"], ["styleClass", "mb-4"], ["styleClass", "p-datatable-gridlines", "responsiveLayout", "scroll", "currentPageReportTemplate", "{first} \xE0 {last} sur {totalRecords} factures", 3, "value", "loading", "paginator", "rows", "rowsPerPageOptions", "globalFilterFields", "showCurrentPageReport"], ["header", "Nouvelle facture livraison", 3, "visibleChange", "visible", "modal", "draggable"], ["novalidate", "", 3, "formGroup"], [1, "flex", "flex-col", "gap-4"], [1, "flex", "flex-col", "gap-1"], [1, "font-medium", "text-sm"], [1, "text-red-500"], ["formControlName", "vehicule_id", "optionLabel", "label", "optionValue", "value", "placeholder", "S\xE9lectionner un v\xE9hicule", "filterPlaceholder", "Rechercher\u2026", "styleClass", "w-full", 3, "options", "filter", "ngClass"], ["formControlName", "montant", "suffix", " GNF", "styleClass", "w-full", 3, "min", "useGrouping", "ngClass"], ["formControlName", "date_facture", "dateFormat", "dd/mm/yy", "styleClass", "w-full", 3, "showIcon", "ngClass"], [1, "text-color-secondary"], ["pTextarea", "", "formControlName", "description", "rows", "2", "placeholder", "Informations compl\xE9mentaires\u2026", 1, "w-full"], [1, "text-xl", "font-semibold", "m-0", "flex", "align-items-center", "gap-2"], [1, "pi", "pi-truck", "text-primary"], ["label", "Nouvelle facture", "icon", "pi pi-plus"], ["label", "Nouvelle facture", "icon", "pi pi-plus", 3, "onClick"], [1, "flex", "justify-end"], [1, "pi", "pi-search"], ["pInputText", "", "type", "text", "placeholder", "Rechercher\u2026", 1, "w-full", "md:w-20rem", 3, "input"], ["pSortableColumn", "id", 2, "min-width", "6rem"], ["field", "id"], [2, "min-width", "14rem"], ["pSortableColumn", "date_facture", 2, "min-width", "9rem"], ["field", "date_facture"], ["pSortableColumn", "montant", 2, "min-width", "10rem"], ["field", "montant"], [2, "min-width", "8rem"], ["pSortableColumn", "statut", 2, "min-width", "8rem"], ["field", "statut"], [2, "min-width", "6rem"], [1, "font-mono", "text-sm", "text-color-secondary"], [1, "text-sm"], [1, "font-semibold"], [1, "text-sm", "text-green-600", "font-medium"], [1, "text-color-secondary", "text-sm"], [3, "value", "severity"], ["icon", "pi pi-eye", "severity", "info", "pTooltip", "Voir d\xE9tail", 3, "onClick", "text", "rounded"], [1, "font-medium"], [1, "text-xs", "text-color-secondary"], ["colspan", "7", 1, "text-center", "py-8"], [1, "pi", "pi-file", "text-4xl", "mb-3", "block", 2, "opacity", ".25"], [1, "text-color-secondary", "m-0"], ["label", "Cr\xE9er une facture", "icon", "pi pi-plus", "styleClass", "mt-3", 3, "text"], ["label", "Cr\xE9er une facture", "icon", "pi pi-plus", "styleClass", "mt-3", 3, "onClick", "text"], ["label", "Annuler", "severity", "secondary", 3, "onClick", "outlined", "disabled"], ["label", "Cr\xE9er", "icon", "pi pi-save", 3, "onClick", "loading"]], template: function FactureLivraisonListe_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
      \u0275\u0275element(0, "p-toast");
      \u0275\u0275elementStart(1, "div", 9)(2, "p-toolbar", 10);
      \u0275\u0275template(3, FactureLivraisonListe_ng_template_3_Template, 3, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor)(5, FactureLivraisonListe_ng_template_5_Template, 1, 1, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(7, "p-table", 11, 2);
      \u0275\u0275template(9, FactureLivraisonListe_ng_template_9_Template, 4, 0, "ng-template", null, 3, \u0275\u0275templateRefExtractor)(11, FactureLivraisonListe_ng_template_11_Template, 19, 0, "ng-template", null, 4, \u0275\u0275templateRefExtractor)(13, FactureLivraisonListe_ng_template_13_Template, 17, 9, "ng-template", null, 5, \u0275\u0275templateRefExtractor)(15, FactureLivraisonListe_ng_template_15_Template, 6, 1, "ng-template", null, 6, \u0275\u0275templateRefExtractor)(17, FactureLivraisonListe_ng_template_17_Template, 2, 1, "ng-template", null, 7, \u0275\u0275templateRefExtractor);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(19, "p-dialog", 12);
      \u0275\u0275twoWayListener("visibleChange", function FactureLivraisonListe_Template_p_dialog_visibleChange_19_listener($event) {
        \u0275\u0275restoreView(_r1);
        \u0275\u0275twoWayBindingSet(ctx.dialogVisible, $event) || (ctx.dialogVisible = $event);
        return \u0275\u0275resetView($event);
      });
      \u0275\u0275elementStart(20, "form", 13)(21, "div", 14)(22, "div", 15)(23, "label", 16);
      \u0275\u0275text(24, "V\xE9hicule ");
      \u0275\u0275elementStart(25, "span", 17);
      \u0275\u0275text(26, "*");
      \u0275\u0275elementEnd()();
      \u0275\u0275element(27, "p-select", 18);
      \u0275\u0275conditionalCreate(28, FactureLivraisonListe_Conditional_28_Template, 2, 0, "small", 17);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(29, "div", 15)(30, "label", 16);
      \u0275\u0275text(31, "Montant (GNF) ");
      \u0275\u0275elementStart(32, "span", 17);
      \u0275\u0275text(33, "*");
      \u0275\u0275elementEnd()();
      \u0275\u0275element(34, "p-inputNumber", 19);
      \u0275\u0275conditionalCreate(35, FactureLivraisonListe_Conditional_35_Template, 2, 0, "small", 17);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(36, "div", 15)(37, "label", 16);
      \u0275\u0275text(38, "Date de facturation ");
      \u0275\u0275elementStart(39, "span", 17);
      \u0275\u0275text(40, "*");
      \u0275\u0275elementEnd()();
      \u0275\u0275element(41, "p-datepicker", 20);
      \u0275\u0275conditionalCreate(42, FactureLivraisonListe_Conditional_42_Template, 2, 0, "small", 17);
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275text(47, "(optionnel)");
      \u0275\u0275elementEnd()();
      \u0275\u0275element(48, "textarea", 22);
      \u0275\u0275elementEnd()()();
      \u0275\u0275template(49, FactureLivraisonListe_ng_template_49_Template, 2, 3, "ng-template", null, 8, \u0275\u0275templateRefExtractor);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance(7);
      \u0275\u0275property("value", ctx.factures())("loading", ctx.loading)("paginator", true)("rows", 10)("rowsPerPageOptions", \u0275\u0275pureFunction0(24, _c03))("globalFilterFields", \u0275\u0275pureFunction0(25, _c13))("showCurrentPageReport", true);
      \u0275\u0275advance(12);
      \u0275\u0275styleMap(\u0275\u0275pureFunction0(26, _c23));
      \u0275\u0275twoWayProperty("visible", ctx.dialogVisible);
      \u0275\u0275property("modal", true)("draggable", false);
      \u0275\u0275advance();
      \u0275\u0275property("formGroup", ctx.createForm);
      \u0275\u0275advance(7);
      \u0275\u0275property("options", ctx.vehiculeOptions)("filter", true)("ngClass", \u0275\u0275pureFunction1(27, _c33, ctx.isInvalid("vehicule_id")));
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.isInvalid("vehicule_id") ? 28 : -1);
      \u0275\u0275advance(6);
      \u0275\u0275property("min", 1)("useGrouping", true)("ngClass", \u0275\u0275pureFunction1(29, _c33, ctx.isInvalid("montant")));
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.isInvalid("montant") ? 35 : -1);
      \u0275\u0275advance(6);
      \u0275\u0275property("showIcon", true)("ngClass", \u0275\u0275pureFunction1(31, _c33, ctx.isInvalid("date_facture")));
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.isInvalid("date_facture") ? 42 : -1);
    }
  }, dependencies: [CommonModule, NgClass, ReactiveFormsModule, \u0275NgNoValidate, DefaultValueAccessor, NgControlStatus, NgControlStatusGroup, FormGroupDirective, FormControlName, TableModule, Table, SortableColumn, SortIcon, ButtonModule, Button, ToastModule, Toast, ToolbarModule, Toolbar, InputTextModule, InputText, InputNumberModule, InputNumber, TagModule, Tag, SkeletonModule, Skeleton, DialogModule, Dialog, SelectModule, Select, DatePickerModule, DatePicker, TextareaModule, Textarea, TooltipModule, Tooltip, InputIconModule, InputIcon, IconFieldModule, IconField], encapsulation: 2 });
};
(() => {
...
<div class="card">
  ...
  <p-table
    ...
    currentPageReportTemplate="{first} \xE0 {last} sur {totalRecords} factures"
  ...
  >
    ...
    <ng-template #header>
      <tr>
        <th pSortableColumn="id" style="min-width:6rem">N\xB0 <p-sortIcon field="id" /></th>
        <th style="min-width:14rem">V\xE9hicule</th>
        ...
        <th style="min-width:8rem">Encaiss\xE9</th>
...
>
  ...
  <ng-template #footer>
    ...
    <p-button label="Cr\xE9er" icon="pi pi-save" (onClick)="onSaveFacture()" [loading]="saving" />
  </ng-template>
</p-dialog>
` }]
  }], () => [{ type: FormBuilder }, { type: FactureLivraisonService }, { type: VehiculeService }, { type: AuthService }, { type: MessageService }, { type: Router }], null);
})();
(() => {
...
var _c04 = () => ({ width: "28rem" });
var _c14 = () => [1, 2, 3, 4];
var _forTrack0 = ($index, $item) => $item.id;
function FactureLivraisonDetail_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate2(" Facture #", ctx_r1.facture.id, " \u2014 ", ctx_r1.formatDate(ctx_r1.facture.date_facture), " ");
  }
}
function FactureLivraisonDetail_Conditional_7_For_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p-card");
    \u0275\u0275element(1, "p-skeleton", 18);
    \u0275\u0275elementEnd();
  }
}
function FactureLivraisonDetail_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275repeaterCreate(1, FactureLivraisonDetail_Conditional_7_For_2_Template, 2, 0, "p-card", null, \u0275\u0275repeaterTrackByIndex);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    \u0275\u0275advance();
...
function FactureLivraisonDetail_Conditional_8_ng_template_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 26)(1, "div", 27);
    \u0275\u0275element(2, "i", 28);
    \u0275\u0275elementStart(3, "h2", 29);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd()();
    \u0275\u0275element(5, "p-tag", 30);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate1("Facture #", ctx_r1.facture.id);
    \u0275\u0275advance();
    \u0275\u0275property("value", ctx_r1.getStatutLabel(ctx_r1.facture.statut))("severity", ctx_r1.getStatutSeverity(ctx_r1.facture.statut));
  }
}
function FactureLivraisonDetail_Conditional_8_Conditional_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div")(1, "p", 21);
    \u0275\u0275text(2, "Encaiss\xE9");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "p", 31);
    \u0275\u0275text(4);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(5, "div")(6, "p", 21);
    \u0275\u0275text(7, "Restant");
    \u0275\u0275elementEnd();
...
function FactureLivraisonDetail_Conditional_8_Conditional_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "p-divider");
    \u0275\u0275elementStart(1, "div")(2, "div", 33)(3, "span", 16);
    \u0275\u0275text(4, "Progression encaissement");
    \u0275\u0275elementEnd();
...
function FactureLivraisonDetail_Conditional_8_Conditional_18_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "p-divider");
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r1.facture.description);
  }
}
function FactureLivraisonDetail_Conditional_8_Conditional_19_ng_template_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 41);
    \u0275\u0275element(1, "i", 42);
    \u0275\u0275elementStart(2, "h2", 29);
    \u0275\u0275text(3, "V\xE9hicule associ\xE9");
    \u0275\u0275elementEnd()();
  }
}
function FactureLivraisonDetail_Conditional_8_Conditional_19_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p-card");
    \u0275\u0275template(1, FactureLivraisonDetail_Conditional_8_Conditional_19_ng_template_1_Template, 4, 0, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementStart(3, "div", 38)(4, "span", 39);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(6, "div")(7, "p", 23);
    \u0275\u0275text(8);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(9, "code", 40);
    \u0275\u0275text(10);
    \u0275\u0275elementEnd()()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate2(" ", ctx_r1.facture.vehicule.marque == null ? null : ctx_r1.facture.vehicule.marque.charAt(0), "", ctx_r1.facture.vehicule.modele == null ? null : ctx_r1.facture.vehicule.modele.charAt(0), " ");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate2("", ctx_r1.facture.vehicule.marque, " ", ctx_r1.facture.vehicule.modele);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r1.facture.vehicule.immatriculation);
  }
}
function FactureLivraisonDetail_Conditional_8_Conditional_20_ng_template_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 41);
    \u0275\u0275element(1, "i", 45);
    \u0275\u0275elementStart(2, "h2", 29);
...
function FactureLivraisonDetail_Conditional_8_Conditional_20_For_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 44)(1, "div")(2, "span", 46);
    \u0275\u0275text(3);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const enc_r3 = ctx.$implicit;
    const ctx_r1 = \u0275\u0275nextContext(3);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(ctx_r1.formatMontant(enc_r3.montant));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("\u2014 ", enc_r3.mode_paiement);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r1.formatDate(enc_r3.date_encaissement));
  }
}
function FactureLivraisonDetail_Conditional_8_Conditional_20_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "p-card");
    \u0275\u0275template(1, FactureLivraisonDetail_Conditional_8_Conditional_20_ng_template_1_Template, 4, 0, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementStart(3, "div", 43);
    \u0275\u0275repeaterCreate(4, FactureLivraisonDetail_Conditional_8_Conditional_20_For_5_Template, 8, 3, "div", 44, _forTrack0);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
...
function FactureLivraisonDetail_Conditional_8_ng_template_23_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 41);
    \u0275\u0275element(1, "i", 48);
    \u0275\u0275elementStart(2, "h2", 29);
...
function FactureLivraisonDetail_Conditional_8_Conditional_25_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 25)(1, "p", 49);
    \u0275\u0275text(2, " Calculez la commission pour cette facture. ");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "p-button", 50);
    \u0275\u0275listener("onClick", function FactureLivraisonDetail_Conditional_8_Conditional_25_Template_p_button_onClick_3_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.calculerCommission());
    });
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(3);
    \u0275\u0275property("outlined", true)("loading", ctx_r1.commissionLoading);
  }
}
function FactureLivraisonDetail_Conditional_8_Conditional_26_Conditional_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "p-tag", 52);
  }
}
function FactureLivraisonDetail_Conditional_8_Conditional_26_Conditional_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "p-tag", 53);
  }
}
function FactureLivraisonDetail_Conditional_8_Conditional_26_Conditional_25_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "small", 59);
    \u0275\u0275element(1, "i", 61);
    \u0275\u0275text(2, " La facture doit \xEAtre enti\xE8rement pay\xE9e avant de r\xE9gler la commission. ");
    \u0275\u0275elementEnd();
  }
}
function FactureLivraisonDetail_Conditional_8_Conditional_26_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 11)(1, "div", 51)(2, "span", 40);
    \u0275\u0275text(3, "Statut");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(4, FactureLivraisonDetail_Conditional_8_Conditional_26_Conditional_4_Template, 1, 0, "p-tag", 52)(5, FactureLivraisonDetail_Conditional_8_Conditional_26_Conditional_5_Template, 1, 0, "p-tag", 53);
    \u0275\u0275elementEnd();
    \u0275\u0275element(6, "p-divider", 54);
    \u0275\u0275elementStart(7, "div", 55)(8, "span", 40);
    \u0275\u0275text(9, "Montant net");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "span", 34);
    \u0275\u0275text(11);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(12, "div", 55)(13, "span", 40);
    \u0275\u0275text(14);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(15, "span", 56);
    \u0275\u0275text(16);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(17, "div", 55)(18, "span", 40);
    \u0275\u0275text(19);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(20, "span", 57);
    \u0275\u0275text(21);
    \u0275\u0275elementEnd()();
    \u0275\u0275element(22, "p-divider", 54);
    \u0275\u0275elementStart(23, "div", 43)(24, "p-button", 58);
    \u0275\u0275listener("onClick", function FactureLivraisonDetail_Conditional_8_Conditional_26_Template_p_button_onClick_24_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.openPayerDialog());
    });
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(25, FactureLivraisonDetail_Conditional_8_Conditional_26_Conditional_25_Template, 3, 0, "small", 59);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(26, "p-button", 60);
    \u0275\u0275listener("onClick", function FactureLivraisonDetail_Conditional_8_Conditional_26_Template_p_button_onClick_26_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r1 = \u0275\u0275nextContext(2);
      return \u0275\u0275resetView(ctx_r1.calculerCommission());
    });
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(4);
    \u0275\u0275conditional(ctx_r1.commission.est_payee ? 4 : 5);
    \u0275\u0275advance(7);
    \u0275\u0275textInterpolate(ctx_r1.formatMontant(ctx_r1.commission.montant_net));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" Propri\xE9taire (", ctx_r1.commission.part_proprietaire_pct, "%) ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r1.formatMontant(ctx_r1.commission.montant_proprietaire));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate1(" Livreur (", ctx_r1.commission.part_livreur_pct, "%) ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r1.formatMontant(ctx_r1.commission.montant_livreur));
    \u0275\u0275advance(3);
    \u0275\u0275property("disabled", !ctx_r1.canPayCommission)("loading", ctx_r1.payerLoading);
    \u0275\u0275advance();
    \u0275\u0275conditional(!ctx_r1.canPayCommission && !ctx_r1.commission.est_payee ? 25 : -1);
    \u0275\u0275advance();
    \u0275\u0275property("text", true)("loading", ctx_r1.commissionLoading);
  }
}
function FactureLivraisonDetail_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 7)(1, "div", 19)(2, "p-card");
    \u0275\u0275template(3, FactureLivraisonDetail_Conditional_8_ng_template_3_Template, 6, 3, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementStart(5, "div", 20)(6, "div")(7, "p", 21);
    ...
    \u0275\u0275text(13, "Date de facture");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(14, "p", 23);
    \u0275\u0275text(15);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(16, FactureLivraisonDetail_Conditional_8_Conditional_16_Template, 10, 2);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(17, FactureLivraisonDetail_Conditional_8_Conditional_17_Template, 9, 3);
    \u0275\u0275conditionalCreate(18, FactureLivraisonDetail_Conditional_8_Conditional_18_Template, 3, 1);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(19, FactureLivraisonDetail_Conditional_8_Conditional_19_Template, 11, 5, "p-card");
    \u0275\u0275conditionalCreate(20, FactureLivraisonDetail_Conditional_8_Conditional_20_Template, 6, 0, "p-card");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(21, "div", 24)(22, "p-card");
    \u0275\u0275template(23, FactureLivraisonDetail_Conditional_8_ng_template_23_Template, 4, 0, "ng-template", null, 1, \u0275\u0275templateRefExtractor);
    \u0275\u0275conditionalCreate(25, FactureLivraisonDetail_Conditional_8_Conditional_25_Template, 4, 2, "div", 25)(26, FactureLivraisonDetail_Conditional_8_Conditional_26_Template, 27, 11, "div", 11);
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(10);
    \u0275\u0275textInterpolate(ctx_r1.formatMontant(ctx_r1.facture.montant));
    \u0275\u0275advance(5);
    \u0275\u0275textInterpolate(ctx_r1.formatDate(ctx_r1.facture.date_facture));
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.facture.montant_encaisse != null ? 16 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.facture.montant_encaisse != null ? 17 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.facture.description ? 18 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.facture.vehicule ? 19 : -1);
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.facture.encaissements && ctx_r1.facture.encaissements.length > 0 ? 20 : -1);
    \u0275\u0275advance(5);
    \u0275\u0275conditional(!ctx_r1.commission ? 25 : 26);
  }
}
function FactureLivraisonDetail_Conditional_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 9)(1, "p", 62);
    \u0275\u0275text(2, "R\xE9capitulatif");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "p", 63);
    \u0275\u0275text(4, "Propri\xE9taire : ");
...
function FactureLivraisonDetail_ng_template_25_Template(rf, ctx) {
  if (rf & 1) {
    const _r6 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "p-button", 64);
    \u0275\u0275listener("onClick", function FactureLivraisonDetail_ng_template_25_Template_p_button_onClick_0_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.commissionDialogVisible = false);
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(1, "p-button", 65);
    \u0275\u0275listener("onClick", function FactureLivraisonDetail_ng_template_25_Template_p_button_onClick_1_listener() {
      \u0275\u0275restoreView(_r6);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onPayerCommission());
    });
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275property("outlined", true)("disabled", ctx_r1.payerLoading);
    \u0275\u0275advance();
    \u0275\u0275property("loading", ctx_r1.payerLoading);
  }
}
var FactureLivraisonDetail = class _FactureLivraisonDetail {
  ...
  loadFacture(id) {
    ...
    this.factureService.getFacture(id).subscribe({
      ...
      error: () => {
        ...
        setTimeout(() => this.router.navigate(["/comptabilite/factures-livraison"]), 2e3);
      }
    });
  }
  calculerCommission() {
    ...
    this.factureService.getCommissionCalcul(this.facture.id).subscribe({
      ...
      error: () => {
        ...
        this.messageService.add({
          severity: "error",
          summary: "Erreur",
          detail: "Impossible de calculer la commission.",
          life: 4e3
        });
      }
    });
  ...
  onPayerCommission() {
    ...
    if (this.commissionForm.invalid || !this.facture || this.payerLoading)
      return;
    const dto = {
      mode_paiement: this.commissionForm.value.mode_paiement,
      notes: this.commissionForm.value.notes || void 0
    };
    ...
    this.factureService.payerCommission(this.facture.id, dto).subscribe({
      next: () => {
        ...
        this.messageService.add({
          severity: "success",
          summary: "Commission pay\xE9e",
          detail: "Le paiement de la commission a \xE9t\xE9 enregistr\xE9.",
          life: 4e3
        });
  ...
  get canPayCommission() {
    return this.facture?.statut === "payee" && this.commission !== null && this.commission?.est_payee === false;
  }
  getStatutLabel(s) {
    return FACTURE_LIV_STATUT_LABELS[s] ?? s;
  }
  ...
  get progressPct() {
    if (!this.facture?.montant || !this.facture.montant_encaisse)
      return 0;
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _FactureLivraisonDetail, selectors: [["app-facture-livraison-detail"]], features: [\u0275\u0275ProvidersFeature([MessageService])], decls: 27, vars: 12, consts: [["footer", ""], ["header", ""], [1, "flex", "align-items-center", "gap-3", "mb-5", "px-4", "pt-4", "md:px-6"], ["icon", "pi pi-arrow-left", "severity", "secondary", "pTooltip", "Retour aux factures", 3, "onClick", "text"], [1, "text-xl", "font-semibold", "m-0"], [1, "text-color-secondary", "text-sm"], [1, "grid", "grid-cols-1", "md:grid-cols-2", "gap-4", "px-4", "md:px-6"], [1, "grid", "grid-cols-1", "lg:grid-cols-3", "gap-4", "px-4", "md:px-6"], ["header", "Payer la commission", 3, "visibleChange", "visible", "modal", "draggable"], [1, "mb-4", "p-3", "surface-100", "border-round"], ["novalidate", "", 3, "formGroup"], [1, "flex", "flex-col", "gap-3"], [1, "flex", "flex-col", "gap-1"], [1, "font-medium", "text-sm"], [1, "text-red-500"], ["formControlName", "mode_paiement", "optionLabel", "label", "optionValue", "value", "styleClass", "w-full", 3, "options"], [1, "text-color-secondary"], ["pInputText", "", "formControlName", "notes", "placeholder", "Remarques\u2026"], ["height", "6rem"], [1, "lg:col-span-2", "flex", "flex-col", "gap-4"], [1, "grid", "grid-cols-2", "gap-4"], [1, "text-color-secondary", "text-sm", "m-0", "mb-1"], [1, "text-2xl", "font-bold", "m-0", "text-primary"], [1, "font-semibold", "m-0"], [1, "flex", "flex-col", "gap-4"], [1, "text-center", "py-3"], [1, "flex", "align-items-center", "justify-content-between", "px-5", "pt-4", "pb-2"], [1, "flex", "align-items-center", "gap-2"], [1, "pi", "pi-file-invoice", "text-primary", "text-xl"], [1, "text-base", "font-semibold", "m-0"], [3, "value", "severity"], [1, "font-semibold", "text-green-600", "m-0"], [1, "font-semibold", "text-red-500", "m-0"], [1, "flex", "justify-content-between", "mb-1", "text-sm"], [1, "font-semibold"], [1, "surface-200", "border-round", "overflow-hidden", 2, "height", ".5rem"], [1, "bg-primary", "border-round", "transition-all", 2, "height", "100%"], [1, "text-color-secondary", "text-sm", "m-0"], [1, "flex", "align-items-center", "gap-3"], [1, "flex", "align-items-center", "justify-content-center", "bg-blue-100", "text-blue-700", "border-circle", "font-bold", 2, "width", "3rem", "height", "3rem"], [1, "text-sm", "text-color-secondary"], [1, "flex", "align-items-center", "gap-2", "px-5", "pt-4", "pb-2"], [1, "pi", "pi-car", "text-blue-500", "text-xl"], [1, "flex", "flex-col", "gap-2"], [1, "flex", "justify-content-between", "align-items-center", "p-3", "surface-100", "border-round"], [1, "pi", "pi-wallet", "text-green-500", "text-xl"], [1, "font-medium"], [1, "text-color-secondary", "text-sm", "ml-2"], [1, "pi", "pi-percentage", "text-orange-500", "text-xl"], [1, "text-color-secondary", "text-sm", "mb-3"], ["label", "Calculer la commission", "icon", "pi pi-calculator", "severity", "secondary", 3, "onClick", "outlined", "loading"], [1, "flex", "justify-content-between", "align-items-center"], ["value", "Pay\xE9e", "severity", "success"], ["value", "Non pay\xE9e", "severity", "danger"], ["styleClass", "my-1"], [1, "flex", "justify-content-between"], [1, "font-semibold", "text-blue-600"], [1, "font-semibold", "text-orange-600"], ["label", "Payer la commission", "icon", "pi pi-credit-card", "styleClass", "w-full", 3, "onClick", "disabled", "loading"], [1, "text-orange-600", "text-center"], ["label", "Recalculer", "icon", "pi pi-refresh", "severity", "secondary", "styleClass", "w-full", 3, "onClick", "text", "loading"], [1, "pi", "pi-info-circle", "mr-1"], [1, "text-sm", "m-0", "text-color-secondary", "mb-1"], [1, "m-0"], ["label", "Annuler", "severity", "secondary", 3, "onClick", "outlined", "disabled"], ["label", "Confirmer le paiement", "icon", "pi pi-check", 3, "onClick", "loading"]], template: function FactureLivraisonDetail_Template(rf, ctx) {
    if (rf & 1) {
      const _r1 = \u0275\u0275getCurrentView();
      \u0275\u0275element(0, "p-toast");
      \u0275\u0275elementStart(1, "div", 2)(2, "p-button", 3);
      \u0275\u0275listener("onClick", function FactureLivraisonDetail_Template_p_button_onClick_2_listener() {
        \u0275\u0275restoreView(_r1);
        return \u0275\u0275resetView(ctx.goBack());
      });
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(3, "div")(4, "h1", 4);
      \u0275\u0275text(5, "D\xE9tail facture livraison");
      \u0275\u0275elementEnd();
      \u0275\u0275conditionalCreate(6, FactureLivraisonDetail_Conditional_6_Template, 2, 2, "span", 5);
      \u0275\u0275elementEnd()();
      \u0275\u0275conditionalCreate(7, FactureLivraisonDetail_Conditional_7_Template, 3, 1, "div", 6)(8, FactureLivraisonDetail_Conditional_8_Template, 27, 8, "div", 7);
      \u0275\u0275elementStart(9, "p-dialog", 8);
      \u0275\u0275twoWayListener("visibleChange", function FactureLivraisonDetail_Template_p_dialog_visibleChange_9_listener($event) {
        \u0275\u0275restoreView(_r1);
        \u0275\u0275twoWayBindingSet(ctx.commissionDialogVisible, $event) || (ctx.commissionDialogVisible = $event);
        return \u0275\u0275resetView($event);
      });
      \u0275\u0275conditionalCreate(10, FactureLivraisonDetail_Conditional_10_Template, 11, 2, "div", 9);
      \u0275\u0275elementStart(11, "form", 10)(12, "div", 11)(13, "div", 12)(14, "label", 13);
      \u0275\u0275text(15, "Mode de paiement ");
      \u0275\u0275elementStart(16, "span", 14);
      \u0275\u0275text(17, "*");
      \u0275\u0275elementEnd()();
      \u0275\u0275element(18, "p-select", 15);
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275elementEnd()()();
      \u0275\u0275template(25, FactureLivraisonDetail_ng_template_25_Template, 2, 3, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance(2);
      \u0275\u0275property("text", true);
      \u0275\u0275advance(4);
      \u0275\u0275conditional(ctx.facture && !ctx.loading ? 6 : -1);
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.loading ? 7 : ctx.facture ? 8 : -1);
      \u0275\u0275advance(2);
      \u0275\u0275styleMap(\u0275\u0275pureFunction0(11, _c04));
      \u0275\u0275twoWayProperty("visible", ctx.commissionDialogVisible);
      \u0275\u0275property("modal", true)("draggable", false);
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.commission ? 10 : -1);
      \u0275\u0275advance();
      \u0275\u0275property("formGroup", ctx.commissionForm);
      \u0275\u0275advance(7);
...
<div class="flex align-items-center gap-3 mb-5 px-4 pt-4 md:px-6">
  ...
  />
  <div>
    <h1 class="text-xl font-semibold m-0">D\xE9tail facture livraison</h1>
    @if (facture && !loading) {
...
@if (loading) {
  ...
  <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 px-4 md:px-6">
    ...
    <!-- Colonne lat\xE9rale : Commission \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500 -->
    <div class="flex flex-col gap-4">
      <p-card>
        <ng-template #header>
          <div class="flex align-items-center gap-2 px-5 pt-4 pb-2">
          ...
          <div class="flex flex-col gap-3">
            ...
            <div class="flex justify-content-between align-items-center">
              ...
              @if (commission.est_payee) {
                <p-tag value="Pay\xE9e" severity="success" />
              } @else {
                <p-tag value="Non pay\xE9e" severity="danger" />
              }
            </div>
            ...
            <div class="flex justify-content-between">
              <span class="text-sm text-color-secondary">
                Propri\xE9taire ({{ commission.part_proprietaire_pct }}%)
              </span>
            ...
            <!-- Bouton payer commission (bloqu\xE9 si facture non pay\xE9e) -->
            <div class="flex flex-col gap-2">
              <p-button
              ...
              @if (!canPayCommission && !commission.est_payee) {
                <small class="text-orange-600 text-center">
                  ...
                  La facture doit \xEAtre enti\xE8rement pay\xE9e avant de r\xE9gler la commission.
                </small>
              }
            </div>
...
>
  @if (commission) {
    <div class="mb-4 p-3 surface-100 border-round">
      <p class="text-sm m-0 text-color-secondary mb-1">R\xE9capitulatif</p>
      <p class="m-0">Propri\xE9taire : <strong>{{ formatMontant(commission.montant_proprietaire) }}</strong></p>
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(FactureLivraisonDetail, { className: "FactureLivraisonDetail", filePath: "src/app/pages/comptabilite/facture-livraison-detail/facture-livraison-detail.ts", lineNumber: 47 });
})();

// src/app/pages/comptabilite/encaissement-livraison-liste/encaissement-livraison-liste.ts
var _c05 = () => [10, 25, 50];
var _c15 = () => ["mode_paiement", "notes"];
var _c24 = () => ({ width: "30rem" });
...
function EncaissementLivraisonListe_ng_template_33_Conditional_9_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275textInterpolate1(" #", e_r6.facture_livraison_id, " ");
  }
}
...
function EncaissementLivraisonListe_ng_template_33_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275conditional(e_r6.facture_livraison_id ? 9 : 10);
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(e_r6.notes || "\u2014");
  }
}
...
function EncaissementLivraisonListe_ng_template_37_For_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    \u0275\u0275advance();
    \u0275\u0275repeater(\u0275\u0275pureFunction0(0, _c54));
  }
}
function EncaissementLivraisonListe_ng_template_37_Template(rf, ctx) {
  ...
  if (rf & 2) {
    \u0275\u0275repeater(\u0275\u0275pureFunction0(0, _c44));
  }
}
...
function EncaissementLivraisonListe_ng_template_73_Template(rf, ctx) {
  if (rf & 1) {
    const _r7 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "p-button", 53);
    \u0275\u0275listener("onClick", function EncaissementLivraisonListe_ng_template_73_Template_p_button_onClick_0_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r2 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r2.dialogVisible = false);
    });
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(1, "p-button", 54);
    \u0275\u0275listener("onClick", function EncaissementLivraisonListe_ng_template_73_Template_p_button_onClick_1_listener() {
      \u0275\u0275restoreView(_r7);
      const ctx_r2 = \u0275\u0275nextContext();
...
var EncaissementLivraisonListe = class _EncaissementLivraisonListe {
  ...
  canCreate = false;
  // Stats calculées
  totalEncaisse = computed(() => this.encaissements().reduce((sum, e) => sum + (e.montant ?? 0), 0), ...ngDevMode ? [{ debugName: "totalEncaisse" }] : []);
  ...
  onSaveEncaissement() {
    ...
    const dto = {
      ...
      facture_livraison_id: v.facture_livraison_id || void 0
    };
    this.saving = true;
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EncaissementLivraisonListe, selectors: [["app-encaissement-livraison-liste"]], features: [\u0275\u0275ProvidersFeature([MessageService])], decls: 75, vars: 27, consts: [["start", ""], ["end", ""], ["dt", ""], ["caption", ""], ["header", ""], ["body", ""], ["emptymessage", ""], ["loadingbody", ""], ["footer", ""], [1, "flex", "flex-col", "gap-4"], [1, "grid", "grid-cols-1", "md:grid-cols-2", "gap-4", "px-0"], [1, "flex", "align-items-center", "gap-3"], [1, "flex", "align-items-center", "justify-content-center", "bg-green-100", "text-green-700", "border-circle", 2, "width", "3rem", "height", "3rem"], [1, "pi", "pi-wallet", "text-xl"], [1, "text-color-secondary", "text-sm", "m-0"], [1, "text-2xl", "font-bold", "text-green-600", "m-0"], [1, "flex", "align-items-center", "justify-content-center", "bg-blue-100", "text-blue-700", "border-circle", 2, "width", "3rem", "height", "3rem"], [1, "pi", "pi-list", "text-xl"], [1, "text-2xl", "font-bold", "m-0"], [1, "card"], ["styleClass", "mb-4"], ["styleClass", "p-datatable-gridlines", "responsiveLayout", "scroll", "currentPageReportTemplate", "{first} \xE0 {last} sur {totalRecords} encaissements", 3, "value", "loading", "paginator", "rows", "rowsPerPageOptions", "globalFilterFields", "showCurrentPageReport"], ["header", "Nouvel encaissement", 3, "visibleChange", "visible", "modal", "draggable"], ["novalidate", "", 3, "formGroup"], [1, "flex", "flex-col", "gap-1"], [1, "font-medium", "text-sm"], [1, "text-red-500"], ["formControlName", "montant", "suffix", " GNF", "styleClass", "w-full", 3, "min", "useGrouping", "ngClass"], ["formControlName", "mode_paiement", "optionLabel", "label", "optionValue", "value", "styleClass", "w-full", 3, "options"], ["formControlName", "date_encaissement", "dateFormat", "dd/mm/yy", "styleClass", "w-full", 3, "showIcon"], [1, "text-color-secondary"], ["formControlName", "facture_livraison_id", "placeholder", "ID facture associ\xE9e", "styleClass", "w-full", 3, "useGrouping"], ["pInputText", "", "formControlName", "notes", "placeholder", "Remarques\u2026"], [1, "text-xl", "font-semibold", "m-0", "flex", "align-items-center", "gap-2"], [1, "pi", "pi-money-bill", "text-primary"], ["label", "Nouvel encaissement", "icon", "pi pi-plus"], ["label", "Nouvel encaissement", "icon", "pi pi-plus", 3, "onClick"], [1, "flex", "justify-end"], [1, "pi", "pi-search"], ["pInputText", "", "type", "text", "placeholder", "Rechercher\u2026", 1, "w-full", "md:w-20rem", 3, "input"], ["pSortableColumn", "date_encaissement", 2, "min-width", "10rem"], ["field", "date_encaissement"], ["pSortableColumn", "montant", 2, "min-width", "10rem"], ["field", "montant"], [2, "min-width", "10rem"], [2, "min-width", "8rem"], [1, "text-sm"], [1, "font-semibold", "text-green-600"], [1, "surface-100", "px-2", "py-1", "border-round", "text-sm"], [1, "text-color-secondary", "text-sm"], ["colspan", "5", 1, "text-center", "py-8"], [1, "pi", "pi-inbox", "text-4xl", "mb-3", "block", 2, "opacity", ".25"], [1, "text-color-secondary", "m-0"], ["label", "Annuler", "severity", "secondary", 3, "onClick", "outlined", "disabled"], ["label", "Enregistrer", "icon", "pi pi-save", 3, "onClick", "loading"]], template: function EncaissementLivraisonListe_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(63, "N\xB0 facture livraison ");
      \u0275\u0275elementStart(64, "span", 30);
      \u0275\u0275text(65, "(optionnel)");
      \u0275\u0275elementEnd()();
      \u0275\u0275element(66, "p-inputNumber", 31);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(67, "div", 24)(68, "label", 25);
      \u0275\u0275text(69, "Notes ");
      ...
      \u0275\u0275elementEnd()()();
      \u0275\u0275template(73, EncaissementLivraisonListe_ng_template_73_Template, 2, 3, "ng-template", null, 8, \u0275\u0275templateRefExtractor);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      \u0275\u0275advance(11);
      ...
      \u0275\u0275advance(7);
      \u0275\u0275property("value", ctx.encaissements())("loading", ctx.loading)("paginator", true)("rows", 10)("rowsPerPageOptions", \u0275\u0275pureFunction0(22, _c05))("globalFilterFields", \u0275\u0275pureFunction0(23, _c15))("showCurrentPageReport", true);
      \u0275\u0275advance(12);
      \u0275\u0275styleMap(\u0275\u0275pureFunction0(24, _c24));
      \u0275\u0275twoWayProperty("visible", ctx.dialogVisible);
      \u0275\u0275property("modal", true)("draggable", false);
      \u0275\u0275advance();
      \u0275\u0275property("formGroup", ctx.createForm);
      \u0275\u0275advance(7);
      \u0275\u0275property("min", 1)("useGrouping", true)("ngClass", \u0275\u0275pureFunction1(25, _c34, ctx.isInvalid("montant")));
      \u0275\u0275advance();
...
<div class="flex flex-col gap-4">
  ...
  <div class="card">
    ...
    <p-table
      ...
      [rows]="10"
      [rowsPerPageOptions]="[10, 25, 50]"
      [globalFilterFields]="['mode_paiement', 'notes']"
      styleClass="p-datatable-gridlines"
      responsiveLayout="scroll"
      ...
      <ng-template #body let-e>
        <tr>
          ...
          <td class="text-color-secondary text-sm">
            @if (e.facture_livraison_id) {
              #{{ e.facture_livraison_id }}
            } @else { \u2014 }
          </td>
          <td class="text-color-secondary text-sm">{{ e.notes || '\u2014' }}</td>
        </tr>
      </ng-template>
...
>
  <form [formGroup]="createForm" novalidate>
    <div class="flex flex-col gap-4">
      ...
      <div class="flex flex-col gap-1">
        <label class="font-medium text-sm">N\xB0 facture livraison <span class="text-color-secondary">(optionnel)</span></label>
        <p-inputNumber
          formControlName="facture_livraison_id"
          [useGrouping]="false"
          placeholder="ID facture associ\xE9e"
          styleClass="w-full"
        />
      </div>
  ...
  <ng-template #footer>
    <p-button label="Annuler" severity="secondary" [outlined]="true" (onClick)="dialogVisible = false" [disabled]="saving" />
    <p-button label="Enregistrer" icon="pi pi-save" (onClick)="onSaveEncaissement()" [loading]="saving" />
  </ng-template>
</p-dialog>
` }]
...
var comptabilite_routes_default = [
  ...
  // ── Factures livraison ───────────────────────────────────────────────
  {
    ...
    canActivate: [authorizationGuard],
    data: { permissions: ["factures-livraisons.read"] }
  },
  {
  ...
  // ── Encaissements livraison ──────────────────────────────────────────
  {
    ...
    canActivate: [authorizationGuard],
    data: { permissions: ["encaissements.read"] }
  },
...
//# sourceMappingURL=chunk-GI3CFTKV.js.map
