...
function StatsWidget_Conditional_1_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275styleMap(\u0275\u0275pureFunction1(41, _c1, ctx_r0.strokeColor(ctx_r0.stats.prestataires.trend)));
    ...
    \u0275\u0275advance(3);
    \u0275\u0275styleMap(\u0275\u0275pureFunction1(43, _c1, ctx_r0.strokeColor(ctx_r0.stats.packings.trend)));
    ...
    \u0275\u0275advance(3);
    \u0275\u0275styleMap(\u0275\u0275pureFunction1(45, _c1, ctx_r0.strokeColor(ctx_r0.stats.utilisateurs.trend)));
    ...
    \u0275\u0275advance(3);
    \u0275\u0275styleMap(\u0275\u0275pureFunction1(47, _c1, ctx_r0.strokeColor(ctx_r0.stats.vehicules.trend)));
    ...
    \u0275\u0275advance(3);
    \u0275\u0275styleMap(\u0275\u0275pureFunction1(49, _c1, ctx_r0.strokeColor(ctx_r0.stats.rouleaux_stock.trend)));
...
var StatsWidget = class _StatsWidget {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _StatsWidget, selectors: [["app-stats-widget"]], hostVars: 2, hostBindings: function StatsWidget_HostBindings(rf, ctx) {
    ...
    if (rf & 1) {
      ...
      \u0275\u0275conditionalCreate(1, StatsWidget_Conditional_1_Template, 81, 51);
    }
    if (rf & 2) {
                ...
                <div class="card h-full">
                    ...
                    <div class="flex justify-between items-start">
                        <div class="w-6/12">
                            ...
                            <!-- delta masqu\xE9 : pas d'historique de stock fiable -->
                        </div>
                        <div class="w-6/12">
                            <svg width="100%" viewBox="0 0 258 96" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(StatsWidget, { className: "StatsWidget", filePath: "src/app/pages/dashboards/ecommerce/statswidget.ts", lineNumber: 165 });
})();
...
//# sourceMappingURL=chunk-UWSNMD3N.js.map
