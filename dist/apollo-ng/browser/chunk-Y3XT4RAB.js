...
var RevenueOverViewWidget = class _RevenueOverViewWidget {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _RevenueOverViewWidget, selectors: [["app-revenue-overview-widget"]], decls: 6, vars: 4, consts: [[1, "card", "h-full"], [1, "flex", "items-start", "justify-between", "mb-12"], [1, "text-surface-900", "dark:text-surface-0", "text-xl", "font-semibold"], ["optionLabel", "label", 1, "w-40", 3, "ngModelChange", "onChange", "options", "ngModel"], ["type", "bar", "height", "300", 3, "data", "options"]], template: function RevenueOverViewWidget_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "span", 2);
      \u0275\u0275text(3, "Statistiques v\xE9hicules");
      \u0275\u0275elementEnd();
      ...
      template: ` <div class="card h-full">
        <div class="flex items-start justify-between mb-12">
            <span
                ...
                >Statistiques v\xE9hicules</span
            >
            <p-select
                [options]="weeks"
...
var EcommerceDashboard = class _EcommerceDashboard {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EcommerceDashboard, selectors: [["app-ecommerce-dashboard"]], decls: 6, vars: 0, consts: [[1, "grid", "grid-cols-12", "gap-8"], [1, "col-span-12", "xl:col-span-9"], [1, "col-span-12", "xl:col-span-3"]], template: function EcommerceDashboard_Template(rf, ctx) {
    if (rf & 1) {
  ...
  }, dependencies: [StatsWidget, RevenueOverViewWidget, SalesByCategoryWidget], encapsulation: 2 });
};
(() => {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EcommerceDashboard, { className: "EcommerceDashboard", filePath: "src/app/pages/dashboards/ecommercedashboard.ts", lineNumber: 24 });
})();
export {
  EcommerceDashboard
};
//# sourceMappingURL=chunk-Y3XT4RAB.js.map
