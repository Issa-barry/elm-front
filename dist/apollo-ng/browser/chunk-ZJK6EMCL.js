...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(MailSidebarComponent, [{
    type: Component,
    args: [{
  ...
  }], () => [{ type: Router }, { type: MailService }], null);
})();
(() => {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(MailAppComponent, [{
    type: Component,
    args: [{
      standalone: true,
...
//# sourceMappingURL=chunk-ZJK6EMCL.js.map
