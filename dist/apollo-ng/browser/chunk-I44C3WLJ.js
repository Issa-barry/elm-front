...
import "./chunk-R425XDLV.js";
import {
  ParametresService
} from "./chunk-TSTSK3WE.js";
import {
  MoneyPipe
    ...
    <section class="mobile-search">
      <p-iconfield>
        ...
        <input
          ...
          placeholder="Prestataire, r\xE9f\xE9rence..."
          class="w-full"
        />
      </p-iconfield>
    </section>
    ...
    <section class="mobile-list" *ngIf="!loading && mobileVisiblePackings.length; else mobileListState">
      ...
      >
        ...
        <div class="mobile-card-body">
          ...
          <div class="mobile-card-meta">{{ formatDateDisplay(packing.date) }} \xB7 {{ packing.nb_rouleaux }} rouleaux</div>
...
<div class="card packing-desktop">
    ...
    <p-table
        ...
        [rowHover]="true"
        dataKey="id"
        currentPageReportTemplate="  {first} \xE0 {last} sur {totalRecords} packings"
    ...
    >
        ...
        <ng-template #header>
            <tr>
                ...
                <th><span class="col-header">T\xE9l\xE9phone</span></th>
            ...
            <tr>
                <td colspan="7">
                    <div class="empty-state">
                        ...
                        <span>Aucun packing trouv\xE9</span>
                    </div>
                </td>
            </tr>
        </ng-template>
...
<p-dialog
    ...
    [header]="packing?.id ? 'D\xE9tails du packing' : 'Nouveau packing'"
    [modal]="true"
    styleClass="packing-dialog"
    [breakpoints]="{ '960px': '95vw', '768px': '100vw', '480px': '100vw' }"
    [maximizable]="false"
>
...
<!-- Mobile slideover form (full screen, comme comptabilite-packing-paiement) -->
<div class="fixed inset-0 z-50" *ngIf="mobileFormVisible">
    <div class="absolute inset-0 bg-black/50 animate-fadein" (click)="closeMobileForm()"></div>
    <div class="packing-mobile-slideover bg-surface-0 dark:bg-surface-900 absolute top-0 right-0 shadow-xl w-full h-full animate-fadeinright">
        <app-packing-mobile-form
            [packing]="packing"
...
function PackingFrom_button_5_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 35);
    \u0275\u0275listener("click", function PackingFrom_button_5_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r1);
...
function PackingFrom_span_13_Template(rf, ctx) {
  if (rf & 1) {
...
function PackingFrom_ng_template_17_div_0_Template(rf, ctx) {
  if (rf & 1) {
...
function PackingFrom_ng_template_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, PackingFrom_ng_template_17_div_0_Template, 4, 2, "div", 42);
  }
  if (rf & 2) {
    const prestataire_r4 = ctx.$implicit;
    \u0275\u0275property("ngIf", prestataire_r4);
...
function PackingFrom_small_18_Template(rf, ctx) {
  if (rf & 1) {
...
function PackingFrom_span_22_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 37);
    \u0275\u0275text(1, "*");
    \u0275\u0275elementEnd();
...
function PackingFrom_small_24_Template(rf, ctx) {
  if (rf & 1) {
...
function PackingFrom_span_35_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span", 37);
    \u0275\u0275text(1, "*");
    \u0275\u0275elementEnd();
...
function PackingFrom_small_37_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "small", 37);
...
function PackingFrom_div_52_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "div", 54)(7, "div", 55)(8, "div", 56);
    \u0275\u0275element(9, "i", 57);
    \u0275\u0275elementStart(10, "div", 58)(11, "div", 29);
    ...
    \u0275\u0275element(18, "i", 61);
    \u0275\u0275elementStart(19, "div", 58)(20, "div", 29);
    \u0275\u0275text(21, "Date");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275pipe(24, "date");
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(25, "div", 55)(26, "div", 56);
    \u0275\u0275element(27, "i", 63);
    \u0275\u0275elementStart(28, "div", 58)(29, "div", 29);
    ...
    \u0275\u0275element(34, "i", 65);
    \u0275\u0275elementStart(35, "div", 58)(36, "div", 29);
    ...
    \u0275\u0275element(42, "i", 67);
    \u0275\u0275elementStart(43, "div", 58)(44, "div", 29);
...
function PackingFrom_div_53_span_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
...
function PackingFrom_div_53_span_4_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "span");
...
function PackingFrom_div_53_Template(rf, ctx) {
  if (rf & 1) {
    const _r5 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 69)(1, "button", 70);
    \u0275\u0275element(2, "i", 71);
    \u0275\u0275template(3, PackingFrom_div_53_span_3_Template, 2, 1, "span", 72)(4, PackingFrom_div_53_span_4_Template, 2, 0, "span", 72);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(5, "button", 73);
    \u0275\u0275listener("click", function PackingFrom_div_53_Template_button_click_5_listener() {
      \u0275\u0275restoreView(_r5);
      const ctx_r1 = \u0275\u0275nextContext();
...
var PackingFrom = class _PackingFrom {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _PackingFrom, selectors: [["app-packing-from"]], inputs: { mode: "mode", initialData: "initialData", prestataires: "prestataires", loading: "loading" }, outputs: { submitForm: "submitForm", cancel: "cancel" }, decls: 54, vars: 34, consts: [[1, "card"], [1, "contents", 3, "ngSubmit", "keydown.enter"], [1, "flex", "justify-between", "items-center", "mb-6"], [1, "text-surface-900", "dark:text-surface-0", "text-xl", "font-bold"], ["pButton", "", "pRipple", "", "severity", "warn", "class", "w-auto", 3, "click", 4, "ngIf"], [1, "grid", "grid-cols-12", "gap-4"], [1, "col-span-12", "lg:col-span-2"], [1, "col-span-12", "lg:col-span-10"], [1, "mb-6", "col-span-12"], ["for", "prestataire", 1, "font-medium", "text-surface-900", "dark:text-surface-0", "mb-2", "block"], ["class", "text-red-500", 4, "ngIf"], ["id", "prestataire", "optionLabel", "nom", "optionValue", "id", "placeholder", "S\xE9lectionnez un machiniste", "filterBy", "nom,prenom,phone", "fluid", "", 3, "ngModelChange", "ngModel", "options", "filter", "showClear", "disabled"], ["pTemplate", "item"], ["pTemplate", "selectedItem"], [1, "mb-6", "col-span-12", "md:col-span-6"], ["for", "date", 1, "font-medium", "text-surface-900", "dark:text-surface-0", "mb-2", "block"], ["id", "date", "dateFormat", "dd/mm/yy", "placeholder", "S\xE9lectionnez la date", "fluid", "", 3, "ngModelChange", "onSelect", "onBlur", "ngModel", "showIcon", "disabled"], ["class", "text-red-500 block mt-1", 4, "ngIf"], [1, "mb-6", "col-span-12", "grid", "grid-cols-12", "gap-3"], [1, "col-span-12", "md:col-span-6"], ["for", "nbRouleaux", 1, "font-medium", "text-surface-900", "dark:text-surface-0", "mb-2", "block"], ["id", "nbRouleaux", "placeholder", "Entrez le nombre", "mode", "decimal", "fluid", "", 3, "ngModelChange", "ngModel", "showButtons", "min", "max", "useGrouping", "disabled"], ["for", "prixRouleau", 1, "font-medium", "text-surface-900", "dark:text-surface-0", "mb-2", "block"], ["id", "prixRouleau", "mode", "currency", "currency", "GNF", "locale", "fr-GN", "placeholder", "Prix par rouleau", "fluid", "", 3, "ngModelChange", "ngModel", "min", "disabled"], [1, "bg-gradient-to-r", "from-primary/10", "to-primary/5", "border-l-4", "border-primary", "rounded-lg", "p-4"], [1, "flex", "items-center", "justify-between"], [1, "flex", "items-center", "gap-3"], [1, "w-12", "h-12", "rounded-full", "bg-primary/20", "flex", "items-center", "justify-center"], [1, "pi", "pi-money-bill", "text-primary", "text-xl"], [1, "text-xs", "text-surface-600", "dark:text-surface-400", "mb-1"], [1, "text-3xl", "font-bold", "text-primary"], ["class", "text-sm text-surface-600 dark:text-surface-300 mt-3 flex items-center gap-2", 4, "ngIf"], ["class", "text-sm text-surface-500 dark:text-surface-400 mt-3 italic", 4, "ngIf"], ["class", "col-span-12 mb-6", 4, "ngIf"], ["class", "col-span-12 flex gap-2 mb-4", 4, "ngIf"], ["pButton", "", "pRipple", "", "severity", "warn", 1, "w-auto", 3, "click"], [1, "pi", "pi-pencil", "mr-2"], [1, "text-red-500"], [1, "flex", "items-center", "justify-center", "w-10", "h-10", "rounded-full", "bg-primary/10"], [1, "pi", "pi-user", "text-primary"], [1, "font-medium"], [1, "text-sm", "text-surface-500"], ["class", "flex items-center gap-2", 4, "ngIf"], [1, "flex", "items-center", "gap-2"], [1, "text-red-500", "block", "mt-1"], [1, "text-sm", "text-surface-600", "dark:text-surface-300", "mt-3", "flex", "items-center", "gap-2"], [1, "pi", "pi-calculator", "text-surface-500"], [1, "text-sm", "text-surface-500", "dark:text-surface-400", "mt-3", "italic"], [1, "pi", "pi-info-circle", "mr-2"], [1, "col-span-12", "mb-6"], [1, "bg-blue-50", "dark:bg-blue-900/20", "border", "border-blue-200", "dark:border-blue-800", "rounded-lg", "p-5"], [1, "flex", "items-center", "gap-2", "mb-4"], [1, "pi", "pi-info-circle", "text-blue-600", "dark:text-blue-400", "text-lg"], [1, "font-bold", "text-blue-900", "dark:text-blue-100", "text-lg"], [1, "grid", "grid-cols-1", "md:grid-cols-2", "gap-4"], [1, "space-y-3"], [1, "flex", "items-start", "gap-3"], [1, "pi", "pi-user", "text-blue-600", "mt-1"], [1, "flex-1"], [1, "font-semibold", "text-surface-900", "dark:text-surface-0"], [1, "text-sm", "text-surface-500", "dark:text-surface-400"], [1, "pi", "pi-calendar", "text-blue-600", "mt-1"], [1, "font-medium", "text-surface-900", "dark:text-surface-0"], [1, "pi", "pi-box", "text-blue-600", "mt-1"], [1, "font-bold", "text-primary", "text-xl"], [1, "pi", "pi-tag", "text-blue-600", "mt-1"], [1, "flex", "items-start", "gap-3", "pt-3", "border-t", "border-blue-200", "dark:border-blue-700"], [1, "pi", "pi-wallet", "text-blue-600", "mt-1"], [1, "font-bold", "text-primary", "text-2xl"], [1, "col-span-12", "flex", "gap-2", "mb-4"], ["type", "submit", "pButton", "", "pRipple", "", 1, "w-auto", 3, "disabled"], [1, "pi", 3, "ngClass"], [4, "ngIf"], ["pButton", "", "pRipple", "", "severity", "secondary", 1, "w-auto", 3, "click", "disabled"], [1, "pi", "pi-times", "mr-2"]], template: function PackingFrom_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275listener("ngSubmit", function PackingFrom_Template_form_ngSubmit_1_listener() {
        return ctx.onSubmit();
      })("keydown.enter", function PackingFrom_Template_form_keydown_enter_1_listener($event) {
        return ctx.onEnterKey($event);
      });
      \u0275\u0275elementStart(2, "div", 2)(3, "span", 3);
      \u0275\u0275text(4);
      \u0275\u0275elementEnd();
      \u0275\u0275template(5, PackingFrom_button_5_Template, 3, 0, "button", 4);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(6, "div", 5);
      \u0275\u0275element(7, "div", 6);
      \u0275\u0275elementStart(8, "div", 7)(9, "div", 5)(10, "div", 8)(11, "label", 9);
      \u0275\u0275text(12, " Prestataire ");
      \u0275\u0275template(13, PackingFrom_span_13_Template, 2, 0, "span", 10);
      \u0275\u0275text(14, " (Machiniste) ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(15, "p-select", 11);
      \u0275\u0275twoWayListener("ngModelChange", function PackingFrom_Template_p_select_ngModelChange_15_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.model.prestataire_id, $event) || (ctx.model.prestataire_id = $event);
        return $event;
      });
      \u0275\u0275template(16, PackingFrom_ng_template_16_Template, 8, 3, "ng-template", 12)(17, PackingFrom_ng_template_17_Template, 1, 1, "ng-template", 13);
      \u0275\u0275elementEnd();
      \u0275\u0275template(18, PackingFrom_small_18_Template, 2, 0, "small", 10);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(19, "div", 14)(20, "label", 15);
      \u0275\u0275text(21, " Date ");
      \u0275\u0275template(22, PackingFrom_span_22_Template, 2, 0, "span", 10);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(23, "p-datepicker", 16);
      \u0275\u0275twoWayListener("ngModelChange", function PackingFrom_Template_p_datepicker_ngModelChange_23_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.model.date, $event) || (ctx.model.date = $event);
        return $event;
      });
      \u0275\u0275listener("onSelect", function PackingFrom_Template_p_datepicker_onSelect_23_listener() {
        return ctx.onDateChange();
      })("onBlur", function PackingFrom_Template_p_datepicker_onBlur_23_listener() {
        return ctx.onDateBlur();
      });
      \u0275\u0275elementEnd();
      \u0275\u0275template(24, PackingFrom_small_24_Template, 2, 1, "small", 17);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(25, "div", 18)(26, "div", 19)(27, "label", 20);
      \u0275\u0275text(28, " Nombre de rouleaux ");
      \u0275\u0275template(29, PackingFrom_span_29_Template, 2, 0, "span", 10);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(30, "p-inputnumber", 21);
      \u0275\u0275twoWayListener("ngModelChange", function PackingFrom_Template_p_inputnumber_ngModelChange_30_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.model.nb_rouleaux, $event) || (ctx.model.nb_rouleaux = $event);
        return $event;
      });
      \u0275\u0275listener("ngModelChange", function PackingFrom_Template_p_inputnumber_ngModelChange_30_listener() {
        return ctx.onPrixOrQuantityChange();
      });
      \u0275\u0275elementEnd();
      \u0275\u0275template(31, PackingFrom_small_31_Template, 2, 0, "small", 10);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(32, "div", 19)(33, "label", 22);
      \u0275\u0275text(34, " Prix unitaire (GNF) ");
      \u0275\u0275template(35, PackingFrom_span_35_Template, 2, 0, "span", 10);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(36, "p-inputnumber", 23);
      \u0275\u0275twoWayListener("ngModelChange", function PackingFrom_Template_p_inputnumber_ngModelChange_36_listener($event) {
        \u0275\u0275twoWayBindingSet(ctx.model.prix_par_rouleau, $event) || (ctx.model.prix_par_rouleau = $event);
        return $event;
      });
      \u0275\u0275listener("ngModelChange", function PackingFrom_Template_p_inputnumber_ngModelChange_36_listener() {
        return ctx.onPrixOrQuantityChange();
      });
      \u0275\u0275elementEnd();
      \u0275\u0275template(37, PackingFrom_small_37_Template, 2, 0, "small", 10);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(38, "div", 8)(39, "div", 24)(40, "div", 25)(41, "div", 26)(42, "div", 27);
      \u0275\u0275element(43, "i", 28);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(44, "div")(45, "div", 29);
      \u0275\u0275text(46, " Montant total ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(47, "div", 30);
      \u0275\u0275text(48);
      \u0275\u0275pipe(49, "money");
      \u0275\u0275elementEnd()()()();
      \u0275\u0275template(50, PackingFrom_div_50_Template, 4, 5, "div", 31)(51, PackingFrom_div_51_Template, 3, 0, "div", 32);
      \u0275\u0275elementEnd()();
      \u0275\u0275template(52, PackingFrom_div_52_Template, 49, 16, "div", 33)(53, PackingFrom_div_53_Template, 8, 7, "div", 34);
      \u0275\u0275elementEnd()()()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(4);
      ...
      \u0275\u0275advance(11);
      \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(49, 32, ctx.model.montant), " ");
      \u0275\u0275advance(2);
...
(() => {
  ...
  <form (ngSubmit)="onSubmit()" (keydown.enter)="onEnterKey($event)" class="contents">\r
...
//# sourceMappingURL=chunk-I44C3WLJ.js.map
