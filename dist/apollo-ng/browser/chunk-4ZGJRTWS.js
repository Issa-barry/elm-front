...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(OrderSummary, [{
    type: Component,
    args: [{
      ...
      template: `
        <div class="card">
            ...
            <div class="text-surface-900 dark:text-surface-0 font-bold text-4xl my-2">Successful Order \u{1F680}</div>
...
//# sourceMappingURL=chunk-4ZGJRTWS.js.map
