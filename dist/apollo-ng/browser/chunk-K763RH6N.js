import {
  OrganisationService
} from "./chunk-XHJJ2YWS.js";
import {
  authorizationGuard
} from "./chunk-FJO2OT2O.js";
import "./chunk-JKMJDVN5.js";
...
function BillingEvents_ng_template_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(6, "td");
    \u0275\u0275template(7, BillingEvents_ng_template_13_ng_container_7_Template, 3, 2, "ng-container", 22)(8, BillingEvents_ng_template_13_ng_template_8_Template, 2, 0, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(10, "td");
    \u0275\u0275text(11);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(12, "td")(13, "code", 23);
    \u0275\u0275text(14);
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275template(24, BillingEvents_ng_template_13_button_24_Template, 1, 2, "button", 25);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx_r1.formatGNF(event_r1.amount));
    \u0275\u0275advance(2);
...
var BillingEvents = class _BillingEvents {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BillingEvents, selectors: [["app-billing-events"]], decls: 31, vars: 20, consts: [["noForfait", ""], [1, "card"], [1, "flex", "align-items-center", "justify-content-between", "mb-4", "gap-3", "flex-wrap"], [1, "m-0", "text-2xl", "font-semibold"], [1, "m-0", "text-color-secondary"], [1, "flex", "gap-3", "mb-4", "flex-wrap"], ["optionLabel", "label", "optionValue", "value", "placeholder", "Toutes les organisations", 3, "ngModelChange", "onChange", "options", "ngModel"], ["optionLabel", "label", "optionValue", "value", "placeholder", "Tous les statuts", 3, "ngModelChange", "onChange", "options", "ngModel"], ["optionLabel", "label", "optionValue", "value", "placeholder", "Tous les forfaits", 3, "ngModelChange", "onChange", "options", "ngModel"], ["dataKey", "id", "responsiveLayout", "scroll", 3, "value", "loading"], ["pTemplate", "header"], ["pTemplate", "body"], ["pTemplate", "emptymessage"], [1, "flex", "gap-4", "mt-4", "pt-4", "border-top-1", "surface-border", "flex-wrap"], [1, "flex", "align-items-center", "gap-2"], [1, "text-color-secondary"], [1, "font-bold"], [1, "font-bold", "text-orange-500"], [1, "font-bold", "text-green-500"], [1, "text-right"], [1, "font-semibold"], [1, "text-color-secondary", "text-sm", "ml-1"], [4, "ngIf", "ngIfElse"], [1, "text-sm"], [3, "value", "severity"], ["pButton", "", "type", "button", "label", "Marquer pay\xE9", "icon", "pi pi-check", "class", "p-button-success p-button-sm p-button-outlined", 3, "loading", "disabled", "click", 4, "ngIf"], [1, "border-round", "px-2", "text-xs", "font-semibold", "white-space-nowrap", 2, "padding-top", "3px", "padding-bottom", "3px", 3, "ngClass"], ["pButton", "", "type", "button", "label", "Marquer pay\xE9", "icon", "pi pi-check", 1, "p-button-success", "p-button-sm", "p-button-outlined", 3, "click", "loading", "disabled"], ["colspan", "9", 1, "text-center", "text-color-secondary", "py-5"]], template: function BillingEvents_Template(rf, ctx) {
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance(9);
      \u0275\u0275textInterpolate(ctx.formatGNF(ctx.totalAmount));
      \u0275\u0275advance(5);
      \u0275\u0275textInterpolate(ctx.formatGNF(ctx.totalPending));
      \u0275\u0275advance(5);
      \u0275\u0275textInterpolate(ctx.formatGNF(ctx.totalPaid));
    }
...
(() => {
  ...
  <p-table [value]="events" [loading]="loading" dataKey="id" responsiveLayout="scroll">
    ...
    <ng-template pTemplate="body" let-event>
      <tr>
        ...
        <td class="font-semibold">{{ formatGNF(event.amount) }}</td>
        <td>
          <p-tag
  ...
  <div class="flex gap-4 mt-4 pt-4 border-top-1 surface-border flex-wrap">
    <div class="flex align-items-center gap-2">
      ...
      <span class="font-bold">{{ formatGNF(totalAmount) }}</span>
    </div>
    <div class="flex align-items-center gap-2">
      <span class="text-color-secondary">En attente :</span>
      <span class="font-bold text-orange-500">{{ formatGNF(totalPending) }}</span>
    </div>
    <div class="flex align-items-center gap-2">
      <span class="text-color-secondary">Pay\xE9 :</span>
      <span class="font-bold text-green-500">{{ formatGNF(totalPaid) }}</span>
    </div>
  </div>
</div>
` }]
...
//# sourceMappingURL=chunk-K763RH6N.js.map
