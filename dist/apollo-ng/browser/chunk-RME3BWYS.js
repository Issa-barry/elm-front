...
function ParametresListe_Conditional_21_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "li", 7)(1, "a", 8);
    \u0275\u0275listener("click", function ParametresListe_Conditional_21_Template_a_click_1_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onSectionClick($event, "packing"));
    });
    \u0275\u0275element(2, "i", 13);
    ...
    \u0275\u0275listener("click", function ParametresListe_Conditional_21_Template_a_click_6_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onSectionClick($event, "roles"));
    });
    \u0275\u0275element(7, "i", 14);
    \u0275\u0275elementStart(8, "span");
    \u0275\u0275text(9, "R\xF4les & Permissions");
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(10, "li", 7)(11, "a", 8);
    \u0275\u0275listener("click", function ParametresListe_Conditional_21_Template_a_click_11_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onSectionClick($event, "notifications"));
    });
    \u0275\u0275element(12, "i", 15);
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275property("ngClass", ctx_r1.isActive("packing") ? "border-l-2 border-primary" : "border-l-2 border-surface-200 dark:border-surface-700");
    \u0275\u0275advance();
    \u0275\u0275property("ngClass", ctx_r1.isActive("packing") ? "text-primary" : "text-surface-700 dark:text-surface-200");
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ctx_r1.isActive("roles") ? "border-l-2 border-primary" : "border-l-2 border-surface-200 dark:border-surface-700");
    \u0275\u0275advance();
    \u0275\u0275property("ngClass", ctx_r1.isActive("roles") ? "text-primary" : "text-surface-700 dark:text-surface-200");
    \u0275\u0275advance(4);
    \u0275\u0275property("ngClass", ctx_r1.isActive("notifications") ? "border-l-2 border-primary" : "border-l-2 border-surface-200 dark:border-surface-700");
    \u0275\u0275advance();
    \u0275\u0275property("ngClass", ctx_r1.isActive("notifications") ? "text-primary" : "text-surface-700 dark:text-surface-200");
  }
}
function ParametresListe_app_parametres_profile_23_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-parametres-profile");
  }
}
function ParametresListe_app_parametres_auth_24_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-parametres-auth");
  }
}
function ParametresListe_Conditional_25_app_parametres_packing_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-parametres-packing");
  }
}
function ParametresListe_Conditional_25_app_parametres_roles_permissions_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-parametres-roles-permissions");
  }
}
function ParametresListe_Conditional_25_app_parametres_notifications_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-parametres-notifications");
  }
}
function ParametresListe_Conditional_25_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275template(0, ParametresListe_Conditional_25_app_parametres_packing_0_Template, 1, 0, "app-parametres-packing", 12)(1, ParametresListe_Conditional_25_app_parametres_roles_permissions_1_Template, 1, 0, "app-parametres-roles-permissions", 12)(2, ParametresListe_Conditional_25_app_parametres_notifications_2_Template, 1, 0, "app-parametres-notifications", 12);
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275property("ngIf", ctx_r1.isActive("packing"));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.isActive("roles"));
    \u0275\u0275advance();
    \u0275\u0275property("ngIf", ctx_r1.isActive("notifications"));
  }
}
...
var ParametresListe = class _ParametresListe {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ParametresListe, selectors: [["app-parametres-liste"]], features: [\u0275\u0275ProvidersFeature([MessageService])], decls: 26, vars: 8, consts: [[1, "rounded-t-3xl", "bg-surface-0", "dark:bg-surface-900", "flex-auto", "py-6", "lg:py-8", "px-8", "lg:px-20"], [1, "flex", "flex-col", "w-full", "pb-8", "gap-2"], [1, "mt-0", "text-surface-900", "dark:text-surface-0", "font-medium", "text-2xl", "leading-tight"], [1, "mt-0", "text-surface-500", "dark:text-surface-300", "leading-tight"], [1, "grid", "grid-cols-12", "gap-4", "py-6", "lg:py-8"], [1, "col-span-12", "lg:col-span-2"], [1, "list-none", "m-0", "p-0", "hidden", "lg:flex", "flex-col", "justify-start"], [1, "-ml-[2px]", 3, "ngClass"], ["href", "#", 1, "w-full", "text-left", "flex", "items-center", "py-3", "px-4", "font-medium", "transition-colors", "hover:text-primary", 3, "click", "ngClass"], [1, "pi", "pi-user", "mr-2", "text-base!", "leading-normal!"], [1, "pi", "pi-lock", "mr-2", "text-base!", "leading-normal!"], [1, "col-span-12", "lg:col-span-10", "xl:col-span-10", "bg-surface-0", "dark:bg-surface-900", "p-8", "rounded-2xl", "flex-auto"], [4, "ngIf"], [1, "pi", "pi-cog", "mr-2", "text-base!", "leading-normal!"], [1, "pi", "pi-shield", "mr-2", "text-base!", "leading-normal!"], [1, "pi", "pi-bell", "mr-2", "text-base!", "leading-normal!"]], template: function ParametresListe_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275element(0, "p-toast");
      ...
      \u0275\u0275elementEnd()()();
      \u0275\u0275conditionalCreate(21, ParametresListe_Conditional_21_Template, 15, 6);
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(22, "div", 11);
      \u0275\u0275template(23, ParametresListe_app_parametres_profile_23_Template, 1, 0, "app-parametres-profile", 12)(24, ParametresListe_app_parametres_auth_24_Template, 1, 0, "app-parametres-auth", 12);
      \u0275\u0275conditionalCreate(25, ParametresListe_Conditional_25_Template, 3, 3);
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(11);
      ...
      \u0275\u0275advance(4);
      \u0275\u0275conditional(ctx.isAdmin() ? 21 : -1);
      \u0275\u0275advance(2);
      \u0275\u0275property("ngIf", ctx.isActive("profile"));
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", ctx.isActive("auth"));
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.isAdmin() ? 25 : -1);
    }
  }, dependencies: [CommonModule, NgClass, NgIf, ParametresAuth, DividerModule, Divider, ToastModule, Toast, RouterModule, ParametresPacking, ParametresProfile, ParametresRolesPermissions, ParametresNotifications], encapsulation: 2 });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ParametresListe, [{
    type: Component,
    args: [{ selector: "app-parametres-liste", standalone: true, imports: [CommonModule, ParametresAuth, DividerModule, ToastModule, RouterModule, ParametresPacking, ParametresProfile, ParametresRolesPermissions, ParametresNotifications], providers: [MessageService], template: `<p-toast></p-toast>\r
\r
  ...
  <div class="grid grid-cols-12 gap-4 py-6 lg:py-8">\r
    <div class="col-span-12 lg:col-span-2">\r
      <ul class="list-none m-0 p-0 hidden lg:flex flex-col justify-start">\r
        ...
        @if (isAdmin()) {\r
          ...
          <li class="-ml-[2px]" [ngClass]="isActive('notifications') ? 'border-l-2 border-primary' : 'border-l-2 border-surface-200 dark:border-surface-700'">\r
            <a\r
              href="#"\r
              class="w-full text-left flex items-center py-3 px-4 font-medium transition-colors hover:text-primary"\r
              [ngClass]="isActive('notifications') ? 'text-primary' : 'text-surface-700 dark:text-surface-200'"\r
              (click)="onSectionClick($event, 'notifications')"\r
            >\r
              <i class="pi pi-bell mr-2 text-base! leading-normal!"></i>\r
    ...
    <div class="col-span-12 lg:col-span-10 xl:col-span-10 bg-surface-0 dark:bg-surface-900 p-8 rounded-2xl flex-auto">\r
      ...
      @if (isAdmin()) {\r
        ...
        <app-parametres-notifications *ngIf="isActive('notifications')"></app-parametres-notifications>\r
      }\r
    </div>\r
  </div>\r
</div>\r
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ParametresListe, { className: "ParametresListe", filePath: "src/app/pages/parametres/parametres-liste/parametres-liste.ts", lineNumber: 26 });
})();
...
//# sourceMappingURL=chunk-RME3BWYS.js.map
