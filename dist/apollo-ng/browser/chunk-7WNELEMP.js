...
function ParametresListe_app_parametres_profile_37_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-parametres-profile");
  }
}
function ParametresListe_app_parametres_auth_38_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-parametres-auth");
  }
}
function ParametresListe_app_parametres_packing_39_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-parametres-packing");
  }
}
function ParametresListe_app_parametres_roles_permissions_40_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-parametres-roles-permissions");
  }
}
function ParametresListe_app_parametres_notifications_41_Template(rf, ctx) {
  if (rf & 1) {
...
var ParametresListe = class _ParametresListe {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ParametresListe, selectors: [["app-parametres-liste"]], features: [\u0275\u0275ProvidersFeature([MessageService])], decls: 42, vars: 15, consts: [[1, "rounded-t-3xl", "bg-surface-0", "dark:bg-surface-900", "flex-auto", "py-6", "lg:py-8", "px-8", "lg:px-20"], [1, "flex", "flex-col", "w-full", "pb-8", "gap-2"], [1, "mt-0", "text-surface-900", "dark:text-surface-0", "font-medium", "text-2xl", "leading-tight"], [1, "mt-0", "text-surface-500", "dark:text-surface-300", "leading-tight"], [1, "grid", "grid-cols-12", "gap-4", "py-6", "lg:py-8"], [1, "col-span-12", "lg:col-span-2"], [1, "list-none", "m-0", "p-0", "hidden", "lg:flex", "flex-col", "justify-start"], [1, "-ml-[2px]", 3, "ngClass"], ["href", "#", 1, "w-full", "text-left", "flex", "items-center", "py-3", "px-4", "font-medium", "transition-colors", "hover:text-primary", 3, "click", "ngClass"], [1, "pi", "pi-user", "mr-2", "text-base!", "leading-normal!"], [1, "pi", "pi-lock", "mr-2", "text-base!", "leading-normal!"], [1, "pi", "pi-cog", "mr-2", "text-base!", "leading-normal!"], [1, "pi", "pi-shield", "mr-2", "text-base!", "leading-normal!"], [1, "pi", "pi-bell", "mr-2", "text-base!", "leading-normal!"], [1, "col-span-12", "lg:col-span-10", "xl:col-span-10", "bg-surface-0", "dark:bg-surface-900", "p-8", "rounded-2xl", "flex-auto"], [4, "ngIf"]], template: function ParametresListe_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(31, "li", 7)(32, "a", 8);
      \u0275\u0275listener("click", function ParametresListe_Template_a_click_32_listener($event) {
        return ctx.onSectionClick($event, "notifications");
      });
      \u0275\u0275element(33, "i", 13);
      \u0275\u0275elementStart(34, "span");
      \u0275\u0275text(35, "Notifications");
      \u0275\u0275elementEnd()()()()();
      \u0275\u0275elementStart(36, "div", 14);
      \u0275\u0275template(37, ParametresListe_app_parametres_profile_37_Template, 1, 0, "app-parametres-profile", 15)(38, ParametresListe_app_parametres_auth_38_Template, 1, 0, "app-parametres-auth", 15)(39, ParametresListe_app_parametres_packing_39_Template, 1, 0, "app-parametres-packing", 15)(40, ParametresListe_app_parametres_roles_permissions_40_Template, 1, 0, "app-parametres-roles-permissions", 15)(41, ParametresListe_app_parametres_notifications_41_Template, 1, 0, "app-parametres-notifications", 15);
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(11);
      ...
      \u0275\u0275advance(4);
      \u0275\u0275property("ngClass", ctx.isActive("notifications") ? "border-l-2 border-primary" : "border-l-2 border-surface-200 dark:border-surface-700");
      \u0275\u0275advance();
      \u0275\u0275property("ngClass", ctx.isActive("notifications") ? "text-primary" : "text-surface-700 dark:text-surface-200");
      \u0275\u0275advance(5);
      ...
      \u0275\u0275advance();
      \u0275\u0275property("ngIf", ctx.isActive("notifications"));
    }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ParametresListe, { className: "ParametresListe", filePath: "src/app/pages/parametres/parametres-liste/parametres-liste.ts", lineNumber: 23 });
})();
...
//# sourceMappingURL=chunk-7WNELEMP.js.map
