...
function ProductOverview_img_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r2 = \u0275\u0275nextContext();
    \u0275\u0275property("src", \u0275\u0275interpolate1("/demo/images/ecommerce/productoverview/", image_r4), \u0275\u0275sanitizeUrl)("ngClass", \u0275\u0275pureFunction1(3, _c2, ctx_r2.selectedImageIndex === i_r2));
  }
}
var ProductOverview = class _ProductOverview {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ProductOverview, selectors: [["app-product-overview"]], decls: 178, vars: 31, consts: [[1, "card"], [1, "grid", "grid-cols-12", "gap-4", "mb-16"], [1, "col-span-12", "lg:col-span-7"], [1, "flex"], [1, "flex", "flex-col", "w-2/12", "justify-between", 2, "row-gap", "1rem"], ["class", "w-full cursor-pointer border-2 border-transparent transition-colors duration-150 border-round", 3, "ngClass", "src", "click", 4, "ngFor", "ngForOf"], [1, "pl-4", "w-10/12", "flex"], [1, "w-full", "border-2", "border-transparent", "rounded", 3, "src"], [1, "col-span-12", "lg:col-span-4", "py-4", "lg:pl-12"], [1, "flex", "items-center", "text-xl", "font-medium", "text-surface-900", "dark:text-surface-0", "mb-6"], [1, "flex", "flex-wrap", "items-center", "justify-between", "mb-8"], [1, "text-surface-900", "dark:text-surface-0", "font-medium", "text-3xl", "block"], [1, "flex", "items-center"], [1, "mr-4", "shrink-0"], [1, "pi", "pi-star-fill", "text-yellow-500", "mr-1"], [1, "pi", "pi-star", "text-surface-600", "dark:text-surface-200", "mr-1"], [1, "text-sm"], [1, "text-surface-900", "dark:text-surface-0", "mr-1"], [1, "text-surface-500", "dark:text-surface-300"], [1, "font-bold", "text-surface-900", "dark:text-surface-0", "mb-4"], [1, "flex", "items-center", "mb-8"], [1, "w-8", "h-8", "shrink-0", "rounded-full", "bg-slate-500", "mr-4", "cursor-pointer", "border-2", "border-surface-200", "dark:border-surface-700", "transition-all", "duration-300", 3, "click"], [1, "w-8", "h-8", "shrink-0", "rounded-full", "bg-green-500", "mr-4", "cursor-pointer", "border-2", "border-surface-200", "dark:border-surface-700", "transition-all", "duration-300", 3, "click"], [1, "w-8", "h-8", "shrink-0", "rounded-full", "bg-blue-500", "cursor-pointer", "border-2", "border-surface-200", "dark:border-surface-700", "transition-all", "duration-300", 3, "click"], [1, "mb-4", "flex", "items-center", "justify-between"], [1, "font-bold", "text-surface-900", "dark:text-surface-0"], ["tabindex", "0", 1, "cursor-pointer", "text-surface-600", "dark:text-surface-200", "text-sm", "flex", "items-center"], [1, "ml-1", "pi", "pi-angle-right"], [1, "flex", "flex-wrap", "gap-4", "items-center", "mb-8"], [1, "h-12", "w-12", "border", "border-surface-300", "dark:border-surface-500", "text-surface-900", "dark:text-surface-0", "inline-flex", "justify-center", "items-center", "shrink-0", "rounded", "mr-4", "cursor-pointer", "hover:bg-surface-100", "dark:hover:bg-surface-700", "duration-150", "transition-colors", 3, "click", "ngClass"], [1, "h-12", "w-12", "border", "border-surface-300", "dark:border-surface-500", "text-surface-900", "dark:text-surface-0", "inline-flex", "justify-center", "items-center", "shrink-0", "rounded", "cursor-pointer", "hover:bg-surface-100", "dark:hover:bg-surface-700", "duration-150", "transition-colors", 3, "click", "ngClass"], [1, "flex", "flex-col", "sm:flex-row", "items-start", "sm:items-center", "flex-wrap", "gap-4"], ["buttonLayout", "horizontal", "inputStyleClass", "w-12 text-center py-2 px-1 border-transparent outline-0 shadow-none", "styleClass", "border border-surface-200 dark:border-surface-700 rounded", "decrementButtonClass", "p-button-text text-surface-600 dark:text-surface-200 hover:text-primary py-1 px-1", "incrementButtonClass", "p-button-text text-surface-600 dark:text-surface-200 hover:text-primary py-1 px-1", "incrementButtonIcon", "pi pi-plus", "decrementButtonIcon", "pi pi-minus", 3, "ngModelChange", "showButtons", "min", "ngModel"], [1, "flex", "items-center", "flex-0", "lg:flex-1", "gap-4"], ["pButton", "", "pRipple", "", "label", "Add to Cart", 1, "shrink-0", "w-full"], [1, "pi", "text-2xl", "cursor-pointer", 3, "click", "ngClass"], ["value", "0"], ["value", "1"], ["value", "2"], [1, "text-surface-900", "dark:text-surface-0", "font-bold", "text-3xl", "mb-6", "mt-2"], [1, "leading-normal", "text-surface-600", "dark:text-surface-200", "p-0", "mx-0", "mt-0", "mb-6"], [1, "grid", "grid-cols-12", "gap-4"], [1, "col-span-12", "lg:col-span-4"], [1, "text-surface-900", "dark:text-surface-0", "block", "mb-4", "font-bold"], [1, "py-0", "pl-4", "m-0", "text-surface-600", "dark:text-surface-200", "mb-4"], [1, "mb-2"], [1, "list-none", "p-0", "m-0", "text-surface-600", "dark:text-surface-200", "mb-6"], [1, "mb-4"], [1, "font-semibold"], [1, "p-0", "m-0", "flex", "flex-wrap", "flex-col", "xl:flex-row", "text-surface-600", "dark:text-surface-200"], [1, "flex", "items-center", "whitespace-nowrap", "w-40", "mr-2", "mb-4"], [1, "pi", "pi-sun", "mr-2", "text-surface-900", "dark:text-surface-0"], [1, "flex", "items-center", "whitespace-nowrap", "w-40", "mb-4"], [1, "pi", "pi-times-circle", "mr-2", "text-surface-900", "dark:text-surface-0"], [1, "flex", "items-center", "whitespace-nowrap", "w-40", "mb-4", "mr-2"], [1, "pi", "pi-sliders-h", "mr-2", "text-surface-900", "dark:text-surface-0"], [1, "pi", "pi-minus-circle", "mr-2", "text-surface-900", "dark:text-surface-0"], [1, "list-none", "p-0", "m-0"], [1, "pb-8", "border-b", "border-surface-200", "dark:border-surface-700"], [1, "pi", "pi-star-fill", "text-gray-500"], [1, "text-surface-900", "dark:text-surface-0", "font-bold", "text-xl", "my-4"], [1, "mx-0", "mt-0", "mb-4", "text-surface-600", "dark:text-surface-200", "leading-normal"], [1, "font-medium"], [1, "py-8", "border-b", "border-surface-200", "dark:border-surface-700"], [1, "pi", "pi-star-fill", "text-yellow-500"], [1, "col-span-12", "md:col-span-6"], [1, "text-surface-900", "dark:text-surface-0", "block", "font-bold", "mb-4"], [1, "leading-normal", "text-surface-600", "dark:text-surface-200", "p-0", "m-0"], [1, "w-full", "cursor-pointer", "border-2", "border-transparent", "transition-colors", "duration-150", "border-round", 3, "click", "ngClass", "src"]], template: function ProductOverview_Template(rf, ctx) {
    if (rf & 1) {
    ...
    if (rf & 2) {
      ...
      \u0275\u0275advance(2);
      \u0275\u0275property("src", \u0275\u0275interpolate1("/demo/images/ecommerce/productoverview/", ctx.images[ctx.selectedImageIndex]), \u0275\u0275sanitizeUrl);
      \u0275\u0275advance(22);
      \u0275\u0275styleProp("box-shadow", ctx.color === "bluegray" ? "0 0 0 0.2rem var(--p-gray-500)" : null);
      \u0275\u0275advance();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ProductOverview, [{
    type: Component,
    args: [{
...
//# sourceMappingURL=chunk-RJECTWPU.js.map
