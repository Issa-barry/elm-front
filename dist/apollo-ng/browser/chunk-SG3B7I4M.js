...
var ventes_routes_default = [
  ...
  {
    path: "commandes/:id",
    loadComponent: () => import("./chunk-UTR5DPFC.js").then((c) => c.CommandeVenteDetail2),
    data: { breadcrumb: "commandes" }
  },
  {
  ...
  },
  {
    ...
    loadComponent: () => import("./chunk-7YMGE2QA.js").then((c) => c.FactureVenteDetail2),
    data: { breadcrumb: "factures-vente-detail2" }
  },
  {
    path: "factures-vente-detail3/:id",
    loadComponent: () => import("./chunk-4BHCFER4.js").then((c) => c.FactureVenteDetail3),
    data: { breadcrumb: "factures-vente-detail3" }
  },
  {
    path: "factures-vente-detail4/:id",
    loadComponent: () => import("./chunk-FPYAJCIX.js").then((c) => c.FactureVenteDetail4),
    data: { breadcrumb: "factures-vente-detail2" }
  },
  {
    path: "factures-vente",
    loadComponent: () => import("./chunk-TC35G3IX.js").then((c) => c.FactureVenteListe),
  ...
  {
    path: "factures/:id",
    loadComponent: () => import("./chunk-OJHZLZN7.js").then((c) => c.FactureVenteDetail),
    data: { breadcrumb: "factures" }
  },
  {
    path: "encaissements",
    loadComponent: () => import("./chunk-LKML2BED.js").then((c) => c.EncaissementVenteListe),
    data: { breadcrumb: "encaissements" }
  },
  {
    path: "commissions",
    loadComponent: () => import("./chunk-TTTWFOGB.js").then((c) => c.CommissionVenteListe),
    data: { breadcrumb: "commissions" }
  },
  {
    path: "commissions2",
    loadComponent: () => import("./chunk-EP57BROR.js").then((c) => c.ComissionVenteListe2),
...
//# sourceMappingURL=chunk-SG3B7I4M.js.map
