import{c as C}from"./chunk-BODZH67C.js";import{f as he}from"./chunk-GDXMST2T.js";import{Ba as pe,Ea as de,Fa as ue,Ga as u,I as E,O as re,P as se,c as te,l as ie,qa as ae,r as oe,ta as le,ua as g,xa as ce,y as ne}from"./chunk-3TW6FRUN.js";import{k as U,n as X,o as G,v as J,z as v}from"./chunk-VHU5DZ3H.js";import{c as ee,d as P,f as b,g as y,h as D}from"./chunk-4O3FVBGX.js";import{Ab as d,Bb as T,Cb as j,Kb as Q,Oa as B,Ob as f,Pa as w,Pb as r,Qb as $,Rb as Y,Sb as S,Sc as m,T as V,Tc as K,U as A,Ua as k,Ub as x,Va as z,Vb as L,W as H,Y as l,ac as I,ba as c,ca as p,db as R,eb as F,hb as Z,ib as M,jb as h,mc as W,oc as q,pa as _,pc as O,rb as N}from"./chunk-DD6OXU6V.js";var ve=["content"],be=["*"],ye=(i,s)=>({showTransitionParams:i,hideTransitionParams:s}),ge=(i,s)=>({value:i,params:s}),Ce=i=>({closeCallback:i});function _e(i,s){}function we(i,s){i&1&&h(0,_e,0,0,"ng-template")}function ke(i,s){if(i&1){let e=Q();T(0,"div",1),f("click",function(o){c(e);let n=r();return p(n.onOverlayClick(o))})("@animation.start",function(o){c(e);let n=r();return p(n.onAnimationStart(o))})("@animation.done",function(o){c(e);let n=r();return p(n.onAnimationEnd(o))}),T(1,"div",2),f("click",function(o){c(e);let n=r();return p(n.onContentClick(o))})("mousedown",function(o){c(e);let n=r();return p(n.onContentClick(o))}),Y(2),h(3,we,1,0,null,3),j()()}if(i&2){let e=r();I(e.cn(e.cx("root"),e.styleClass)),d("pBind",e.ptm("root"))("ngStyle",e.style)("@animation",O(16,ge,e.overlayVisible?"open":"close",O(13,ye,e.showTransitionOptions,e.hideTransitionOptions))),N("aria-modal",e.overlayVisible)("aria-label",e.ariaLabel)("aria-labelledBy",e.ariaLabelledBy),w(),I(e.cx("content")),d("pBind",e.ptm("content")),w(2),d("ngTemplateOutlet",e.contentTemplate||e._contentTemplate)("ngTemplateOutletContext",q(19,Ce,e.onCloseClick.bind(e)))}}var Te=`
.p-popover {
